            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ asset('apps-invoice-create.html') }}" class="btn btn-secondary rounded-circle btn-icon">
                            <i class="ti ti-plus fs-lg"></i></a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!"
                                                    class="link-reset">Emily Parker</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!"
                                                    class="link-reset">Michael Scott</a></h5>
                                    ...
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Samantha Reed</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Jonathan Lee</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Carlos Diaz</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Lisa Brown</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Ryan Mitchell</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Nina Hughes</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Oliver Grant</a></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name"
                                                    href="#!" class="link-reset">Sophia Kim</a></h5>
