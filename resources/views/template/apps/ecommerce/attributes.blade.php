...
<head>
    <meta charset="utf-8" />
    <title>Manage Attributes | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="app-search">
                                        <select data-table-filter="attri-type"
                                ...
                                <div class="d-flex gap-1">
                                    <a href="#addAttributeModal" class="btn btn-danger ms-1"
                                        ...
                                        <tr class="text-uppercase fs-xxs">
                                            <th class="ps-3" style="width: 1%">
                                                <input data-table-select-all
                                                    ...
                                                    type="checkbox" id="select-all-attributes" />
                                            </th>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content border-light rounded-3 shadow-sm">
                            <div class="modal-header">
                                <h5 class="modal-title fw-semibold" id="addAttributeModalLabel"><i
                                        class="ti ti-circle-dashed-plus me-2"></i> Add New Attribute</h5>
                            ...
                            <form id="addAttributeForm">
                                <div class="modal-body">
                                    <div class="row g-3">
                                        <!-- Attribute Name -->
                                        <div class="col-md-6">
                                            <label for="attributeName" class="form-label fw-semibold">Attribute
                                                Name</label>
                                        ...
                                        <!-- Attribute Values -->
                                        <div class="col-12">
                                            <label for="attributeValues"
                                                class="form-label fw-semibold">Values</label>
                                            <textarea id="attributeValues" class="form-control" rows="2"
                                                placeholder="Separate multiple values with commas (e.g. Red, Blue, Green)"></textarea>
                                            <small class="text-muted d-block mt-1">Applicable only for Dropdown or
                                                selectable attributes.</small>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                    id="attributeStatus" checked />
                                                <label class="form-check-label fw-semibold"
                                                    for="attributeStatus">Active</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-danger"><i
                                            class="ti ti-device-floppy me-1"></i> Save Attribute</button>
                                </div>
                            </form>
                        </div>
                    </div>
