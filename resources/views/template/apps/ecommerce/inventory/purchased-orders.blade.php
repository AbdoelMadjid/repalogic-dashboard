...
<head>
    <meta charset="utf-8" />
    <title>Purchased Orders | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                ...
                                <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tr class="text-uppercase fs-xxs">
                                            <th class="ps-3" style="width: 1%">
                                                <input data-table-select-all
                                                    ...
                                                    type="checkbox" id="select-all-orders" />
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="ps-3">
                                                <input
                                                    class="form-check-input form-check-input-light fs-14 order-item-check mt-0"
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$3,480.00</h5>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-label badge-soft-primary fs-xxs">Received</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0149</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$1,260.00</h5>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-warning fs-xxs">Pending</span>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-info fs-xxs">Processing</span>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0150</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$7,920.00</h5>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">Paid</span>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-warning fs-xxs">Partially
                                                    Received</span></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0151</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$980.00</h5>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-danger fs-xxs">Unpaid</span>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-success fs-xxs">Completed</span>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0152</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$4,250.00</h5>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">Paid</span>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-warning fs-xxs">Pending
                                                    Delivery</span></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0153</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$2,340.00</h5>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-danger fs-xxs">Overdue</span>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-danger fs-xxs">Cancelled</span>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0154</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$5,610.00</h5>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-warning fs-xxs">Pending</span>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-info fs-xxs">In
                                                    Progress</span></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0155</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$9,875.00</h5>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">Paid</span>
                                            </td>
                                            <td><span
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0156</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>15 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$2,120.00</h5>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-warning fs-xxs">Pending</span>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-secondary fs-xxs">Awaiting
                                                    Shipment</span></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0157</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$3,950.00</h5>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">Paid</span>
                                            </td>
                                            <td><span class="badge badge-label badge-soft-info fs-xxs">Awaiting
                                                    Delivery</span></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#!"
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="fw-semibold link-reset">PO-2025-0158</a>
                                            </td>
                                            <td>
                                                <div>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium">$6,730.00</h5>
                                            </td>
                                            <td><span
                                                    class="badge badge-label badge-soft-danger fs-xxs">Overdue</span>
                                            </td>
