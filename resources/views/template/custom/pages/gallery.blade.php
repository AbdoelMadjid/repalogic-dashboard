                        ...
                        <div class="col position-absolute" data-category="beautiful">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/1.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/1.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/2.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/2.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="beautiful">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/3.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/3.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/6.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/6.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/4.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/4.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="travel">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/5.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/5.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="city">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/7.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/7.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="travel">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/9.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/9.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="beautiful">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/10.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/10.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="nature">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/11.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/11.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="city">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/12.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/12.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="city">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/13.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/13.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="city">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/8.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/8.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col position-absolute" data-category="travel">
                            <div class="card border-0 mb-0">
                                ...
                                <a class="image-popup" href="{{ asset('assets/images/gallery/14.jpg') }}">
                                    <img class="card-img rounded-2" src="{{ asset('assets/images/gallery/14.jpg') }}"
                                        alt="" />
                                </a>
                            </div>
                        </div>
