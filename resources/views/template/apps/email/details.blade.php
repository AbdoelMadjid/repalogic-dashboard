...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Design Reviews & Feedback | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                        ...
                        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
                            ...
                            <div class="card-header card-bg justify-content-between">
                                <div class="d-flex flex-wrap align-items-center gap-1">
                                    <!-- Back to Inbox -->
                                    <a href="{{ asset('apps-email-inbox.html') }}" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Back to Inbox">
