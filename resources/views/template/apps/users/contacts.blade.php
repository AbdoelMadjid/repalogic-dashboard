...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Contacts | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Sophia Carter</a>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{ asset('apps-users-profile.html') }}" class="btn btn-soft-primary btn-sm rounded-pill">View Profile</a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Marcus Lee</a>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Emily Davis</a>
                                                <img src="{{ asset('assets/images/flags/us.svg') }}" alt="US" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Daniel Smith</a>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Daniel Morris</a>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{ asset('apps-users-profile.html') }}" class="btn btn-soft-success btn-sm rounded-pill">View Profile</a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Jessica Chen</a>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Arjun Patel</a>
                            ...
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="{{ asset('apps-users-profile.html') }}" class="link-reset">Olivia Garcia</a>
