...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Projects List | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ asset('apps-projects-grid.html') }}" class="btn btn-soft-primary btn-icon">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ asset('apps-projects-list.html') }}" class="btn btn-primary btn-icon">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">AI Analytics Dashboard</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">E-commerce Platform</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">UI Kit Design</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Website Redesign</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Marketing Report</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Sales Pitch Deck</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Mobile UI Mockups</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Server Maintenance</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Security Audit</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}" class="link-reset">Plugin Development</a>
                                                            </h5>
