        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="me-2 position-relative">
                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="avatar" class="rounded"
                                    width="42" height="42" />
                            </div>
                            <div>
                                <h5 class="mb-0 d-flex align-items-center">
                                    <a href="#!" class="link-reset">Damian D.</a>
                                    <img src="{{ asset('assets/images/flags/us.svg') }}" alt="US"
                                        class="ms-2 rounded-circle" height="16" />
                                </h5>
            ...
            <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                ...
                <div class="card">
                    <div class="card-body pb-2">
                        <div class="d-flex align-items-center mb-2">
                            <img class="me-2 avatar-md rounded-circle"
                                src="{{ asset('assets/images/users/user-10.jpg') }}" alt="Generic placeholder image" />
                            <div class="w-100">
                                <h5 class="m-0">
                        ...
                        <div class="row g-1">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/gallery/10.jpg') }}"
                                    class="img-fluid w-100 h-100 rounded" style="aspect-ratio: 3/4; object-fit: cover"
                                    alt="Tall Image" />
                            </div>

                            <!-- Right column with two stacked images -->
                            <div class="col-md-6 d-flex flex-column gap-1">
                                <img src="{{ asset('assets/images/gallery/2.jpg') }}" class="img-fluid w-100 rounded"
                                    style="aspect-ratio: 4/3; object-fit: cover" alt="Top Right" />
                                <img src="{{ asset('assets/images/gallery/3.jpg') }}" class="img-fluid w-100 rounded"
                ...
                <div class="card">
                    <div class="card-body pb-2">
                        <div class="d-flex align-items-center mb-2">
                            <img class="me-2 avatar-sm rounded-circle" src="{{ asset('assets/images/users/user-4.jpg') }}"
                        ...
                        <div class="fs-16 text-center mt-3 mb-4 fst-italic">
                            ...
                            Spent the weekend exploring the local trails! Captured some amazing nature shots and can’t wait
                            to post them soon. 🌿📸
                        </div>
                        ...
                        <div class="bg-light-subtle mx-n3 p-3 border-top border-bottom border-dashed">
                            ...
                            <div class="d-flex align-items-start mt-3">
                                <a class="pe-2" href="#">
                                    <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="rounded-circle"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img class="me-2 avatar-sm rounded-circle"
                                src="{{ asset('assets/images/users/user-2.jpg') }}" alt="Profile photo of Anika Roy" />
                            <div class="w-100">
                                <h5 class="m-0">
                        ...
                        <p class="text-muted mb-2">Join fellow creatives and outdoor enthusiasts for an inspiring weekend
                            of nature photography tips, live field sessions, and community networking.</p>
                ...
                <div class="card">
                    <div class="card-body pb-2">
                        <div class="d-flex align-items-center mb-2">
                            <img class="me-2 avatar-sm rounded-circle"
                                src="{{ asset('assets/images/users/user-1.jpg') }}" alt="Profile photo of Anika Roy" />
                            <div class="w-100">
                                <h5 class="m-0">
                                    <a href="#!" class="link-reset">Damian D.</a>
                                </h5>
                        ...
                        <p>Sharing a couple of timelapses from my recent Iceland trip. Let me know which one you like most!
                        </p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <img class="me-2 avatar-sm rounded-circle"
                                src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Profile photo of David Kim" />
                            <div class="w-100">
                                <h5 class="m-0">
                        ...
                        <p class="text-muted">We’re gathering developer preferences for our next project. Cast your vote
                            below! 💻</p>
                        ...
                        <form>
                            ...
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="radio" name="framework_poll"
                                    id="optionAngular" />
            ...
            <div class="col-xl-3 col-lg-6 order-lg-1 order-xl-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center mt-2">
                                <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle me-2"
                                    width="32" height="32" alt="mention" />
                                <div>
                        ...
                        <ul class="list-unstyled mt-2 mb-0">
                            <li class="d-flex align-items-center py-1">
                                <img src="{{ asset('assets/images/users/user-8.jpg') }}" class="rounded-circle me-2"
                                    width="36" height="36" alt="jenny.w" />
                            ...
                            <li class="d-flex align-items-center py-1">
                                <img src="{{ asset('assets/images/users/user-9.jpg') }}" class="rounded-circle me-2"
                                    width="36" height="36" alt="daniel92" />
                                <div class="flex-grow-1">
                                ...
                                <div>
                                    <img src="{{ asset('assets/images/gallery/1.jpg') }}" class="rounded" width="32"
                                        height="32" alt="commented" />
                                </div>
                            </li>

                            <li class="d-flex align-items-center py-1">
                                <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="rounded-circle me-2"
                                    width="36" height="36" alt="amelie.design" />
                                <div class="flex-grow-1">
                                ...
                                <div>
                                    <img src="{{ asset('assets/images/gallery/2.jpg') }}" class="rounded" width="32"
                                        height="32" alt="liked" />
                                </div>
                            </li>

                            <li class="d-flex align-items-center py-1">
                                <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="rounded-circle me-2"
                                    width="36" height="36" alt="johnny_dev" />
                                <div class="flex-grow-1">
                            ...
                            <li class="d-flex align-items-center py-1">
                                <img src="{{ asset('assets/images/users/user-6.jpg') }}" class="rounded-circle me-2"
                                    width="36" height="36" alt="art.gal" />
                                <div class="flex-grow-1">
                                ...
                                <div>
                                    <img src="{{ asset('assets/images/gallery/3.jpg') }}" class="rounded" width="32"
                                        height="32" alt="liked" />
                                </div>
                            </li>
                        </ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-start">
                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="Emily Zhang"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-start">
                                <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="John Doe"
                                    class="avatar-xs rounded-circle me-2" />
                                <div>
                                    <p class="mb-1">
