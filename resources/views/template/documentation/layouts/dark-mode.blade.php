        ...
        <div class="col-12 mb-4">
            <div class="card border shadow-sm">
                <div class="card-header bg-transparent py-3">
                    <h5 class="card-title mb-0 fw-bold"><i class="ti ti-moon-stars me-2 text-primary"></i>HTML Attribute & JavaScript Persistence</h5>
                </div>
                <div class="card-body">
                    <p class="text-muted fs-14 mb-3">Dark mode is toggled dynamically by setting the `data-bs-theme` attribute on the root `<html>` element:</p>
                    ...
                    <p class="text-muted fs-14 mb-0">
                        The current theme state is stored in `localStorage.setItem('theme', 'dark')` so user preferences persist across browser reloads.
                    </p>
                </div>
            </div>
        </div>
