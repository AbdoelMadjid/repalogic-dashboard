<!-- Theme Config Js -->
<script src="{{ asset('assets_default/js/config.js') }}"></script>

<!-- Vendor css -->
<link href="{{ asset('assets_default/css/vendors.min.css') }}" rel="stylesheet" type="text/css" />

<!-- App css -->
<link id="app-style" href="{{ asset('assets_default/css/app.min.css') }}" rel="stylesheet" type="text/css" />
