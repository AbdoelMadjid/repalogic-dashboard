                                                ...
                                                <div class="tab-pane fade" id="parentInfo">
                                                    <div class="p-4">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="btn btn-link fw-semibold text-muted"><i class="ti ti-arrow-left me-1"></i> Continue Shopping</a>
                                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                <p class="mb-1 fw-semibold">
                                                    <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple MacBook Air M3 13”</a>
                                                </p>
                                        ...
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                <p class="mb-1 fw-semibold">
                                                    <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Sony WH-1000XM5 Wireless Headphones</a>
                                                </p>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <p class="mb-1 fw-semibold">
                                                    <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple Watch Series 9 GPS</a>
                                                </p>
