<header class="app-topbar">
    <div class="container-fluid topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="app-search d-none d-xl-flex" id="search-box">
                <input class="form-control topbar-search" name="search" placeholder="Search for something..."
                    type="search" />
                <i class="ti ti-search app-search-icon text-muted"></i>
            </div>
            <div class="topbar-item d-none d-md-flex" id="megamenu-header">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-xxl p-0">
                        <div class="h-100" data-simplebar="" style="max-height: 380px">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="p-3">
                                        <h5 class="mb-2 fw-semibold fs-sm dropdown-header">Dashboard &amp; Analytics
                                        </h5>
                                        <ul class="list-unstyled megamenu-list">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0);">Marketing
                                                    Dashboard</a>
                                            </li>
                                            <li>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0);">Team
                                                    Collaboration</a>
                                            </li>
                                            <li>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0);">Security
                                                    Settings</a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="topbar-item d-none d-md-flex" id="megamenu-apps">
                <div class="dropdown">
                    <button aria-expanded="false" aria-haspopup="false"
                        class="topbar-link btn fw-medium btn-link dropdown-toggle drop-arrow-none px-2"
                        data-bs-toggle="dropdown" type="button">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-sm-4">
                                    <div class="h-100 position-relative rounded-end rounded-0 overflow-hidden"
                                        style="background: url(/images/stock/small-8.jpg); background-size: cover">
                                        <div
                                            ...
                                            <div class="text-center text-white">
                                                ...
                                                <p class="text-white text-opacity-75 mb-3 text-uppercase">Limited Offer
                                                </p>
                                                <h3 class="fw-semibold text-white mb-2 fs-20">Unlock Exclusive Savings
                                                </h3>
        ...
        <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-2 dropdown-menu-end">
                        <div class="row align-items-center g-1">
                            <div class="col-4">
                                <a class="dropdown-item rounded text-center py-2" href="javascript:void(0);">
                        ...
                        <div class="px-3 py-2 border-bottom">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-end">
                                    <a class="badge badge-soft-success badge-label py-1" href="#!">09
                                        Notifications</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg">
                        <div class="px-3 py-2 border-bottom">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-end">
                                    <a class="badge text-bg-light badge-label py-1" href="#!">12 Alerts</a>
                                </div>
                            </div>
                        </div>
                        <div data-simplebar="" style="max-height: 300px">
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-1">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-1" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-2">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-2" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-3">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-3" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-4">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-4" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-5">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-5" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-6">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-6" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-7">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-7" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-8">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-8" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-9">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-9" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-10">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-10" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-11">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-11" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-12">
                                <span class="d-flex gap-2">
                                    ...
                                    <button class="flex-shrink-0 text-muted btn btn-link p-0"
                                        data-dismissible="#notification-12" type="button">
                                        <i class="ti ti-square-rounded-x fs-xxl"></i>
                                    </button>
                                </span>
                            </div>
                        ...
                        <!-- All-->
                        <a class="dropdown-item text-center text-reset text-decoration-underline link-offset-2 fw-bold notify-item border-top border-light py-2"
                            href="javascript:void(0);">View All Alerts</a>
                    </div>
                </div>
            </div>
            ...
            <div class="topbar-item d-none d-sm-flex" id="monochrome-toggler">
            ...
            <div class="topbar-item d-none d-sm-flex">
                <button class="topbar-link btn-theme-setting" data-bs-target="#theme-settings-offcanvas"
                    data-bs-toggle="offcanvas" type="button">
                    <i class="ti ti-settings topbar-link-icon"></i>
                </button>
            </div>
            <div class="topbar-item" id="language-selector">
                <div class="dropdown">
                    <button aria-expanded="false" aria-haspopup="false" class="topbar-link fw-bold"
                        data-bs-toggle="dropdown" type="button">
                        <img alt="user-image" class="rounded me-2" height="18" id="selected-language-image"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" data-translator-lang="ar" href="javascript:void(0);"
                            title="Arabic">
                            <img alt="Arabic" class="me-1 rounded-circle" data-translator-image="" height="18"
            ...
            <div class="topbar-item nav-user" id="simple-user-dropdown">
                <div class="dropdown">
                    <a aria-expanded="false" aria-haspopup="false"
                        class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        href="#!">
