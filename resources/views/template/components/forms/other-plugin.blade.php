        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Inputmask is a javascript library that creates an input mask. Inputmask
                            can run against vanilla javascript, jQuery, and jqlite. (Hoverable Inputmask)</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">a flexible JavaScript library that provides a strong foundation for
                            building robust typeaheads</p>
