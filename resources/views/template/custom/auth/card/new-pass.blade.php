                            ...
                            <div class="col-lg-6">
                                <div class="card-body">
                                    <div class="auth-brand text-center mb-4">
                                        ...
                                        <p class="text-muted w-lg-75 mx-auto">We've emailed you a 6-digit verification code.
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3" data-password="bar">
                                            ...
                                            <p class="text-muted fs-xs mb-0">Use 8+ characters with letters, numbers &
                                                symbols.</p>
                                        </div>
                                        ...
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-primary fw-semibold py-2">Update
                                                Password</button>
                                        </div>
                                    </form>
                                    ...
                                    <p class="mt-4 text-muted text-center mb-4">
                                        ...
                                        or
                                        <a href="#" class="text-decoration-underline link-offset-2 fw-semibold">Call
                                            Us</a>
                                    </p>
