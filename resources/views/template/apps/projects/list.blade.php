                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">AI Analytics Dashboard</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">E-commerce Platform</a>
                                            </h5>
                                    ...
                                    <div class="avatar-group avatar-group-xs">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/images/users/user-6.jpg') }}"
                                                class="rounded-circle avatar-xs" alt="user-img" />
                                        </div>
                                        <div class="avatar">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">Website Redesign</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">Marketing Report</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">Sales Pitch Deck</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">Mobile UI Mockups</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">Server Maintenance</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a data-sort="project" href="{{ asset('apps-projects-details.html') }}"
                                                    class="link-reset">Plugin Development</a>
                                            </h5>
