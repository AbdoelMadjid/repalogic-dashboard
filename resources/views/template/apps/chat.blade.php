                ...
                <div id="chat-sidebar" class="card-body p-2" style="height: calc(100% - 100px)" data-simplebar
                    ...
                    <div class="list-group list-group-flush chat-list">
                        ...
                        <a href="#!" data-chat-id="chat8"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                <span class="avatar avatar-sm flex-shrink-0">
                                    <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="avatar-11"
                                        class="img-fluid rounded-circle" />
                                </span>
                                <span class="overflow-hidden">
                                    <span data-chat-search-field
                        ...
                        <a href="#!" data-chat-id="chat9"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                <span class="avatar avatar-sm flex-shrink-0">
                                    <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="avatar-12"
                                        class="img-fluid rounded-circle" />
                                </span>
                                <span class="overflow-hidden">
                        ...
                        <a href="#!" data-chat-id="chat11"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                <span class="avatar avatar-sm flex-shrink-0">
                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="avatar-14"
                                        class="img-fluid rounded-circle" />
                                </span>
                                <span class="overflow-hidden">
                        ...
                        <a href="#!" data-chat-id="chat12"
                            ...
                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                <span class="avatar avatar-sm flex-shrink-0">
                                    <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="avatar-15"
                                        class="img-fluid rounded-circle" />
                                </span>
                                <span class="overflow-hidden">
                                    <span data-chat-search-field
        ...
        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1">
            ...
            <div id="chat-container" data-chat class="card-body pt-0 pb-3 chat-content-bar" data-simplebar>
                ...
                <div class="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                    <div>
                        <div class="chat-message py-2 px-3 bg-info-subtle rounded">Sure, give me 5 minutes. Just wrapping
                            something up.</div>
                        <div class="text-muted fs-xs mt-1">
                            <i class="ti ti-clock"></i>
                            08:57 am
                ...
                <div class="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                    <div>
                        <div class="chat-message py-2 px-3 bg-info-subtle rounded">Great, I’ll review them once they
                            arrive.</div>
                        <div class="text-muted fs-xs mt-1">
                            <i class="ti ti-clock"></i>
                            09:52 am
                ...
                <div class="d-flex align-items-start gap-2 my-3 chat-item">
                    ...
                    <div>
                        <div class="chat-message py-2 px-3 bg-warning-subtle rounded">Just sent them via Drive. Let me know
                            if you have issues accessing.</div>
                        <div class="text-muted fs-xs mt-1">
                            <i class="ti ti-clock"></i>
                            12:03 pm
                        </div>
                ...
                <div class="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                    <div>
                        <div class="chat-message py-2 px-3 bg-info-subtle rounded">Got them. Everything looks good so far!
                        </div>
                        <div class="text-muted fs-xs mt-1">
                            <i class="ti ti-clock"></i>
                            12:10 pm
                ...
                <div class="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                    <div>
                        <div class="chat-message py-2 px-3 bg-info-subtle rounded">Will get back to you after lunch 🍴
                        </div>
                        <div class="text-muted fs-xs mt-1">
                            <i class="ti ti-clock"></i>
                            12:13 pm
