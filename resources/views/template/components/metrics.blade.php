                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="p-3">
                                ...
                                <p class="mb-0">You have received 421 new orders, indicating a healthy sales trend over
                                    the past period.</p>
                            </div>
                    ...
                    <div class="card text-bg-secondary border-0">
                        <div class="card-body p-0">
                            <div class="p-3 mb-3">
                                ...
                                <p class="mb-0 text-white-50">You currently have 185 active products available across your
                                    store inventory.</p>
                            </div>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-3">Your total profit reached $12,500 this month, showing stable and positive
                                business growth.</p>
