                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-start align-items-center gap-3">
                            <div class="avatar avatar-xxl">
                                <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="avatar-2"
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>
                        I'm a Product Designer and template author passionate about crafting clean, scalable, and
                        high-performing UI solutions. With a focus on frontend technologies and modern design systems, I
                        create user-centric digital products that are both
                        functional and visually appealing.
                    </p>
                    <p class="mb-0">
                        As a template creator, I specialize in building developer-friendly UI kits and dashboards using
                        frameworks like Tailwind CSS, Bootstrap, React, Next.js, Vue, and Laravel. My work powers countless
                        web apps, helping developers save time and
                        build faster.
                    </p>
                    ...
                    <div class="mt-3">
                        ...
                        <p class="mb-0">
                            I take a user-first approach to design—blending thoughtful UX with clean code. From wireframes
                            to fully responsive templates, I focus on creating intuitive and aesthetic experiences. Whether
                            you're launching a SaaS dashboard, admin
                        ...
                        <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h5 class="fs-sm my-1">
                                            <a data-sort="task" href="#" class="text-body">Admin Dashboard Template
                                                - Final Touch</a>
                                        </h5>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            ...
                                            <div>
                                                <h5 data-sort="name" class="text-nowrap fs-sm mb-0 lh-base">Liam Johnson
                                                </h5>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="fs-sm my-1">
                                            <a data-sort="task" href="#" class="text-body">Tailwind UI Kit
                                                Design</a>
                                        </h5>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            ...
                                            <div>
                                                <h5 data-sort="name" class="text-nowrap fs-sm mb-0 lh-base">Ava Reynolds
                                                </h5>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="fs-sm my-1">
                                            <a data-sort="task" href="#" class="text-body">React + Next.js Starter
                                                Template</a>
                                        </h5>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            ...
                                            <div>
                                                <h5 data-sort="name" class="text-nowrap fs-sm mb-0 lh-base">Noah Carter
                                                </h5>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="fs-sm my-1">
                                            <a data-sort="task" href="#" class="text-body">Laravel Template Docs
                                                Update</a>
                                        </h5>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            ...
                                            <div>
                                                <h5 data-sort="name" class="text-nowrap fs-sm mb-0 lh-base">Sophia Bennett
                                                </h5>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="fs-sm my-1">
                                            <a data-sort="task" href="#" class="text-body">Portfolio Website
                                                Redesign</a>
                                        </h5>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start align-items-center gap-2">
                                            ...
                                            <div>
                                                <h5 data-sort="name" class="text-nowrap fs-sm mb-0 lh-base">Mason Clark
                                                </h5>
