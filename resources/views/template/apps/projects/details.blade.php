                        ...
                        <div class="card-header align-items-start p-4">
                            <div class="avatar-xxl me-3">
                                <span class="avatar-title text-bg-light rounded">
                                    <img src="{{ asset('assets/images/logos/starbucks.svg') }}" height="48"
                                        alt="Brand-img" />
                                </span>
                            </div>
                            <div>
                        ...
                        <div class="card-body px-4">
                            <div class="mb-4">
                                ...
                                <p class="text-muted">
                                    ...
                                    scalability and responsiveness in mind, supporting both
                                ...
                                <div class="tab-pane fade active show" id="comments" role="tabpanel">
                                    ...
                                    <div class="d-flex mb-3 border border-dashed rounded p-3">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            ...
                                            <p>
                                                The
                                                <a href="javascript:void(0)" class="text-decoration-underline">System
                                                    Status Page</a>
                                                has been updated. We're actively monitoring and will release a patch within
                                                24 hours.
                                            </p>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox"
                                                            class="form-check-input rounded-circle mt-0 fs-xl"
                                                            id="task7" />
                                                        <a href="#!" role="button" class="link-reset fw-medium">QA
                                                            testing for billing module</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                ...
                                <div class="tab-pane fade" id="activity" role="tabpanel">
                                    ...
                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                        ...
                                        <div class="flex-grow-1 text-muted position-relative">
                                            ...
                                            <div class="py-2 px-3 bg-light bg-opacity-50">"Let’s sync up on the product
                                                roadmap tomorrow afternoon, does 2 PM work for you?"</div>
                                        </div>
