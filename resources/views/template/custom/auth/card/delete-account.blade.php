                        ...
                        <div class="row justify-content-between g-0">
                            <div class="col-lg-6">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <div class="avatar-xxl mx-auto mt-2">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/images/delete.png') }}" alt="dark logo"
                                                    height="64">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <p class="text-muted text-center mb-4">Your account is currently inactive. Reactivate
                                        now to regain access to all features and opportunities.</p>

                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-primary fw-semibold py-2">Reactivate
                                            Now</button>
                                    </div>
