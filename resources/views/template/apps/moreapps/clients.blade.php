                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/us.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        US
                                    </span>
                                </td>
                                <td>Feb 2, 2024</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/gb.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        UK
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/de.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        DE
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/mx.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        MX
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/in.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        IN
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/sg.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        SG
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/jp.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        JP
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/br.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        BR
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge p-1 text-bg-light fs-sm">
                                        <img src="{{ asset('assets/images/flags/au.svg') }}" alt=""
                                            class="rounded-circle me-1" height="12" />
                                        AU
                                    </span>
                                </td>
