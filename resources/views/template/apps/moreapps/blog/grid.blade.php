...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Blog | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Mastering Figma: 7 Pro Tips for Better UI Design</a>
                                    </h6>
                                ...
                                <div class="card-footer bg-transparent d-flex justify-content-between">
                                    ...
                                    <a class="link-primary fw-semibold d-flex align-items-center gap-1" href="{{ asset('apps-blog-article.html') }}">Read more <i class="ti ti-arrow-right"></i></a>
                                </div>
                            </article>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Building REST APIs with Node.js</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">SEO Strategies for 2025: How to Rank Higher</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Web Design Trends to Watch in 2025</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">5 Key Tips for New Entrepreneurs</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">The Future of Artificial Intelligence</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card bg-primary bg-gradient rounded-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="text-white">Top Data Science Trends in 2025</a>
                                    </h6>
                                ...
                                <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                                    ...
                                    <a class="text-white fw-semibold d-flex align-items-center gap-1" href="{{ asset('apps-blog-article.html') }}">Read more <i class="ti ti-arrow-right"></i></a>
                                </div>
                            </article>
                        </div>
                        <!-- end col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Top Data Science Trends in 2025</a>
                                    </h6>
