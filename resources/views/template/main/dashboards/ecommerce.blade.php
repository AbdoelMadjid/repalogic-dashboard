...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>eCommerce Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-xxl-4">
                                            ...
                                            <div class="text-center my-3">
                                                <a href="{{ asset('chat.html') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Reports <i class="ti ti-send-2"></i> </a>
                                            </div>
                                        </div>
                                        <!-- end col-->
                                    </div>
