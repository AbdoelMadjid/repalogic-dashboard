...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Products | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="btn btn-soft-primary btn-icon">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ asset('apps-ecommerce-products.html') }}" class="btn btn-soft-primary btn-icon active">
                                            <i class="ti ti-list-check fs-lg"></i>
                                        </a>
                                        <a href="{{ asset('apps-ecommerce-product-add.html') }}" class="btn btn-danger ms-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Wireless Earbuds</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(87)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="btn btn-light btn-icon btn-sm rounded-circle">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart LED Desk Lamp</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(54)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Men's Running Shoes</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(142)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Fitness Tracker Watch</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(89)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Gaming Mouse RGB</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(102)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Modern Lounge Chair</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(27)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Plush Toy Bear</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(120)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">55" Ultra HD Smart TV</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(88)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple iMac 24" M3</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(16)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-warning fs-xxs">Pending</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart Watch Pro X2</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1">
                                                        <a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(65)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="badge badge-soft-success fs-xxs">Published</span>
