...
<head>
    <meta charset="utf-8" />
    <title>Product Stocks | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                        ...
                        <div data-table data-table-rows-per-page="10" class="card">
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <!-- Price Range Filter -->
                                    <div class="app-search">
                                        <select data-table-range-filter="price"
                                            class="form-select form-control my-1 my-md-0">
                                ...
                                <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/1.png') }}"
                                                            alt="Product" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Smart LED TV 55"</a>
                                                        </h5>
                                            ...
                                            <td>Electronics</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">320</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">24</h5>
                                            </td>
                                            <td>$749.00</td>
                                            <td>
                                                <span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Wireless Noise Cancel
                                                                Headphones</a>
                                                        </h5>
                                            ...
                                            <td>Audio</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">220</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-warning">15</h5>
                                            </td>
                                            <td>$199.00</td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span></td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-light btn-icon btn-sm rounded-circle"
                                                        data-table-delete-row><i class="ti ti-trash fs-lg"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/3.png') }}"
                                                            alt="Product" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Ergonomic Office Chair</a>
                                                        </h5>
                                            ...
                                            <td>Furniture</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">0</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">0</h5>
                                            </td>
                                            <td>$249.00</td>
                                            <td><span class="badge badge-label badge-soft-danger fs-xxs">Out of
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/4.png') }}"
                                                            alt="Product" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Smartphone 12 Pro</a>
                                                        </h5>
                                            ...
                                            <td>Mobiles</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">510</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">30</h5>
                                            </td>
                                            <td>$999.00</td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Bluetooth Speaker Mini</a>
                                                        </h5>
                                            ...
                                            <td>Audio</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">420</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-warning">25</h5>
                                            </td>
                                            <td>$79.00</td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/6.png') }}"
                                                            alt="Product" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Portable Air Cooler</a>
                                                        </h5>
                                            ...
                                            <td>Appliances</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">85</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">8</h5>
                                            </td>
                                            <td>$129.00</td>
                                            <td><span class="badge badge-label badge-soft-warning fs-xxs">Low
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Gaming Laptop GTX 4070</a>
                                                        </h5>
                                            ...
                                            <td>Computers</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">90</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">6</h5>
                                            </td>
                                            <td>$1,899.00</td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/8.png') }}"
                                                            alt="Product" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Wireless Mouse Pro</a>
                                                        </h5>
                                            ...
                                            <td>Accessories</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">410</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-warning">20</h5>
                                            </td>
                                            <td>$49.00</td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/9.png') }}"
                                                            alt="Product" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                            ...
                                            <td>Cameras</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">155</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-warning">12</h5>
                                            </td>
                                            <td>$349.00</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Smart Fitness Watch</a>
                                                        </h5>
                                            ...
                                            <td>Wearables</td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-success">240</h5>
                                            </td>
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">18</h5>
                                            </td>
                                            <td>$149.00</td>
                                            <td><span class="badge badge-label badge-soft-success fs-xxs">In
                                                    Stock</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Cordless Vacuum Cleaner</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <h5 class="fs-base mb-0 fw-medium text-danger">5</h5>
                                            </td>
                                            <td>$249.00</td>
                                            <td><span class="badge badge-label badge-soft-warning fs-xxs">Low
                                                    Stock</span></td>
