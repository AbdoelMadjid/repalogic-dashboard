...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Blog List | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">10 Essential UI Design Tips for Better User Experience</a>
                                                        </h6>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">How AI is Transforming Modern Web Development</a>
                                                        </h6>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Top 5 Content Marketing Strategies That Work in 2025</a>
                                                        </h6>
                                            ...
                                            <article class="card flex-md-row mb-3">
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Scaling Your Startup: Lessons from Successful Founders</a>
                                                        </h6>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="d-grid mb-4">
                                                <a href="{{ asset('apps-blog-add.html') }}" class="btn btn-primary btn-lg fs-base d-flex align-items-center justify-content-center gap-2"> <i class="ti ti-circle-dashed-plus"></i> Add New Article </a>
                                            </div>
