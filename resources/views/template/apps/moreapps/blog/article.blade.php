                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-8">
                            ...
                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 mt-3 align-items-center fs-base">
                                ...
                                <span class="d-flex align-items-center gap-1"><i class="ti ti-calendar fs-md"></i> Mar 18,
                                    2025</span>
                                <span class="d-flex align-items-center gap-1"><i class="ti ti-message-circle fs-md"></i> <a
                                        href="#!" class="link-reset">42</a></span>
                                <span class="d-flex align-items-center gap-1"><i class="ti ti-eye fs-md"></i> 982</span>
                            </p>

                            <!-- Image -->
                            <img src="{{ asset('assets/images/blog/blog-post.jpg') }}" class="img-fluid rounded mt-4"
                                alt="blog-img" />

                            <div class="fs-md">
                                <!-- Content -->
                                <p class="mt-4">
                                    In a world full of constant notifications and distractions, developing the ability to
                                    focus has become a superpower. This article dives into proven methods for cultivating
                                    deep work and staying productive in a digital age.
                                </p>
                                <p>
                                    Eliminating distractions and building a workflow that encourages uninterrupted focus can
                                    drastically improve your efficiency. Whether you're coding, writing, or designing — deep
                                    work leads to higher quality output and greater
                                    satisfaction.
                                </p>
                                <p>
                                    Some effective strategies include time-blocking your calendar, using tools like Pomodoro
                                    timers, and creating a distraction-free workspace. Even just 90 minutes of intentional,
                                    focused work per day can compound into massive
                                    progress over time.
                                </p>
                            ...
                            <div class="align-items-center mt-5">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item ps-0">
                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>
                                            Unlocking the Secrets of Modern UI Design</a>
                                    </li>
                                    <li class="list-group-item ps-0">
                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>
                                            How to Build a Portfolio with Tailwind CSS</a>
                                    </li>
                                    <li class="list-group-item ps-0">
                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>
                                            Boost Productivity with These Web Dev Tools</a>
                                    </li>
                                    <li class="list-group-item ps-0">
                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>
                                            The Future of Frontend: Trends to Watch in 2025</a>
                                    </li>
                                    <li class="list-group-item ps-0">
                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>
                                            Essential Tips for Clean and Maintainable Code</a>
                                    </li>
                                </ul>
                            </div>
