            ...
            <div data-table data-table-rows-per-page="10" class="card">
                ...
                <div class="table-responsive">
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 mt-0"
                                        type="checkbox" /></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="avatar-11"
                                                class="img-fluid rounded-circle" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="avatar-12"
                                                class="img-fluid rounded-circle" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="avatar-13"
                                                class="img-fluid rounded-circle" />
                                        </div>
                                        <div>
