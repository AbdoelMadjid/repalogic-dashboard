...
<head>
    <meta charset="utf-8" />
    <title>Shopping Cart | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="alert alert-info border border-info border-opacity-25">
                                <h6 class="mb-2">Buy <span class="fw-bold text-warning">$250</span> more to get
                                    <span class="fw-semibold">Free Shipping</span></h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="#"
                                        class="text-decoration-underline link-offset-2 fw-medium">Clear cart</a>
                                </div>
                                ...
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/products/1.png') }}"
                                                            class="me-3 rounded" width="60" alt="iPhone" />
                                                        <div>
                                                    ...
                                                    <td>
                                                        <div class="input-group" data-touchspin
                                                            ...
                                                            <button type="button" class="btn btn-primary floating"
                                                                data-minus>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/products/2.png') }}"
                                                            class="me-3 rounded" width="60" alt="iPad" />
                                                        <div>
                                                            <span
                                                                class="badge bg-danger-subtle text-danger mb-1">-10%</span>
                                                    ...
                                                    <td>
                                                        ...
                                                        <small
                                                            class="text-decoration-line-through text-muted">$1,099.00</small>
                                                    </td>
                                                    <td>
                                                        <div class="input-group" data-touchspin
                                                            style="max-width: 130px">
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/products/3.png') }}"
                                                            class="me-3 rounded" width="60" alt="Watch" />
                                                        <div>
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ asset('apps-ecommerce-products-grid.html') }}"
                                            class="fw-medium d-inline-flex align-items-center gap-1"> <i
                                                class="ti ti-arrow-left"></i> Continue Shopping </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ asset('apps-ecommerce-checkout.html') }}"
                                        class="btn btn-lg btn-danger w-100 mb-3"> Proceed to Checkout </a>
                                    <p class="text-muted text-center mb-0"><a href="#"
                                            class="fw-semibold">Create an account</a> and get 239 bonuses</p>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-warning fs-xs py-2">Use <span
                                            class="fw-bold">ADMINPRO</span> to get 10% off.</div>
