                            ...
                            <div class="row align-items-center g-0">
                                <div class="col-xl-7">
                                    <div class="d-flex align-items-center gap-4 p-4">
                                        ...
                                        <div>
                                            <h3 class="text-primary d-flex align-items-center gap-2 mb-2 fw-bold">4.92 <i
                                                    class="ti ti-star-filled"></i></h3>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle drop-arrow-none" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false"><i class="ti ti-download me-1"></i>
                                Export
