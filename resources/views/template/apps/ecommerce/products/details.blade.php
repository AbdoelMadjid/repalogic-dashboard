                                            ...
                                            <div class="card card-top-sticky border-0">
                                                <div class="card-body p-0">
                                                    ...
                                                    <div class="text-center my-3">
                                                        <a href="{{ asset('apps-ecommerce-product-add.html') }}" class="btn btn-light me-1">
                                                            <i class="ti ti-pencil fs-lg me-1"></i>
                                                            Edit
                                                        </a>
                                                        <a href="{{ asset('apps-ecommerce-product-add.html') }}" class="btn btn-danger">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
                                                        ...
                                                        <span class="ms-1 fs-base">
                                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-medium">(859 Reviews)</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="mt-3 mb-5">
