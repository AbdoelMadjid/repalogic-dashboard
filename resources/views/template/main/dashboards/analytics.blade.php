                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1">
                                                    <span data-target="14.59">0</span>M <span
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1">
                                                    <span data-target="815.58">0</span>k <span
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1">
                                                    <span data-target="41.3">0</span>% <span
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-12">
                                    <div class="p-3 rounded m-1 mt-xxl-0 border border-dashed">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h3 class="mb-1">
                                                    <span data-target="56.39">0</span>k <span
                            ...
                            <div class="card-header justify-content-between border-dashed">
                                ...
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i
                                            class="ti ti-download me-1"></i> Export CSV </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div dir="ltr">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-end mt-3">
                                <a href="{{ asset('chat.html') }}"
                                    class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Links
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <img src="{{ asset('assets/images/flags/fr.svg') }}" alt="France"
                                    class="avatar-xxs rounded" />
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <img src="{{ asset('assets/images/flags/in.svg') }}" alt="India"
                                    class="avatar-xxs rounded" />
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <img src="{{ asset('assets/images/flags/gb.svg') }}" alt="United Kingdom"
                                    class="avatar-xxs rounded" />
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <img src="{{ asset('assets/images/flags/br.svg') }}" alt="Brazil"
                                    class="avatar-xxs rounded" />
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <img src="{{ asset('assets/images/flags/it.svg') }}" alt="Italy"
                                    class="avatar-xxs rounded" />
                            ...
                            <div class="text-center mt-2">
                                <a href="{{ asset('chat.html') }}"
                                    class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all
                                    Countries <i class="ti ti-world"></i> </a>
                            </div>
                        </div>
                        <!-- end card-body -->
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-custom table-nowrap table-hover table-centered mb-0">
                                    ...
                                    <tbody class="text-sm">
                                        ...
                                        <tr>
                                            <td><i class="ti ti-brand-facebook text-info fs-lg me-1"></i> Facebook Push
                                            </td>
                                            <td>478</td>
                                            <td>245</td>
                                            <td>6,120</td>
                                        ...
                                        <tr>
                                            <td><i class="ti ti-speakerphone text-success fs-lg me-1"></i> Holiday Buzz
                                            </td>
                                            <td>445</td>
                                            <td>230</td>
                                            <td>5,710</td>
                                        ...
                                        <tr>
                                            <td><i class="ti ti-mail-fast text-warning fs-lg me-1"></i> Email Reconnect
                                            </td>
                                            <td>392</td>
                                            <td>190</td>
                                            <td>5,210</td>
            ...
            <div class="d-block">
                <div class="p-3 border-bottom">
                    ...
                    <a href="#" class="d-block py-2">
                        ...
                        <span class="d-flex align-items-center">
                            <span class="flex-shrink-0">
                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="Lucas Miller"
                    ...
                    <a href="#" class="d-block py-2">
                        ...
                        <span class="d-flex align-items-center">
                            <span class="flex-shrink-0">
                                <img src="{{ asset('assets/images/users/user-4.jpg') }}" alt="Amelia Green"
                                    class="avatar-sm rounded-circle" />
                            </span>
                            <span class="flex-grow-1 ms-2 text-truncate">
                    ...
                    <a href="#" class="d-block py-2">
                        ...
                        <span class="d-flex align-items-center">
                            <span class="flex-shrink-0">
                                <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Noah Smith"
                                    class="avatar-sm rounded-circle" />
                            </span>
                            <span class="flex-grow-1 ms-2 text-truncate">
                    ...
                    <a href="#" class="d-block py-2">
                        ...
                        <span class="d-flex align-items-center">
                            <span class="flex-shrink-0">
                                <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="Emma Johnson"
                                    class="avatar-sm rounded-circle" />
                            </span>
                            <span class="flex-grow-1 ms-2 text-truncate">
                    ...
                    <div class="text-center mt-2">
                        <a href="{{ asset('chat.html') }}"
                            class="link-reset text-decoration-underline fw-semibold link-offset-3"> Go to Chat <i
                    ...
                    <div class="p-3">
                        <div class="tab-content">
                            <div class="tab-pane" id="Posts">
                                ...
                                <p class="fs-xs mb-0">You have published 260 posts this month, showing strong content
                                    activity across all categories.</p>
                            ...
                            <div class="tab-pane show active" id="Orders">
                                ...
                                <p class="fs-xs mb-0">A total of 421 orders have been placed, reflecting consistent demand
                                    for your products.</p>
                                <div class="card-body">
                ...
                <div class="p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="#" class="text-muted d-flex align-items-center fs-xs fw-semibold"> <i
                    ...
                    <div class="pb-2 border-bottom border-light border-dashed">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="avatar-group avatar-group-xs">
                                <div class="avatar">
                                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="Liam Carter"
                                        class="avatar-xs rounded-circle" />
                                </div>
                                <div class="avatar">
                                    <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="Zoe Miles"
                                        class="avatar-xs rounded-circle" />
                                </div>
                                <div class="avatar avatar-xs">
                                    <span class="avatar-title bg-primary-subtle text-primary rounded-circle fw-bold"> D
                                    </span>
                                </div>
                            </div>
