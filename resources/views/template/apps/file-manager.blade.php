                        ...
                        <div class="card">
                            <div class="card-body p-2">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div
                                        class="flex-shrink-0 avatar-md d-flex justify-content-center align-items-center bg-light bg-opacity-50 text-muted rounded-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="{{ asset('assets/images/users/user-1.jpg') }}" download
                                                class="dropdown-item">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#attex-react-folder">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#material-design">
                                                <i class="ti ti-trash me-1"></i>
                                                Delete
                                            </a>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#vuestudio-pack">
                                                <i class="ti ti-trash me-1"></i>
                                                Delete
                                            </a>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#blazor-studio">
                                                <i class="ti ti-trash me-1"></i>
                                                Delete
                                            </a>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#angular-prime">
                                                <i class="ti ti-trash me-1"></i>
                                                Delete
                                            </a>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"
                                                data-dismissible="#react-kit-pro">
                                                <i class="ti ti-trash me-1"></i>
                                                Delete
                                            </a>
                                        </div>
                        ...
                        <tbody>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base">
                                                <a data-sort="name" href="#!" class="link-reset">Project Overview
                                                    Video</a>
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base">
                                                <a data-sort="name" href="#!" class="link-reset">Team Meeting
                                                    Video</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base">
                                            <a href="#!" data-sort="owner"
                                                class="link-reset">michael@devteam.com</a>
                                        </h5>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="{{ asset('assets/images/users/user-4.jpg') }}" download
                                                    class="dropdown-item">
                                                    <i class="ti ti-download me-1"></i>
                                                    Download
                                                </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div
                                            class="flex-shrink-0 d-flex justify-content-center align-items-center avatar-md bg-light bg-opacity-50 text-muted rounded-2">
                                            <i class="ti ti-brand-figma fs-xl avatar-title"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base">
                                                <a data-sort="name" href="#!" class="link-reset">Marketing Strategy
                                                    Design</a>
                                            </h5>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h5 class="mb-0 fs-base">
                                            <a data-sort="owner" href="#!"
                                                class="link-reset">susan@marketing.com</a>
                                        </h5>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base">
                                                <a data-sort="name" href="#!" class="link-reset">Client Proposal
                                                    PDF</a>
                                            </h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base">
                                                <a data-sort="name" href="#!" class="link-reset">Dependency
                                                    Package</a>
                                            </h5>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                        ...
                                        <div class="dropdown flex-shrink-0 text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="{{ asset('assets/images/users/user-6.jpg') }}" download
                                                    class="dropdown-item">
                                                    <i class="ti ti-download me-1"></i>
                                                    Download
                                                </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="mb-1 fs-base">
                                                <a data-sort="name" href="#" class="link-reset">Podcast Episode
                                                    12</a>
                                            </h5>
