                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li data-jstree='{ "icon" : "treeview-file text-success fs-lg" }'>Documentation Files
                                    </li>
                                    <li
                                        data-jstree='{ "opened" : true, "icon" : "treeview-folder-open text-warning fs-lg" }'>
                                        Project Resources
                                        <ul>
                                            <li
                                                data-jstree='{ "disabled" : true, "icon": "treeview-icon-ban text-muted fs-lg" }'>
                                                Restricted Access</li>
                                            <li data-jstree='{ "type" : "file", "icon": "treeview-file fs-lg" }'>Final
                                                Report.pdf</li>
                                        </ul>
                                    </li>
                                    <li data-jstree='{ "icon" : "treeview-icon-user text-danger fs-lg" }'>Team Member Info
                                    </li>
                                </ul>
                            </li>
