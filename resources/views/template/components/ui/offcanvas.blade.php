        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Build hidden sidebars into your project for navigation, shopping carts,
                            and more with a few classes and our JavaScript plugin.</p>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop"
                                ...
                                <div class="offcanvas-body">
                                    <div>Some text as placeholder. In real life you can have the elements you have chosen.
                                        Like, text, images, lists, etc.</div>
                                    <h5 class="mt-3">List</h5>
                                    <ul class="ps-3">
                                        <li class="">Nemo enim ipsam voluptatem quia aspernatur</li>
                                        <li class="">Neque porro quisquam est, qui dolorem</li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted fs-sm">
                            Customize the look of offcanvases using utility classes to suit different themes, such as dark
                            navbars. Add
