...
<!-- Carousel Slider -->
      <div class="js-carousel u-carousel-v5"
        ...
        <!-- Carousel Slides -->
        <div class="js-slide h-100 g-flex-centered g-bg-img-hero g-bg-cover g-bg-black-opacity-0_3--after" style="background-image: url({{ asset('asset_education/img-temp') }}/1920x1080/img5.jpg);">
          <div class="container">
        ...
        <!-- Carousel Slides -->
        <div class="js-slide h-100 g-flex-centered g-bg-img-hero g-bg-cover g-bg-black-opacity-0_2--after" style="background-image: url({{ asset('asset_education/img-temp') }}/1920x1080/img6.jpg);">
          <div class="container">
            <div class="g-max-width-600 g-pos-rel g-z-index-1">
              <a class="d-block g-text-underline--none--hover" href="#">
                <span class="d-block g-color-white g-font-size-20--md mb-2">
        ...
        <!-- Carousel Slides -->
        <div class="js-slide h-100 g-flex-centered g-bg-img-hero g-bg-pos-top-center g-bg-cover g-bg-black-opacity-0_3--after" style="background-image: url({{ asset('asset_education/img-temp') }}/1920x1080/img7.jpg);">
          <div class="container">
            <div class="g-max-width-600 g-pos-rel g-z-index-1">
              <a class="d-block g-text-underline--none--hover" href="#">
                <span class="d-block g-color-white g-font-size-20--md mb-2">
          ...
          <div class="row align-items-lg-center">
            <div class="col-lg-7 order-lg-2 g-mb-50">
              <div class="g-pos-rel g-pl-15--lg">
                <img class="img-fluid w-100 u-shadow-v19 g-brd-around g-brd-7 g-brd-secondary rounded" src="{{ asset('asset_education/img-temp') }}/600x400/img1.jpg" alt="Image Description">
              ...
              <div class="media g-max-width-300">
                <div class="d-flex mr-3">
                  <div class="g-width-40 g-height-40">
                    <img class="img-fluid g-brd-around g-brd-2 g-brd-white rounded-circle" src="{{ asset('asset_education/img-temp') }}/100x100/img1.jpg" alt="Image Description">
                  </div>
                </div>
                <div class="media-body">
        ...
        <div class="container g-pt-70 g-pb-20">
          <div class="js-carousel" data-pagi-classes="u-carousel-indicators-v35--white g-pos-rel text-center">
            ...
            <div class="js-slide">
              <div class="row justify-content-lg-center g-mb-20">
                <div class="col-md-3 col-lg-2 g-mb-20">
                  <img class="img-fluid u-shadow-v36 rounded-circle mx-auto" src="{{ asset('asset_education/img-temp') }}/200x200/img3.jpg" alt="Image Description">
                </div>
            ...
            <div class="js-slide">
              <div class="row justify-content-lg-center g-mb-20">
                <div class="col-md-3 col-lg-2 g-mb-20">
                  <img class="img-fluid u-shadow-v36 rounded-circle mx-auto" src="{{ asset('asset_education/img-temp') }}/200x200/img1.jpg" alt="Image Description">
                </div>
            ...
            <div class="js-slide">
              <div class="row justify-content-lg-center g-mb-20">
                <div class="col-md-3 col-lg-2 g-mb-20">
                  <img class="img-fluid u-shadow-v36 rounded-circle mx-auto" src="{{ asset('asset_education/img-temp') }}/200x200/img2.jpg" alt="Image Description">
                </div>
            ...
            <div class="js-slide">
              <div class="row justify-content-lg-center g-mb-20">
                <div class="col-md-3 col-lg-2 g-mb-20">
                  <img class="img-fluid u-shadow-v36 rounded-circle mx-auto" src="{{ asset('asset_education/img-temp') }}/200x200/img4.jpg" alt="Image Description">
                </div>
      ...
      <div class="container g-pt-100">
        <div class="g-px-30--lg">
          ...
          <div class="js-carousel u-carousel-v5 g-mx-minus-15"
            ...
            <!-- News -->
            <div class="js-slide u-shadow-v38 g-bg-size-cover g-bg-pos-center rounded g-mx-15 g-my-30" style="background-image: url({{ asset('asset_education/img-temp') }}/400x500/img1.jpg);">
            ...
            <!-- News -->
            <div class="js-slide u-shadow-v38 g-bg-size-cover g-bg-pos-center rounded g-mx-15 g-my-30" style="background-image: url({{ asset('asset_education/img-temp') }}/400x500/img3.jpg);">
              <article class="align-self-end text-center g-pos-rel g-z-index-1 g-pa-40 mx-auto">
            ...
            <!-- News -->
            <div class="js-slide u-shadow-v38 g-bg-size-cover g-bg-pos-center rounded g-mx-15 g-my-30" style="background-image: url({{ asset('asset_education/img-temp') }}/400x500/img2.jpg);">
              <article class="align-self-end text-center g-pos-rel g-z-index-1 g-pa-40 mx-auto">
