...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Forms Layout | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-4 align-items-center">
                                            ...
                                            <div class="col-sm-6 text-center">
                                                ...
                                                <a href="{{ asset('auth-sign-up.html') }}" class="link-primary text-decoration-underline fw-semibold link-offset-3">Create Your Account</a>
                                            </div>
                                        </div>
                                        <!-- end row-->
                                    </div>
