            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="text-center my-2">
                        <a href="#!" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all
                            Links <i class="ti ti-link"></i> </a>
                    </div>
                </div>
                <!-- end card-body-->
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-end mt-3">
                        <a href="{{ asset('chat.html') }}"
                            class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Links <i
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-2">
                        <a href="{{ asset('chat.html') }}"
                            class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Countries <i
        ...
        <div class="col-xl-4">
            <div class="card border-top-0">
                <div class="position-relative card-side-img overflow-hidden rounded-top"
                    style="height: 180px; background-image: url('{{ asset('assets/images/profile-bg.jpg') }}')">
                    <div
                ...
                <div class="card-body position-relative">
                    <div class="d-flex justify-content-start gap-3">
                        <div class="avatar avatar-xxl" style="margin-top: -60px">
                            <a href="#!">
                                <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="User Profile"
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <div class="d-flex justify-content-between mt-2 text-muted">
                                ...
                                <a href="javascript:void(0);"
                                    class="link-primary fw-semibold d-inline-flex align-items-center gap-1"> <i
                                        class="ti ti-arrow-back-up"></i> Reply </a>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        ...
                        <div class="avatar-group avatar-group-xs">
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-4.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-7.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-1.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-2.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                        </div>
                        <div>
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        ...
                        <div class="avatar-group avatar-group-xs">
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-8.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-2.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-6.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-9.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-10.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                        </div>
                        <div>
                            <a href="#" class="btn btn-sm btn-icon btn-default" title="Download"><i
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        ...
                        <div class="avatar-group avatar-group-xs">
                            ...
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-1.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-3.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                            <div class="avatar"><img src="{{ asset('assets/images/users/user-6.jpg') }}"
                                    class="rounded-circle avatar-xs" alt="" /></div>
                        </div>
