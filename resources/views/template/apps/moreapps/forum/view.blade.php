...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Forum | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ asset('apps-forum-post.html') }}" class="link-reset">What's the best JavaScript framework in 2025?</a>
                                                    </h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ asset('apps-forum-post.html') }}" class="link-reset">Should AI tools be regulated by governments?</a>
                                                    </h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ asset('apps-forum-post.html') }}" class="link-reset">Is minimalism still relevant in modern UI design?</a>
                                                    </h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ asset('apps-forum-post.html') }}" class="link-reset">What’s better for growth: startups or large companies?</a>
                                                    </h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ asset('apps-forum-post.html') }}" class="link-reset">CI/CD or traditional release cycles: what works better?</a>
                                                    </h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ asset('apps-forum-post.html') }}" class="link-reset">What’s the best way to start contributing to open source?</a>
                                                    </h4>
