            ...
            <div class="row row-cols-xl-3 row-cols-md-2 row-cols-1 g-3">
                <div class="col">
                    <div class="card border h-100 p-3">
                        ...
                        <p class="text-muted fs-13 mb-2">The signature INSPINIA theme featuring rich teal/emerald accents and high-contrast typography.</p>
                ...
                <div class="col">
                    <div class="card border h-100 p-3">
                        ...
                        <p class="text-muted fs-13 mb-2">Tailored for SaaS products with soft indigo primary hues and modern border radiuses.</p>
                ...
                <div class="col">
                    <div class="card border h-100 p-3">
                        ...
                        <p class="text-muted fs-13 mb-2">Inspired by Material Design principles with vibrant primary colors and floating shadows.</p>
                ...
                <div class="col">
                    <div class="card border h-100 p-3">
                        ...
                        <p class="text-muted fs-13 mb-2">Contemporary layout styling with rounded cards and sleek borders.</p>
                ...
                <div class="col">
                    <div class="card border h-100 p-3">
                        ...
                        <p class="text-muted fs-13 mb-2">Futuristic dark gradient theme designed for AI & analytics applications.</p>
