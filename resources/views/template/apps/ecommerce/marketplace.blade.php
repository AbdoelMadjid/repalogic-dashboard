...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Marketplace | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                    ...
                    <div class="container-xxl">
                                ...
                                <div class="card bg-success bg-opacity-10 bg-gradient">
                                    <div class="card-body pb-0 d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="fw-semibold link-reset d-inline-block my-3"> View All <i class="ti ti-arrow-right bi align-middle fs-lg"></i> </a>
                                        </div>
                                ...
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Modern Minimalist Fabric Sofa Single Seater</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(45)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Funky Streetwear Sneakers - Neon Splash</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(32)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Noise Canceling Wireless Earbuds - Black Edition</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(58)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Minimalist Solid Wood Dining Chair</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(46)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Modern Black Minimalist Wall Clock</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(62)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Elegant Brown Wooden Chair</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(48)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple iMac 24" Retina 4.5K Display</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(65)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Coolest Ergonomic Lounge Chair</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(52)</a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card card-h-100 d-none d-lg-block d-xxl-none">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple iPad 10.9" Wi-Fi 64GB - Silver</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1">
                                                <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(142)</a>
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 text-end">
                                <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="btn btn-success mt-3"> View More Products <i class="ti ti-arrow-right bi align-middle fs-lg"></i> </a>
                            </div>
                        </div>
