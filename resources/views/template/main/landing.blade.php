            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div>
                        ...
                        <a href="{{ asset('auth-sign-in.html') }}" class="btn btn-link fw-semibold text-body ps-2">SIGN
                            IN</a>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <p class="mb-4 fs-sm text-muted lh-lg">
                        Build powerful, modern web applications with our top-rated Admin Dashboard Template. Designed
                        for performance, flexibility, and ease of customization, it’s the perfect solution for startups,
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Crafting data-driven strategies to maximize online growth and
                                brand engagement.</p>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Connect with your audience and boost conversions through
                                targeted email campaigns.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
                                    class="ti ti-arrow-right ms-2 align-middle"></i></a>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 p-2 card-h-100">
                        <div class="card-body pb-0">
                            ...
                            <p class="text-muted mb-3">Produce compelling visuals and copy to drive traffic and build
                                brand identity.</p>
                        </div>
                        <div class="card-footer border-0 pt-0">
                            <a class="link-primary fw-semibold" href="#">Know more<i
        ...
        <div class="container">
            <div class="row align-items-center pb-5">
                ...
                <div class="col-lg-5 ms-auto py-3">
                    ...
                    <p class="mb-2 lead">Fast, secure, and intuitive—our chat platform empowers teams and communities
                        to communicate effortlessly, no matter the distance.</p>
                    <p class="text-muted fs-sm mb-4">Experience seamless messaging with built-in privacy features and
                        unmatched reliability.</p>
                    <a href="{{ asset('chat.html') }}" class="btn btn-primary mb-4">Check Chat App</a>

                    <!-- Counter -->
                    <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
                        <div>
                            <h3 class="mb-2"><span data-target="99.2">0</span><span class="text-primary">%</span>
                            </h3>
                            <p class="text-muted mb-0">User satisfaction</p>
                        </div>

                        <div>
                            <h3 class="mb-2"><span data-target="7.4">0</span><span class="text-primary">x</span>
                            </h3>
                            <p class="text-muted mb-0">Monthly user growth</p>
                        </div>

                        <div>
                            <h3 class="mb-2"><span data-target="1200">0</span><span class="text-primary">+</span>
                            </h3>
            ...
            <div class="row align-items-center py-5">
                <div class="col-lg-5 py-5 order-2 order-lg-1">
                    ...
                    <p class="mb-2 lead">A powerful, secure, and intuitive file manager built to simplify how
                        individuals and teams store, share, and organize files.</p>
                    <p class="text-muted fs-sm mb-4">Access files instantly, collaborate in real-time, and enjoy peace
                        of mind with encrypted storage.</p>
                    <a href="{{ asset('file-manager.html') }}" class="btn btn-primary mb-4">Explore File Manager</a>

                    <!-- Counter -->
                    <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
                        <div>
                            <h3 class="mb-2"><span data-target="99.5">0</span><span class="text-primary">%</span>
                            </h3>
                            <p class="text-muted mb-0">File recovery success rate</p>
                        </div>

                        <div>
                            <h3 class="mb-2"><span data-target="3.2">0</span><span class="text-primary">x</span>
                            </h3>
                            <p class="text-muted mb-0">Faster upload speed</p>
                        </div>

                        <div>
                            <h3 class="mb-2"><span data-target="1500">0</span><span class="text-primary">+</span>
                            </h3>
            ...
            <div class="row align-items-center py-5">
                ...
                <div class="col-lg-5 ms-auto py-3">
                    ...
                    <p class="mb-2 lead">Our smart contacts app keeps all your relationships organized, accessible, and
                        in sync across devices—at home or on the go.</p>
                    <p class="text-muted fs-sm mb-4">Effortlessly import, categorize, and interact with contacts
                        through a clean, privacy-focused interface.</p>
                    <a href="{{ asset('contacts.html') }}" class="btn btn-primary mb-4">Check Contacts App</a>

                    <!-- Counter -->
                    <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
                        <div>
                            <h3 class="mb-2"><span data-target="97.5">0</span><span class="text-primary">%</span>
                            </h3>
                            <p class="text-muted mb-0">Sync reliability</p>
                        </div>

                        <div>
                            <h3 class="mb-2"><span data-target="4.2">0</span><span class="text-primary">x</span>
                            </h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Choose the <mark class="fst-italic">License</mark> That Fits Your
                        Needs</h2>
                </div>
            </div>
            <!-- end row-->
                            ...
                            <div class="card h-100 bg-light bg-opacity-10 border-light rounded-3">
                                <div class="card-body px-lg-4 p-5 pb-2 text-center">
                                    ...
                                    <ul class="list-unstyled text-start fs-sm fw-medium mb-0">
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> 1
                                            project usage</li>
                                        ...
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Basic
                                            documentation</li>
                                        <li class="mb-2"><i class="ti ti-x text-danger me-2 fs-5"></i> No
                                            multi-client use</li>
                                        <li class="mb-2"><i class="ti ti-x text-danger me-2 fs-5"></i> No
                                            SaaS/resale rights</li>
                                    </ul>
                                </div>
                            ...
                            <div class="card h-100 bg-light bg-opacity-10 border-dashed border my-4 my-lg-0 rounded-3">
                                <div class="card-body px-lg-4 p-5 pb-2 text-center">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">For developers or agencies working with multiple
                                            clients</p>
                                    </div>
                                    <div class="my-4">
                                    ...
                                    <ul class="list-unstyled text-start fs-sm fw-medium mb-0">
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i> Use in
                                            up to 5 projects</li>
                                        <li class="mb-2"><i class="ti ti-check text-success me-2 fs-5"></i>
                                            Commercial client use</li>
                            ...
                            <div class="card h-100 bg-light bg-opacity-10 border-light rounded-3">
                                <div class="card-body px-lg-4 p-5 pb-2 text-center">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">For SaaS products or items offered in paid
                                            applications</p>
                                    </div>
                                    <div class="my-4">
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"This gadget exceeded all my expectations.
                                Sleek design and incredible performance!"</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card border-light rounded-4 p-3 card-h-100">
                        <div class="card-body pb-0 text-center">
                            ...
                            <p class="text-muted mb-3 fst-italic fs-sm">"The performance and features are unmatched in
                                this price range. Highly impressed!"</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Explore Our <mark class="fst-italic">Latest</mark> Articles and
                        Updates</h2>
                </div>
            </div>
            <!-- end row-->
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <article class="card rounded-3 border-0 shadow-sm">
                        <!-- Badge -->
                        <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3">Technology
                        </div>
                ...
                <div class="col-lg-4">
                    <article class="card rounded-3 border-0 shadow-sm">
                        <!-- Badge -->
                        <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3">Data Science
                        </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                ...
                                <h5 class="my-1 lh-lg">INSPINIA HQ, 123 Market Street, 5th Floor, Financial District,
                                    San Francisco, CA 94103, United States</h5>
                            </div>
                        </div>
                    </div>
                    <!-- end .p-4-->
