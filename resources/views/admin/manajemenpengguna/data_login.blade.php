...
@section('content')
    <link href="{{ asset('assets/css/admin/manajemenpengguna/data_login.css') }}" rel="stylesheet" type="text/css" />
    ...
    <script>
        window.DataLoginConfig = {
            routes: {
                base: "{{ url('admin/manajemenpengguna/data-login') }}"
            }
        };
    </script>
    <script src="{{ asset('assets/js/admin/manajemenpengguna/data_login.js') }}"></script>
@endsection
