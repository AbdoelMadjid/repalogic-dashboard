                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="invalidCheck"
                                        required />
                                    <label class="form-check-label" for="invalidCheck">I agree to the terms and
                                        conditions</label>
                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <input type="text" class="form-control" id="studentCity" value="Palo Alto"
                                    required />
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="agreementCheck"
                                        required />
                                    <label class="form-check-label" for="agreementCheck">I confirm my enrollment at
                                        Stanford University.</label>
                    ...
                    <div class="card-body">
                        <form class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="validationServer03Feedback" class="invalid-feedback">Please provide a valid city.
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div id="validationServer04Feedback" class="invalid-feedback">Please select a valid state.
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div id="validationServer05Feedback" class="invalid-feedback">Please provide a valid zip.
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-check">
