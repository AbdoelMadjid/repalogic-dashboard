...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Seller Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                    ...
                                    <div data-table data-table-rows-per-page="8" class="card">
                                        <div class="card-header border-light justify-content-between">
                                            ...
                                            <div class="d-flex gap-1">
                                                ...
                                                <a href="{{ asset('apps-ecommerce-product-add.html') }}" class="btn btn-danger ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Product </a>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="mb-0">
                                                                        <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Gaming Laptop Pro</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="mb-0">
                                                                        <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Vintage Leather Wallet</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
