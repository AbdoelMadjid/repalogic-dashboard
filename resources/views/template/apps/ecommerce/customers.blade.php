...
<head>
    <meta charset="utf-8" />
    <title>Customers | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-10">
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div
                                class="card-header border-light d-flex align-items-center justify-content-between flex-wrap gap-2">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <!-- Export Dropdown -->
                                    <div class="dropdown">
                                        <button class="btn btn-default dropdown-toggle drop-arrow-none"
                                            type="button" data-bs-toggle="dropdown" aria-expanded="false"><i
                                                class="ti ti-download me-1"></i> Export <i
                                                class="ti ti-chevron-down align-middle ms-1"></i></button>
                                    ...
                                    <a href="#!" class="btn btn-primary"> <i
                                            class="ti ti-plus me-1 fs-sm"></i> Add Customer </a>
                                </div>
                            </div>
                                ...
                                <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="customer" href="#!"
                                                                class="link-reset">Carlos Méndez</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/us.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                United States</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="customer" href="#!"
                                                                class="link-reset">Sophie Laurent</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/fr.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                France</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/jp.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                Japan</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="customer" href="#!"
                                                                class="link-reset">Emma Watson</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/gb.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                United Kingdom</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/de.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                Germany</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/it.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                Italy</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/ar.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                Argentina</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/in.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                India</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="customer" href="#!"
                                                                class="link-reset">Liam O’Connor</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/au.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                Australia</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="customer" href="#!"
                                                                class="link-reset">Olga Petrova</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img src="{{ asset('assets/images/flags/ru.svg') }}"
                                                    alt="" class="rounded-circle me-1" height="16" />
                                                Russia</td>
