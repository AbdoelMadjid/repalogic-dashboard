                ...
                <div class="card">
                    <div class="card-header d-block">
                        ...
                        <p class="text-muted mb-0">
                            A UI concept which merges loading indicators into the action that invoked them. Primarily
                            intended for use with forms where it gives users immediate feedback upon submit rather than
                            leaving them wondering while the browser does its
                            thing.
                        </p>
                    </div>
                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-primary"
                                                data-style="expand-up">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-primary"
                                                data-style="expand-down">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-warning"
                                                data-style="contract">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-info"
                                                data-style="slide-left">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-info"
                                                data-style="slide-right">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-info"
                                                data-style="slide-down">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button class="ladda-button btn btn-danger"
                                                data-style="expand-right">Submit</button>
                                        </td>
                                    </tr>
                                    <tr>
