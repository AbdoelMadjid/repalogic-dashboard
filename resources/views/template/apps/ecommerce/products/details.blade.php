                                    ...
                                    <div id="carouselExampleFade" class="carousel slide carousel-fade"
                                        ...
                                        <div class="carousel-inner bg-light bg-opacity-25 border border-light border-dashed rounded-3"
                                            ...
                                            <div class="carousel-item text-center active">
                                                <img src="{{ asset('assets/images/products/single-1.png') }}" alt=""
                                                    class="img-fluid" />
                                            </div>
                                            <div class="carousel-item text-center">
                                                <img src="{{ asset('assets/images/products/single-2.png') }}" alt=""
                                                    class="img-fluid" />
                                            </div>
                                            <div class="carousel-item text-center">
                                                <img src="{{ asset('assets/images/products/single-3.png') }}" alt=""
                                                    class="img-fluid" />
                                            </div>
                                            <div class="carousel-item text-center">
                                                <img src="{{ asset('assets/images/products/single-4.png') }}" alt=""
                                                    class="img-fluid" />
                                            </div>
                                        </div>
                                        <div
                                        ...
                                        <div class="row align-items-center g-0">
                                            <div class="col-xl-7">
                                                <div class="d-flex align-items-center gap-4 p-4">
                                                    <img src="{{ asset('assets/images/ratings.svg') }}" alt="Product"
                                                        height="80" />
                                                    <div>
                                                        <h3
                                                        ...
                                                        <span class="badge badge-label text-bg-success">+12
                                                            new this week</span>
                                                    </div>
                                                </div>
                                            </div>
