                            ...
                            <table class="table mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary"
                                                id="sweetalert-basic">Click me</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary"
                                                id="sweetalert-title">Click Me</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="button" id="sweetalert-info"
                                                    class="btn btn-sm btn-info">Toggle Info</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" id="sweetalert-close"
                                                class="btn btn-sm btn-secondary">Click Me</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-2">
                                                <button class="btn btn-sm btn-primary" id="position-top-start">Top
                                                    Start</button>
                                                <button class="btn btn-sm btn-primary" id="position-top-end">Top
                                                    End</button>
