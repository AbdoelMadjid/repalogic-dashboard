                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu">
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle drop-arrow-none" href="#" id="topnav-main"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-ecommerce" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-columns"
                                            ...
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-products" role="button"
                                            ...
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-orders" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                            ...
                                            <a href="{{ asset('apps-ecommerce-customers.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-ecommerce-customers">Customers</span></a>
                                            <a href="{{ asset('apps-ecommerce-cart.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-ecommerce-cart">Cart</span></a>
                                            <a href="{{ asset('apps-ecommerce-checkout.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-ecommerce-checkout">Checkout</span></a>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-sellers" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                            ...
                                            <a href="{{ asset('apps-ecommerce-refunds.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-ecommerce-refunds">Refunds</span></a>
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-ecommerce-reviews">Reviews</span></a>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-inventory" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                            ...
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-reports" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-email" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-email">
                                            <a href="{{ asset('apps-email-inbox.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-email-inbox">Inbox</span></a>
                                            <a href="{{ asset('apps-email-details.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-email-details">Details</span></a>
                                            <a href="{{ asset('apps-email-compose.html') }}"
                                                class="dropdown-item"><span
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-users" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="users">Users</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-users">
                                            <a href="{{ asset('apps-users-contacts.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-users-contacts">Contacts</span></a>
                                            <a href="{{ asset('apps-users-roles.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-users-roles">Roles</span></a>
                                            <a href="{{ asset('apps-users-role-details.html') }}"
                                                class="dropdown-item"><span data-lang="apps-users-role-details">Role
                                                    Details</span></a>
                                            <a href="{{ asset('apps-users-permissions.html') }}"
                                                class="dropdown-item"><span
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-projects" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="projects">Projects</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-projects">
                                            <a href="{{ asset('apps-projects-grid.html') }}"
                                                class="dropdown-item"><span data-lang="apps-projects-grid">My
                                                    Projects</span></a>
                                            <a href="{{ asset('apps-projects-list.html') }}"
                                                class="dropdown-item"><span data-lang="apps-projects-list">Projects
                                                    List</span></a>
                                            <a href="{{ asset('apps-projects-details.html') }}"
                                                class="dropdown-item"><span data-lang="apps-projects-details">View
                                                    Project</span></a>
                                            <a href="{{ asset('apps-projects-kanban.html') }}"
                                                class="dropdown-item"><span data-lang="apps-projects-kanban">Kanban
                                                    Board</span></a>
                                            <a href="{{ asset('apps-projects-team-board.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-projects-team-board">Team Board</span></a>
                                            <a href="{{ asset('apps-projects-activity.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-projects-activity">Activity Steam</span></a>
                                        </div>
                                    </div>
                                    <a href="{{ asset('apps-file-manager.html') }}" class="dropdown-item"><span
                                            data-lang="apps-file-manager">File Manager</span></a>
                                    <a href="{{ asset('apps-chat.html') }}" class="dropdown-item"><span
                                            data-lang="apps-chat">Chat</span></a>
                                    <a href="{{ asset('apps-calendar.html') }}" class="dropdown-item"><span
                                            data-lang="apps-calendar">Calendar</span></a>
                                    <a href="{{ asset('apps-social-feed.html') }}" class="dropdown-item"><span
                                            data-lang="apps-social-feed">Social Feed</span></a>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-invoice" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="invoice">Invoice</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-invoice">
                                            <a href="{{ asset('apps-invoice-list.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="apps-invoice-list">Invoices</span></a>
                                            <a href="{{ asset('apps-invoice-details.html') }}"
                                                class="dropdown-item"><span data-lang="apps-invoice-details">Single
                                                    Invoice</span></a>
                                            <a href="{{ asset('apps-invoice-create.html') }}"
                                                class="dropdown-item"><span data-lang="apps-invoice-create">New
                                                    Invoice</span></a>
                                        </div>
                                    </div>
                                    <a href="{{ asset('apps-companies.html') }}" class="dropdown-item"><span
                                            data-lang="apps-companies">Companies</span></a>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-more-apps" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="more-apps">More Apps</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-more-apps">
                                            <a href="{{ asset('apps-clients.html') }}" class="dropdown-item"><span
                                                    data-lang="apps-clients">Clients</span></a>
                                            <a href="{{ asset('apps-outlook.html') }}" class="dropdown-item"><span
                                                    data-lang="apps-outlook">Outlook View</span></a>
                                            <a href="{{ asset('apps-vote-list.html') }}"
                                                class="dropdown-item"><span data-lang="apps-vote-list">Vote
                                                    List</span></a>
                                            <a href="{{ asset('apps-issue-tracker.html') }}"
                                                class="dropdown-item"><span data-lang="apps-issue-tracker">Issue
                                                    Tracker</span></a>
                                            <a href="{{ asset('apps-api-keys.html') }}" class="dropdown-item"><span
                                                    data-lang="apps-api-keys">API Keys</span></a>
                                            <a href="{{ asset('apps-manage.html') }}" class="dropdown-item"><span
                                                    data-lang="apps-manage">Manage Apps</span></a>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-blog" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-submenu-blog">
                                                    <a href="{{ asset('apps-blog-list.html') }}"
                                                        class="dropdown-item"><span data-lang="apps-blog-list">Blog
                                                            List</span></a>
                                                    <a href="{{ asset('apps-blog-grid.html') }}"
                                                        class="dropdown-item"><span data-lang="apps-blog-grid">Blog
                                                            Grid</span></a>
                                                    <a href="{{ asset('apps-blog-article.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="apps-blog-article">Article</span></a>
                                                    <a href="{{ asset('apps-blog-add.html') }}"
                                                        class="dropdown-item"><span data-lang="apps-blog-add">Add
                                                            Article</span></a>
                                                </div>
                                            </div>
                                            <a href="{{ asset('apps-pin-board.html') }}"
                                                class="dropdown-item"><span data-lang="apps-pin-board">Pin
                                                    Board</span></a>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-forum" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle drop-arrow-none" href="#"
                                    id="topnav-custom-pages" role="button" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-custom-pages">
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-pages" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-columns"
                                            ...
                                            <a href="{{ asset('pages-profile.html') }}" class="dropdown-item"><span
                                                    data-lang="pages-profile">Profile</span></a>
                                            <a href="{{ asset('pages-account-settings.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="pages-account-settings">Account Settings</span></a>
                                            <a href="{{ asset('pages-faq.html') }}" class="dropdown-item"><span
                                                    data-lang="pages-faq">FAQ</span></a>
                                            <a href="{{ asset('pages-pricing.html') }}" class="dropdown-item"><span
                                                    data-lang="pages-pricing">Pricing</span></a>
                                            <a href="{{ asset('pages-empty.html') }}" class="dropdown-item"><span
                                                    data-lang="pages-empty">Empty Page</span></a>
                                            <a href="{{ asset('pages-timeline.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="pages-timeline">Timeline</span></a>
                                            <a href="{{ asset('pages-gallery.html') }}" class="dropdown-item"><span
                                                    data-lang="pages-gallery">Gallery</span></a>
                                            <a href="{{ asset('pages-sitemap.html') }}" class="dropdown-item"><span
                                                    data-lang="pages-sitemap">Sitemap</span></a>
                                            <a href="{{ asset('pages-search-results.html') }}"
                                                class="dropdown-item"><span data-lang="pages-search-results">Search
                                                    Results</span></a>
                                            <a href="{{ asset('pages-coming-soon.html') }}"
                                                class="dropdown-item"><span data-lang="pages-coming-soon">Coming
                                                    Soon</span></a>
                                            <a href="{{ asset('pages-privacy-policy.html') }}"
                                                class="dropdown-item"><span data-lang="pages-privacy-policy">Privacy
                                                    Policy</span></a>
                                            <a href="{{ asset('pages-terms-conditions.html') }}"
                                                class="dropdown-item"><span data-lang="pages-terms-conditions">Terms
                                                    &amp; Conditions</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-plugins" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-columns"
                                            ...
                                            <a href="{{ asset('plugins-sortable.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-sortable">Sortable
                                                    List</span></a>
                                            <a href="{{ asset('plugins-text-diff.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-text-diff">Text
                                                    Diff</span></a>
                                            <a href="{{ asset('plugins-pdf-viewer.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-pdf-viewer">PDF
                                                    Viewer</span></a>
                                            <a href="{{ asset('plugins-i18.html') }}" class="dropdown-item"><span
                                                    data-lang="plugins-i18">i18 Support</span></a>
                                            <a href="{{ asset('plugins-sweet-alerts.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-sweet-alerts">Sweet
                                                    Alerts</span></a>
                                            <a href="{{ asset('plugins-idle-timer.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-idle-timer">Idle
                                                    Timer</span></a>
                                            <a href="{{ asset('plugins-pass-meter.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-pass-meter">Password
                                                    Meter</span></a>
                                            <a href="{{ asset('plugins-live-favicon.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-live-favicon">Live
                                                    Favicon</span></a>
                                            <a href="{{ asset('plugins-clipboard.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="plugins-clipboard">Clipboard</span></a>
                                            <a href="{{ asset('plugins-tree-view.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-tree-view">Tree
                                                    View</span></a>
                                            <a href="{{ asset('plugins-loading-buttons.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="plugins-loading-buttons">Loading Buttons</span></a>
                                            <a href="{{ asset('plugins-masonry.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="plugins-masonry">Masonry</span></a>
                                            <a href="{{ asset('plugins-tour.html') }}" class="dropdown-item"><span
                                                    data-lang="plugins-tour">Tour</span></a>
                                            <a href="{{ asset('plugins-animation.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="plugins-animation">Animation</span></a>
                                            <a href="{{ asset('plugins-video-player.html') }}"
                                                class="dropdown-item"><span data-lang="plugins-video-player">Video
                                                    Player</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-authentication" role="button"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-authentication">
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-auth-basic" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu"
                                                    ...
                                                    <a href="{{ asset('auth-sign-in.html') }}"
                                                        class="dropdown-item"><span data-lang="auth-sign-in">Sign
                                                            In</span></a>
                                                    <a href="{{ asset('auth-sign-up.html') }}"
                                                        class="dropdown-item"><span data-lang="auth-sign-up">Sign
                                                            Up</span></a>
                                                    <a href="{{ asset('auth-reset-pass.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-reset-pass">Reset Password</span></a>
                                                    <a href="{{ asset('auth-new-pass.html') }}"
                                                        class="dropdown-item"><span data-lang="auth-new-pass">New
                                                            Password</span></a>
                                                    <a href="{{ asset('auth-two-factor.html') }}"
                                                        class="dropdown-item"><span data-lang="auth-two-factor">Two
                                                            Factor</span></a>
                                                    <a href="{{ asset('auth-lock-screen.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-lock-screen">Lock Screen</span></a>
                                                    <a href="{{ asset('auth-success-mail.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-success-mail">Success Mail</span></a>
                                                    <a href="{{ asset('auth-login-pin.html') }}"
                                                        class="dropdown-item"><span data-lang="auth-login-pin">Login
                                                            with PIN</span></a>
                                                    <a href="{{ asset('auth-delete-account.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-delete-account">Delete Account</span></a>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-auth-card" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu"
                                                    ...
                                                    <a href="{{ asset('auth-card-sign-in.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-sign-in">Sign In</span></a>
                                                    <a href="{{ asset('auth-card-sign-up.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-sign-up">Sign Up</span></a>
                                                    <a href="{{ asset('auth-card-reset-pass.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-reset-pass">Reset Password</span></a>
                                                    <a href="{{ asset('auth-card-new-pass.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-new-pass">New Password</span></a>
                                                    <a href="{{ asset('auth-card-two-factor.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-two-factor">Two Factor</span></a>
                                                    <a href="{{ asset('auth-card-lock-screen.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-lock-screen">Lock Screen</span></a>
                                                    <a href="{{ asset('auth-card-success-mail.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-success-mail">Success Mail</span></a>
                                                    <a href="{{ asset('auth-card-login-pin.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-card-login-pin">Login with PIN</span></a>
                                            ...
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-auth-split" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu"
                                                    ...
                                                    <a href="{{ asset('auth-split-sign-in.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-split-sign-in">Sign In</span></a>
                                                    <a href="{{ asset('auth-split-sign-up.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-split-sign-up">Sign Up</span></a>
                                                    ...
                                                    <a href="{{ asset('auth-split-new-pass.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-split-new-pass">New Password</span></a>
                                                    <a href="{{ asset('auth-split-two-factor.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-split-two-factor">Two Factor</span></a>
                                                    <a href="{{ asset('auth-split-lock-screen.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-split-lock-screen">Lock Screen</span></a>
                                                    ...
                                                    <a href="{{ asset('auth-split-login-pin.html') }}"
                                                        class="dropdown-item"><span
                                                            data-lang="auth-split-login-pin">Login with PIN</span></a>
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-error-pages" role="button"
                                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="error-pages">Error Pages</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-error-pages">
                                            <a href="{{ asset('error-400.html') }}" class="dropdown-item"><span
                                                    data-lang="error-400">400 Bad Request</span></a>
                                            <a href="{{ asset('error-401.html') }}" class="dropdown-item"><span
                                                    data-lang="error-401">401 Unauthorized</span></a>
                                            <a href="{{ asset('error-403.html') }}" class="dropdown-item"><span
                                                    data-lang="error-403">403 Forbidden</span></a>
                                            <a href="{{ asset('error-404.html') }}" class="dropdown-item"><span
                                                    data-lang="error-404">404 Not Found</span></a>
                                            <a href="{{ asset('error-408.html') }}" class="dropdown-item"><span
                                                    data-lang="error-408">408 Request Timeout</span></a>
                                            <a href="{{ asset('error-500.html') }}" class="dropdown-item"><span
                                                    data-lang="error-500">500 Internal Server</span></a>
                                            <a href="{{ asset('error-maintenance.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="error-maintenance">Maintenance</span></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-layout-options" role="button"
                                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="layout-options">Layout Options</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-layout-options">
                                            <a href="{{ asset('layouts-scrollable.html') }}" class="dropdown-item"
                                                target="_blank"><span
                                                    data-lang="layouts-scrollable">Scrollable</span></a>
                                            <a href="{{ asset('layouts-compact.html') }}" class="dropdown-item"
                                                target="_blank"><span data-lang="layouts-compact">Compact</span></a>
                                            <a href="{{ asset('layouts-boxed.html') }}" class="dropdown-item"
                                                target="_blank"><span data-lang="layouts-boxed">Boxed</span></a>
                                            <a href="{{ asset('layouts-horizontal.html') }}" class="dropdown-item"
                                                target="_blank"><span
                                                    data-lang="layouts-horizontal">Horizontal</span></a>
                                            <a href="{{ asset('layouts-preloader.html') }}" class="dropdown-item"
                                                target="_blank"><span
                                                    data-lang="layouts-preloader">Preloader</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-sidebars" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="sidebars">Sidebars</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-sidebars">
                                            <a href="{{ asset('layouts-sidebar-light.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-light">Light Menu</span></a>
                                            <a href="{{ asset('layouts-sidebar-gradient.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-gradient">Gradient Menu</span></a>
                                            <a href="{{ asset('layouts-sidebar-gray.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-gray">Gray Menu</span></a>
                                            <a href="{{ asset('layouts-sidebar-image.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-image">Image Menu</span></a>
                                            <a href="{{ asset('layouts-sidebar-compact.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-compact">Compact Menu</span></a>
                                            <a href="{{ asset('layouts-sidebar-on-hover.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-on-hover">On Hover Menu</span></a>
                                            <a href="{{ asset('layouts-sidebar-on-hover-active.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-on-hover-active">On Hover
                                                    Active</span></a>
                                            <a href="{{ asset('layouts-sidebar-offcanvas.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-offcanvas">Offcanvas Menu</span></a>
                                            ...
                                            <a href="{{ asset('layouts-sidebar-with-lines.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-sidebar-with-lines">Sidebar with
                                                    Lines</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-topbar" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="topbar">Topbar</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-topbar">
                                            <a href="{{ asset('layouts-topbar-dark.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-topbar-dark">Dark Topbar</span></a>
                                            <a href="{{ asset('layouts-topbar-gray.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-topbar-gray">Gray Topbar</span></a>
                                            <a href="{{ asset('layouts-topbar-gradient.html') }}"
                                                class="dropdown-item" target="_blank"><span
                                                    data-lang="layouts-topbar-gradient">Gradient Topbar</span></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-components">
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-base-ui" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-columns"
                                            ...
                                            <a href="{{ asset('ui-accordions.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="ui-accordions">Accordions</span></a>
                                            <a href="{{ asset('ui-alerts.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-alerts">Alerts</span></a>
                                            <a href="{{ asset('ui-images.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-images">Images</span></a>
                                            <a href="{{ asset('ui-badges.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-badges">Badges</span></a>
                                            <a href="{{ asset('ui-breadcrumb.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="ui-breadcrumb">Breadcrumb</span></a>
                                            <a href="{{ asset('ui-buttons.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-buttons">Buttons</span></a>
                                            <a href="{{ asset('ui-cards.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-cards">Cards</span></a>
                                            <a href="{{ asset('ui-carousel.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-carousel">Carousel</span></a>
                                            <a href="{{ asset('ui-collapse.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-collapse">Collapse</span></a>
                                            <a href="{{ asset('ui-colors.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-colors">Colors</span></a>
                                            <a href="{{ asset('ui-dropdowns.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-dropdowns">Dropdowns</span></a>
                                            <a href="{{ asset('ui-videos.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-videos">Videos</span></a>
                                            <a href="{{ asset('ui-grid.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-grid">Grid Options</span></a>
                                            <a href="{{ asset('ui-links.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-links">Links</span></a>
                                            <a href="{{ asset('ui-list-group.html') }}"
                                                class="dropdown-item"><span data-lang="ui-list-group">List
                                                    Group</span></a>
                                            <a href="{{ asset('ui-modals.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-modals">Modals</span></a>
                                            <a href="{{ asset('ui-notifications.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="ui-notifications">Notifications</span></a>
                                            <a href="{{ asset('ui-offcanvas.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-offcanvas">Offcanvas</span></a>
                                            <a href="{{ asset('ui-placeholders.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="ui-placeholders">Placeholders</span></a>
                                            <a href="{{ asset('ui-pagination.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="ui-pagination">Pagination</span></a>
                                            <a href="{{ asset('ui-popovers.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-popovers">Popovers</span></a>
                                            <a href="{{ asset('ui-progress.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-progress">Progress</span></a>
                                            <a href="{{ asset('ui-scrollspy.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-scrollspy">Scrollspy</span></a>
                                            <a href="{{ asset('ui-spinners.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-spinners">Spinners</span></a>
                                            <a href="{{ asset('ui-tabs.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-tabs">Tabs</span></a>
                                            <a href="{{ asset('ui-tooltips.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-tooltips">Tooltips</span></a>
                                            <a href="{{ asset('ui-typography.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="ui-typography">Typography</span></a>
                                            <a href="{{ asset('ui-utilities.html') }}" class="dropdown-item"><span
                                                    data-lang="ui-utilities">Utilities</span></a>
                                        </div>
                                    </div>
                                    <a href="{{ asset('widgets.html') }}" class="dropdown-item"><span
                                            data-lang="widgets">Widgets</span></a>
                                    <a href="{{ asset('metrics.html') }}" class="dropdown-item"><span
                                            data-lang="metrics">Metrics</span></a>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-charts" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-charts">
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-apex-charts" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                            ...
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-echarts" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-forms" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="forms">Forms</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-forms">
                                            <a href="{{ asset('form-elements.html') }}"
                                                class="dropdown-item"><span data-lang="form-elements">Basic
                                                    Elements</span></a>
                                            <a href="{{ asset('form-pickers.html') }}" class="dropdown-item"><span
                                                    data-lang="form-pickers">Pickers</span></a>
                                            <a href="{{ asset('form-select.html') }}" class="dropdown-item"><span
                                                    data-lang="form-select">Select</span></a>
                                            <a href="{{ asset('form-validation.html') }}"
                                                class="dropdown-item"><span
                                                    data-lang="form-validation">Validation</span></a>
                                            <a href="{{ asset('form-wizard.html') }}" class="dropdown-item"><span
                                                    data-lang="form-wizard">Wizard</span></a>
                                            <a href="{{ asset('form-fileuploads.html') }}"
                                                class="dropdown-item"><span data-lang="form-fileuploads">File
                                                    Uploads</span></a>
                                            <a href="{{ asset('form-text-editors.html') }}"
                                                class="dropdown-item"><span data-lang="form-text-editors">Text
                                                    Editors</span></a>
                                            <a href="{{ asset('form-range-slider.html') }}"
                                                class="dropdown-item"><span data-lang="form-range-slider">Range
                                                    Slider</span></a>
                                            <a href="{{ asset('form-layout.html') }}" class="dropdown-item"><span
                                                    data-lang="form-layout">Layouts</span></a>
                                            <a href="{{ asset('form-other-plugin.html') }}"
                                                class="dropdown-item"><span data-lang="form-other-plugin">Other
                                                    Plugins</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-tables" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="tables">Tables</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-tables">
                                            <a href="{{ asset('tables-static.html') }}"
                                                class="dropdown-item"><span data-lang="tables-static">Static
                                                    Tables</span></a>
                                            <a href="{{ asset('tables-custom.html') }}"
                                                class="dropdown-item"><span data-lang="tables-custom">Custom
                                                    Tables</span></a>
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle drop-arrow-none"
                                                    href="#" id="topnav-submenu-datatables" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-icons" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="icons">Icons</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-icons">
                                            <a href="{{ asset('icons-tabler.html') }}" class="dropdown-item"><span
                                                    data-lang="icons-tabler">Tabler</span></a>
                                            <a href="{{ asset('icons-lucide.html') }}" class="dropdown-item"><span
                                                    data-lang="icons-lucide">Lucide</span></a>
                                            <a href="{{ asset('icons-flags.html') }}" class="dropdown-item"><span
                                                    data-lang="icons-flags">Flags</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle drop-arrow-none" href="#"
                                            id="topnav-submenu-maps" role="button" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                            <span data-lang="maps">Maps</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-submenu-maps">
                                            <a href="{{ asset('maps-google.html') }}" class="dropdown-item"><span
                                                    data-lang="maps-google">Google Maps</span></a>
                                            <a href="{{ asset('maps-vector.html') }}" class="dropdown-item"><span
                                                    data-lang="maps-vector">Vector Maps</span></a>
                                            <a href="{{ asset('maps-leaflet.html') }}" class="dropdown-item"><span
