        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Provide contextual feedback messages for typical user actions with the
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary" role="alert">This is a primary alert—something important you
                            should know!</div>

                        <div class="alert alert-secondary" role="alert">This is a secondary alert—some additional context.
                        </div>

                        <div class="alert alert-success" role="alert">Success! Your operation was completed successfully.
                        </div>
                        ...
                        <div class="alert alert-purple mb-0" role="alert">Purple alert—use for general-purpose messages.
                        </div>
                    </div>
                    <!-- end card-body -->
                </div>
