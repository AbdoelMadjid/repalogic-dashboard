                            ...
                            <div class="d-flex flex-wrap justify align-items-center gap-3">
                                <div class="d-lg-none d-flex gap-2">
                                    <button class="btn btn-default btn-icon" type="button"
                                        data-bs-toggle="offcanvas" data-bs-target="#productFillterOffcanvas"
                                ...
                                <div class="d-flex gap-1">
                                    <a href="{{ asset('apps-ecommerce-products-grid.html') }}"
                                        class="btn btn-soft-primary btn-icon active">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3 border-bottom border-dashed">
                                        <div class="d-flex mb-2 justify-content-between align-items-center">
                                            ...
                                            <a href="javascript: void(0);"
                                                class="btn btn-link btn-sm px-0 fw-semibold">View All</a>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                ...
                                                <label for="cat-electronics"
                                                    class="form-check-label mb-0">Electronics</label>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                <input type="checkbox" id="cat-computers"
                                                    class="form-check-input" />
                                                <label for="cat-computers"
                                                    class="form-check-label mb-0">Computers</label>
                                            </div>
                                            <div class="flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                <input type="checkbox" id="cat-home-office"
                                                    class="form-check-input" />
                                                <label for="cat-home-office" class="form-check-label mb-0">Home &
                                                    Office</label>
                                            </div>
                                            <div class="flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                ...
                                                <label for="cat-accessories"
                                                    class="form-check-label mb-0">Accessories</label>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                ...
                                                <label for="cat-mobile" class="form-check-label mb-0">Mobile
                                                    Phones</label>
                                            </div>
                                            <div class="flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                <input type="checkbox" id="cat-appliances"
                                                    class="form-check-input" />
                                                <label for="cat-appliances"
                                                    class="form-check-label mb-0">Appliances</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 text-muted py-1">
                                            <div class="form-check flex-grow-1">
                                                ...
                                                <label for="brand-samsung"
                                                    class="form-check-label mb-0">Samsung</label>
                                            </div>
                                            <div class="flex-shrink-0">
                                    ...
                                    <div class="p-3 border-bottom border-dashed">
                                        ...
                                        <div class="d-flex gap-2 align-items-center mt-3">
                                            <div class="form-control form-control-sm text-center"
                                                id="price-filter-low"></div>
                                            <span class="fw-semibold text-muted">to</span>
                                            <div class="form-control form-control-sm text-center"
                                                id="price-filter-high"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="bg-light-subtle p-3 mb-3 border border-light rounded">
                                            <img src="{{ asset('assets/images/products/1.png') }}"
                                                alt="modern-sofa" class="img-fluid" />
                                        </div>
                                        <!-- Title -->
                                    ...
                                    <div class="card-body">
                                        <div class="bg-light-subtle p-3 mb-3 border border-light rounded">
                                            <img src="{{ asset('assets/images/products/2.png') }}"
                                                alt="funky-shoes" class="img-fluid" />
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                class="link-reset">Noise Canceling Wireless Earbuds - Black
                                                Edition</a>
                                        </h6>
                                    ...
                                    <div class="card-body">
                                        <div class="bg-light-subtle p-3 mb-3 border border-light rounded">
                                            <img src="{{ asset('assets/images/products/4.png') }}"
                                                alt="wooden-chair" class="img-fluid" />
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                    ...
                                    <div class="card-body">
                                        <div class="bg-light-subtle p-3 mb-3 border border-light rounded">
                                            <img src="{{ asset('assets/images/products/6.png') }}"
                                                alt="brown-chair" class="img-fluid" />
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                    ...
                                    <div class="card-body">
                                        <div class="bg-light-subtle p-3 mb-3 border border-light rounded">
                                            <img src="{{ asset('assets/images/products/8.png') }}"
                                                alt="coolest-chair" class="img-fluid" />
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
