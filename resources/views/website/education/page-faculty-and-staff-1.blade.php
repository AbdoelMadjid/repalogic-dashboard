...
@section('title', 'Multipage - Education Faculty &amp; Staff Page | Unify - Responsive Website Template')

@section('content')
<!-- Promo Block -->
      <div class="container g-pt-20">
        <div class="u-shadow-v34 g-brd-around g-brd-12 g-brd-white rounded g-pos-rel g-z-index-1">
          <div class="g-min-height-70vh g-flex-centered g-bg-img-hero rounded" style="background-image: url({{ asset('asset_education/img-temp') }}/1200x800/img1.jpg);">
            <div class="w-100 g-pos-abs g-bottom-0 g-left-0 g-z-index-1">
              <div class="g-bg-white g-pos-rel g-px-30 g-pt-30 g-pt-0--md g-pb-15">
                <h1><a class="h1 u-link-v5 g-color-main g-color-primary--hover g-font-size-45--md" href="#">Fall Convocation 2017</a></h1>
        ...
        <div class="row justify-content-center">
          <div class="col-4 col-md g-mb-30">
            ...
            <div class="u-block-hover text-center">
              <span class="u-icon-v2 g-z-index-minus-1 u-icon-size--lg u-shadow-v35 g-brd-5 g-brd-white g-color-text-light-v1 g-color-white--hover g-bg-secondary g-bg-main--hover rounded-circle mb-2">
      ...
      <!-- Call to Action -->
      <div class="u-shadow-v35 g-bg-img-hero" style="background-image: url({{ asset('asset_education/include') }}/svg/svg-bg1.svg);">
        <div class="container g-pt-100 g-py-70">
          <div class="row align-items-md-center">
            ...
            <div class="col-md-6 g-mb-30">
              <p class="g-font-size-17 mb-0">Leadership through excellence in teaching and research. We offer the widest range of academic programs of any university in Canada.</p>
            </div>

            <div class="col-md-3 g-mb-30">
              <div class="text-right">
                <a class="btn u-shadow-v39 g-brd-main g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-10" href="#">Learn More</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container g-py-100">
        <div class="row justify-content-lg-between align-items-center">
          <div class="col-md-6">
            <img class="img-fluid" src="{{ asset('asset_education/img-temp') }}/900x700/img1.jpg" alt="Image Description">
          </div>
      ...
      <div class="container g-pb-100">
        <div class="row justify-content-lg-between align-items-center">
          <div class="col-md-6 order-md-2">
            <img class="img-fluid" src="{{ asset('asset_education/img-temp') }}/900x700/img3.jpg" alt="Image Description">
          </div>
        ...
        <div class="js-carousel"
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img4.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
              <h3 class="h3 g-font-weight-500 mb-1">Alex Teseira</h3>
              <span class="d-block g-color-text-light-v1 g-font-size-16">Assistant Professor in Ecosystem Ecology</span>
            </div>
            <a class="u-link-v2" href="#"></a>
          </div>
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img5.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img6.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img7.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img8.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img9.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
          ...
          <div class="js-slide u-block-hover g-pb-10 g-mx-15">
            <div class="g-overflow-hidden">
              <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="{{ asset('asset_education/img-temp') }}/400x500/img10.jpg" alt="Image Description">
            </div>
            <div class="u-shadow-v32 g-bg-white g-pa-30">
      ...
      <div class="container text-center g-pt-100">
        ...
        <div class="row g-mb-30">
          <div class="col-sm-6 col-lg-3 g-mb-30">
            <!-- Fancybox Video -->
            <div class="u-shadow-v36 g-brd-around g-brd-7 g-brd-white g-brd-primary--hover rounded g-pos-rel g-transition-0_2">
              ...
              <a class="js-fancybox g-absolute-centered" href="javascript:;"
                 ...
                 data-speed="350"
                 data-caption="Video">
                <span class="u-icon-v3 u-icon-size--lg g-color-white g-color-primary--hover g-bg-transparent g-font-size-30 rounded-circle g-cursor-pointer">
