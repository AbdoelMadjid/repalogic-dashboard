...
@section('title', 'Multipage - Education Current Students Page | Unify - Responsive Website Template')

@section('content')
<!-- Promo Block -->
      <div class="g-bg-img-hero g-pos-rel" style="background-image: url({{ asset('asset_education/img') }}/bg/bg-img1.png);">
          ...
          <div class="row justify-content-lg-between">
            ...
            <div class="col-lg-8 align-self-end">
              <div class="u-shadow-v40 g-brd-around g-brd-7 g-brd-secondary rounded">
                <img class="img-fluid rounded" src="{{ asset('asset_education/img-temp') }}/900x600/img1.jpg" alt="Image Description">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-9 order-lg-2">
            <div class="g-pl-15--lg">
              ...
              <p>As a student, it's all about having the right information at the right time. You need to know how to get information when you need it—whether it’s tips on how to study, important dates or access to your student records. And it's not all about the classroom—making time for other activities on campus, such as fitness and clubs, is just as important.</p>
              <p>If you can't find the information you need, we're here to help! Ask us questions like:</p>

              <ul class="mb-4">
                <li><a class="u-link-v5 g-color-main--hover" href="#">When is the exam timetable posted?</a></li>
                <li><a class="u-link-v5 g-color-main--hover" href="#">How long will it take for my student loan application to be assessed?</a></li>
              </ul>

              <!-- Search -->
              <form class="input-group u-shadow-v19 g-brd-primary--focus g-rounded-30">
                <input class="form-control h-100 g-brd-secondary-light-v2 g-rounded-left-30 g-px-30 g-py-12" type="text" placeholder="Search all current students services websites">
                <button class="btn input-group-addon d-flex align-items-center u-shadow-v33 g-brd-none g-color-white g-bg-primary g-bg-main--hover g-rounded-right-30 g-transition-0_2 g-px-30" type="button">
                  Ask Unify
                </button>
              </form>
              <!-- End Search -->
              ...
              <div class="row">
                <div class="col-md-6 g-mb-30">
                  ...
                  <div class="g-overflow-hidden">
                    <a class="u-block-hover g-text-underline--none--hover" href="#">
                      <img class="img-fluid u-block-hover__main--zoom-v1" src="{{ asset('asset_education/include') }}/svg/svg-system-login1.svg" align="Image Description">
                    </a>
                  </div>
                </div>
                ...
                <div class="col-md-6 g-mb-30">
                  ...
                  <ul class="list-unstyled">
                    <li class="py-1">
                      <a class="d-flex align-items-center u-link-v5 g-color-main--hover g-font-size-15" href="#">
                    ...
                    <li class="py-1">
                      <a class="d-flex align-items-center u-link-v5 g-color-main--hover g-font-size-15" href="#">
                        Semester 2 exam timetables <i class="g-font-size-13 ml-auto material-icons">arrow_forward</i>
                      </a>
                    </li>
                    <li class="py-1">
                      <a class="d-flex align-items-center u-link-v5 g-color-main--hover g-font-size-15" href="#">
        ...
        <div class="container-fluid g-px-8 g-pt-8">
          ...
          <div class="js-carousel u-carousel-v5 g-mx-minus-4"
            ...
            <div class="js-slide g-mx-4 g-mb-8">
              <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                <div class="g-width-150 g-height-150 mx-auto mb-4">
                  <img class="img-fluid u-info-v11-1-img rounded-circle" src="{{ asset('asset_education/img-temp') }}/150x150/img1.jpg" alt="Image Description">
                </div>
                <div class="mb-5">
            ...
            <div class="js-slide g-mx-4 g-mb-8">
              <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                <div class="g-width-150 g-height-150 mx-auto mb-4">
                  <img class="img-fluid u-info-v11-1-img rounded-circle" src="{{ asset('asset_education/img-temp') }}/150x150/img5.jpg" alt="Image Description">
                </div>
                <div class="mb-5">
                  <h3 class="mb-3">New undergraduate curriculum</h3>
                  <p>The University's reimagined Sydney Undergraduate Experience will launch in 2018. If you're a current first-year student, you may be eligibl...</p>
                </div>
                <a class="btn g-brd-secondary-light-v2 g-brd-primary--hover g-color-text-light-v1 g-color-white--hover g-bg-primary--hover g-font-size-15 g-rounded-30 g-px-25 g-py-10" href="#">Read Now</a>
              </div>
            </div>
            ...
            <div class="js-slide g-mx-4 g-mb-8">
              <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                <div class="g-width-150 g-height-150 mx-auto mb-4">
                  <img class="img-fluid u-info-v11-1-img rounded-circle" src="{{ asset('asset_education/img-temp') }}/150x150/img3.jpg" alt="Image Description">
                </div>
                <div class="mb-5">
                  <h3 class="mb-3">Unify Uni Alert is now live</h3>
                  <p>A new emergency alert system is now live across our campuses allowing us to send you vital safety information directly to your mobile in the e...</p>
                </div>
                <a class="btn g-brd-secondary-light-v2 g-brd-primary--hover g-color-text-light-v1 g-color-white--hover g-bg-primary--hover g-font-size-15 g-rounded-30 g-px-25 g-py-10" href="#">Read Now</a>
              </div>
            </div>
            ...
            <div class="js-slide g-mx-4 g-mb-8">
              <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                <div class="g-width-150 g-height-150 mx-auto mb-4">
                  <img class="img-fluid u-info-v11-1-img rounded-circle" src="{{ asset('asset_education/img-temp') }}/150x150/img4.jpg" alt="Image Description">
                </div>
                <div class="mb-5">
            ...
            <div class="js-slide g-mx-4 g-mb-8">
              <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                <div class="g-width-150 g-height-150 mx-auto mb-4">
                  <img class="img-fluid u-info-v11-1-img rounded-circle" src="{{ asset('asset_education/img-temp') }}/150x150/img2.jpg" alt="Image Description">
                </div>
                <div class="mb-5">
                  <h3 class="mb-3">University Health Service</h3>
                  <p>The University Health Service medical centre on Level 3, Wentworth Building, will close for renovations from Saturday 2 December...</p>
                </div>
                <a class="btn g-brd-secondary-light-v2 g-brd-primary--hover g-color-text-light-v1 g-color-white--hover g-bg-primary--hover g-font-size-15 g-rounded-30 g-px-25 g-py-10" href="#">Read Now</a>
              </div>
            </div>
