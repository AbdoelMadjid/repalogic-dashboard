                                            ...
                                            <a class="nav-link active" data-bs-toggle="tab" href="#shopStepGeneral">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span class="fw-semibold text-body d-block fs-base">General
                                                            Info</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepStore">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span class="fw-semibold text-body d-block fs-base">Store
                                                            Details</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepCurrency">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span class="fw-semibold text-body d-block fs-base">Currency &
                                                            Tax</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepNotifications">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="fw-semibold text-body d-block fs-base">Notifications</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepInvoices">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span class="fw-semibold text-body d-block fs-base">Invoices &
                                                            Receipts</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepLegal">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span class="fw-semibold text-body d-block fs-base">SEO &
                                                            Legal</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepIntegrations">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span
                                                            class="fw-semibold text-body d-block fs-base">Integrations</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#shopStepBackup">
                                                <span class="d-flex align-items-center">
                                                    ...
                                                    <span class="flex-grow-1 ms-2 text-truncate">
                                                        <span class="fw-semibold text-body d-block fs-base">Backup &
                                                            Restore</span>
                                    ...
                                    <div class="tab-content border border-dashed rounded p-4" data-wizard-content>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="e.g., Vona Store" required />
                                                </div>
                                                <div class="col-xl-6 mb-3">
                                                    <label class="form-label">Support Email</label>
                                                    <input type="email" class="form-control"
                                                        placeholder="support@vona.com" required />
                                                </div>
                                                <div class="col-xl-6 mb-3">
                                        ...
                                        <div class="tab-pane fade" id="shopStepInvoices">
                                            ...
                                            <div class="d-flex justify-content-between mt-3">
                                                <button type="button" class="btn btn-secondary" data-wizard-prev>←
                                                    Back</button>
                                                <button type="button" class="btn btn-primary" data-wizard-next>Next: SEO
                                                    &
                                                    Legal →</button>
                                            </div>
                                        </div>
