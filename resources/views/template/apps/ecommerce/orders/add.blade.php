                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="orderId"
                                                    placeholder="#WB20100" disabled />
                                            </div>

                                            <!-- Order Date -->
                                            <div class="col-md-6">
                                                <label class="form-label">Order Date</label>
                                                <input type="datetime-local" data-provider="flatpickr"
                                                    data-altFormat="F j, Y" class="form-control flatpickr-input"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="customerName"
                                                    placeholder="Mason Carter" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="email" class="form-control" id="customerEmail"
                                                    placeholder="mason.carter@shopmail.com" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="productName" required>
                                                    ...
                                                    <option value="AirPods Pro (2nd Gen)">AirPods Pro (2nd Gen)
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" class="form-control"
                                                    id="amount" placeholder="129.45" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" maxlength="4" class="form-control"
                                                    id="cardNumber" placeholder="7832" />
                                            </div>
