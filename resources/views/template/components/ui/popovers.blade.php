        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Documentation and examples for adding Bootstrap popovers, like those found
                            in iOS, to any element on your site.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Need Help?"
                            data-bs-content="Click here to get support from our team. We're here 24/7 to assist you.">Get
                            Support Info</button>
                    </div>
                    <!-- end card-body -->
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" tabindex="0" class="btn btn-primary" data-bs-toggle="popover"
                            ...
                            title="Quick Tips">Show Tips</button>
                    </div>
                    <!-- end card-body -->
                </div>
                <!-- end card-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" tabindex="0" class="btn btn-dark" data-bs-toggle="popover"
                            ...
                            title="Exciting Features!">Please Hover Me</button>
                    </div>
                    <!-- end card-body -->
                </div>
                <!-- end card-->
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="popover" data-bs-placement="top"
                                title="Top Popover"
                                data-bs-content="This popover appears above the button. Great for tips or info.">Popover on
                                top</button>

                            <!-- Popover on bottom -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="popover"
                                data-bs-placement="bottom" title="Bottom Popover"
                                data-bs-content="This popover shows below. Perfect for additional details.">Popover on
                                bottom</button>

                            <!-- Popover on right -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="popover"
                                data-bs-placement="right" title="Right Popover"
                                data-bs-content="Slide in from the right to provide quick insights.">Popover on
                                right</button>

                            <!-- Popover on left -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="popover" data-bs-placement="left"
                                title="Left Popover"
                                data-bs-content="Appears on the left side. Great for tooltips or notes.">Popover on
                                left</button>
                        </div>
                    </div>
                    <!-- end card-body -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <span class="d-inline-block" data-bs-toggle="popover" data-bs-placement="top"
                            ...
                            <button class="btn btn-primary" type="button" disabled style="pointer-events: none">Disabled
                                Button</button>
                        </span>
                    </div>
                    <!-- end card-body -->
