...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>User Roles | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ asset('apps-users-role-details.html') }}" class="btn btn-sm btn-outline-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
