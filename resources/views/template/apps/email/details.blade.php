        ...
        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
            ...
            <div class="card-header card-bg justify-content-between">
                <div class="d-flex flex-wrap align-items-center gap-1">
                    <!-- Back to Inbox -->
                    <a href="{{ asset('apps-email-inbox.html') }}" class="btn btn-default btn-icon btn-sm"
                ...
                <div class="pb-3">
                    <div class="d-flex align-items-center">
                        <a class="d-flex align-items-center flex-grow-1 text-reset" data-bs-toggle="collapse"
                            ...
                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle"
                                alt="User Avatar" />
                            ...
                            <div class="mt-2 d-flex flex-wrap gap-3">
                                <div
                                    ...
                                    <div>
                                        <h4 class="fs-sm mb-1">
                                            <a href="#!"
                                                class="link-reset stretched-link">footer-contrast-notes.pdf</a>
                                        </h4>
                                ...
                                <div
                                    class="d-flex p-2 gap-3 align-items-center text-start position-relative border border-dashed rounded">
