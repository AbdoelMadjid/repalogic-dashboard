                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle drop-arrow-none" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false"><i class="ti ti-download me-1"></i> Export
                                <i class="ti ti-chevron-down align-middle ms-1"></i></button>
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/flags/us.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    United States</td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/flags/fr.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    France</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Akira
                                                    Tanaka</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/jp.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    Japan</td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/flags/gb.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    United Kingdom</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Lucas
                                                    Schmidt</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/de.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    Germany</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Isabella
                                                    Rossi</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/it.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    Italy</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Mateo
                                                    Vargas</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/ar.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    Argentina</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Priya
                                                    Sharma</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/in.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    India</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Liam
                                                    O’Connor</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/au.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    Australia</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="customer" href="#!" class="link-reset">Olga
                                                    Petrova</a>
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <td><img src="{{ asset('assets/images/flags/ru.svg') }}" alt=""
                                        class="rounded-circle me-1" height="16" />
                                    Russia</td>
