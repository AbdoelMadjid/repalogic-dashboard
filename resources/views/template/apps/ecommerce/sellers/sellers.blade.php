...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Sellers | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">GreenTech Solutions</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(4.5)</a></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">TechTonic Store</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(3)</a></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">UrbanTech Gadgets</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(3.5)</a></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">NextGen Electronics</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(2)</a></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">SmartHome Goods</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">TechMasters</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(5)</a></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">FutureGizmos</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">GizmoX</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">NextWave Electronics</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="seller" href="{{ asset('apps-ecommerce-seller-details.html') }}" class="link-reset">FutureTech Innovations</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a data-sort="rating" href="{{ asset('apps-ecommerce-reviews.html') }}" class="link-reset fw-semibold">(4)</a></span>
                                                </td>
                                                <td>
