            ...
            <div class="col-md-8 col-lg-7 g-mb-50">
              ...
              <form class="u-shadow-v35 g-bg-white rounded g-px-40 g-py-50">
                ...
                <div class="row align-items-center mb-4">
                  ...
                  <div class="col-lg-8">
                    <input class="form-control h-100 g-brd-none g-bg-secondary g-bg-secondary-dark-v1--focus rounded g-px-20 g-py-12" type="text" placeholder="John Doe">
                  </div>
                </div>
                <!-- End Name Input -->
                ...
                <div class="row align-items-center mb-4">
                  ...
                  <div class="col-lg-8">
                    <input class="form-control h-100 g-brd-none g-bg-secondary g-bg-secondary-dark-v1--focus rounded g-px-20 g-py-12" type="email" placeholder="john@gmail.com">
                  </div>
                </div>
                <!-- End Name Input -->
