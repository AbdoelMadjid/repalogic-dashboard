<div class="offcanvas offcanvas-end overflow-hidden" id="theme-settings-offcanvas" tabindex="-1">
    <div class="d-flex justify-content-between text-bg-primary gap-2 p-3"
        style="background-image: url(/images/settings-bg.png)">
        <div>
        ...
        <div class="p-3 border-bottom border-dashed" id="skin">
            ...
            <div class="row g-3">
                ...
                <div class="col-6" id="skin-galaxy">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="demo-skin-galaxy" name="data-skin" type="radio"
                            value="galaxy" />
                ...
                <div class="col-6" id="skin-luxe">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="demo-skin-luxe" name="data-skin" type="radio"
                            value="luxe" />
                ...
                <div class="col-6" id="skin-retro">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="demo-skin-retro" name="data-skin" type="radio"
                            value="retro" />
                ...
                <div class="col-6" id="skin-neon">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="demo-skin-neon" name="data-skin" type="radio"
                            value="neon" />
                ...
                <div class="col-6" id="skin-pixel">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="demo-skin-pixel" name="data-skin" type="radio"
                            value="pixel" />
        ...
        <div class="p-3 border-bottom border-dashed" id="topbar-color">
            ...
            <div class="row g-3">
                <div class="col-4" id="topbar-color-light">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="layout-topbar-color-light" name="data-topbar-color"
                ...
                <div class="col-4" id="topbar-color-dark">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="layout-topbar-color-dark" name="data-topbar-color"
                ...
                <div class="col-4" id="topbar-color-gray">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="layout-topbar-color-gray" name="data-topbar-color"
                ...
                <div class="col-4" id="topbar-color-gradient">
                    <div class="form-check card-radio">
                        <input class="form-check-input" id="layout-topbar-color-gradient" name="data-topbar-color"
                            type="radio" value="gradient" />
                        <label class="form-check-label p-0 w-100" for="layout-topbar-color-gradient">
                            <img alt="layout-img" class="img-fluid"
                                src="/images/layouts/topbar-color-gradient.png" />
                        </label>
                    </div>
            ...
            <div class="row g-3">
                <div class="col-4" id="sidenav-color-light">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-color-light" name="data-menu-color"
                            type="radio" value="light" />
                ...
                <div class="col-4" id="sidenav-color-dark">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-color-dark" name="data-menu-color"
                            type="radio" value="dark" />
                ...
                <div class="col-4" id="sidenav-color-gray">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-color-gray" name="data-menu-color"
                            type="radio" value="gray" />
                ...
                <div class="col-4" id="sidenav-color-gradient">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-color-gradient" name="data-menu-color"
                            type="radio" value="gradient" />
                        <label class="form-check-label p-0 w-100" for="layout-sidenav-color-gradient">
                            <img alt="layout-img" class="img-fluid"
                                src="/images/layouts/sidenav-color-gradient.png" />
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Gradient</h5>
                </div>
                <div class="col-4" id="sidenav-color-image">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-color-image" name="data-menu-color"
        ...
        <div class="p-3 border-bottom border-dashed" id="sidenav-size">
            ...
            <div class="row g-3">
                <div class="col-4" id="sidenav-size-default">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-size-default" name="data-sidenav-size"
                ...
                <div class="col-4" id="sidenav-size-compact">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-size-compact" name="data-sidenav-size"
                ...
                <div class="col-4" id="sidenav-size-condensed">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-size-condensed" name="data-sidenav-size"
                            type="radio" value="condensed" />
                        <label class="form-check-label p-0 w-100" for="layout-sidenav-size-condensed">
                            <img alt="layout-img" class="img-fluid"
                                src="/images/layouts/sidenav-size-condensed.png" />
                        </label>
                    </div>
                ...
                <div class="col-4" id="sidenav-size-on-hover">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-size-small-hover" name="data-sidenav-size"
                            type="radio" value="on-hover" />
                        <label class="form-check-label p-0 w-100" for="layout-sidenav-size-small-hover">
                            <img alt="layout-img" class="img-fluid"
                                src="/images/layouts/sidenav-size-on-hover.png" />
                        </label>
                    </div>
                ...
                <div class="col-4" id="sidenav-size-on-hover-active">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-size-small-hover-active"
                            name="data-sidenav-size" type="radio" value="on-hover-active" />
                        <label class="form-check-label p-0 w-100" for="layout-sidenav-size-small-hover-active">
                            <img alt="layout-img" class="img-fluid"
                                src="/images/layouts/sidenav-size-on-hover-active.png" />
                        </label>
                    </div>
                ...
                <div class="col-4" id="sidenav-size-offcanvas">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-sidenav-size-offcanvas" name="data-sidenav-size"
                            type="radio" value="offcanvas" />
                        <label class="form-check-label p-0 w-100" for="layout-sidenav-size-offcanvas">
                            <img alt="layout-img" class="img-fluid"
                                src="/images/layouts/sidenav-size-offcanvas.png" />
                        </label>
                    </div>
        ...
        <div class="p-3 border-bottom border-dashed" id="dir">
            ...
            <div class="row g-3">
                <div class="col-4" id="dir-ltr">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-dir-ltr" name="dir" type="radio"
                            value="ltr" />
                ...
                <div class="col-4" id="dir-rtl">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input" id="layout-dir-rtl" name="dir" type="radio"
                            value="rtl" />
        ...
        <div class="row justify-content-end">
            <div class="col-6">
                <a class="btn btn-success fw-semibold py-2 w-100"
                    href="https://wrapmarket.com/item/inspinia-multipurpose-admin-dashboard-template-WB0R5L90S?via=webapp"
                    target="_blank"><i class="ti ti-basket me-2 fs-md"></i> Buy Now</a>
            </div>
            <div class="col-6">
                <button class="btn btn-danger fw-semibold py-2 w-100" id="reset-layout" type="button"><i
