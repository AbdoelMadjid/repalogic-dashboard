                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-2 text-center">
                                <!-- img-fluid -->
                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}" alt="image"
                                    class="img-fluid" />
                                <p class="mb-0 mt-2">
                                    <code>.img-fluid</code>
                                </p>
                            ...
                            <div class="col-sm-2 text-center">
                                <!-- .rounded -->
                                <img src="{{ asset('assets/images/stock/small-2.jpg') }}" alt="image"
                            ...
                            <div class="col-sm-2 text-center">
                                <!-- .rounded -->
                                <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="image"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center mt-3">
                            <div class="col">
                                <!-- .avatar-sm -->
                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="image"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center mt-3">
                            <div class="col">
                                <!-- .avatar-lg -->
                                <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="image"
                        ...
                        <div class="row text-center mt-3">
                            <div class="col">
                                <!-- .avatar-xl -->
                                <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="image"
                            ...
                            <div class="col-xl-3">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar avatar-lg">
                                        <span
                                            class="avatar-title bg-purple-subtle text-purple rounded-circle fw-bold shadow">D</span>
                                    </div>
                                    <div class="avatar avatar-lg">
                                        <span
                                            class="avatar-title bg-primary-subtle text-primary rounded-circle fw-bold shadow">K</span>
                                    </div>
                                    <div class="avatar avatar-lg">
                                        <span
                                            class="avatar-title bg-secondary-subtle text-secondary rounded-circle fw-bold shadow">H</span>
                                    </div>
                                    <div class="avatar avatar-lg">
                                        <span
                                            class="avatar-title bg-warning-subtle text-warning rounded-circle fw-bold shadow">L</span>
                                    </div>
                                    <div class="avatar avatar-lg">
                                        <span
                                            class="avatar-title bg-info-subtle text-info rounded-circle fw-bold shadow">G</span>
                                    </div>
                                </div>
                            </div>
                            <!-- end col-->
