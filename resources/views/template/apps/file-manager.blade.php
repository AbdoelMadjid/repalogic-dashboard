...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>File Manager | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    ...
                                    <div class="list-group list-group-flush list-custom mt-3">
                                        <a href="{{ asset('file-manager.html') }}" class="list-group-item list-group-item-action active">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="assets/files/dependency.dep" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
