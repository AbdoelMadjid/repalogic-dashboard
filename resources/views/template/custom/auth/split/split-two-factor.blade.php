...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Two Factor Authentication | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                    ...
                    <div class="card auth-box-form border-0 mb-0">
                        <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                            ...
                            <p class="text-muted text-center mt-4 mb-0">
                                Return to
                                <a href="{{ asset('auth-split-sign-in.html') }}" class="text-decoration-underline link-offset-3 fw-semibold">Sign in</a>
                            </p>
