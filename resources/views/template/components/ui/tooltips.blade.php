        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Documentation and examples for adding custom Bootstrap tooltips with CSS
                            and JavaScript using CSS3 for animations and data-bs-attributes for local title storage.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-0">
                            ...
                            <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Manage your dashboard easily">custom dashboards</a>
                            and UI components help you build scalable web applications efficiently. This template includes
                            pre-built pages, clean layouts, and reusable code blocks to boost your development workflow.
                            From user management to analytics and settings,
                            everything is modular and developer-friendly. Create modern admin panels with
                            <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Built with Bootstrap 5">responsive design</a>
                            and seamless UX. Get started quickly with a professional-grade
                            <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Tailored for developers">UI toolkit</a>
                            and supercharge your app with
                            <a href="#" class="fw-medium" data-bs-toggle="tooltip"
                                data-bs-title="Includes charts, tables, forms and more">powerful components</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Elements with the
                            <code>disabled</code>
                            attribute aren’t interactive, meaning users cannot focus, hover, or click them to trigger a
                            tooltip (or popover). As a workaround, you’ll want to trigger the tooltip from a wrapper
                            <code>&lt;div&gt;</code>
                            or
                            <code>&lt;span&gt;</code>
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Hover over the buttons below to see the four tooltips directions: top, right,
                            bottom, and left.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-html="true"
                            data-bs-title="<em>New</em> <u>Tooltip</u> <b>with</b> <i>HTML</i> <br>Custom message here!">Tooltip
                            with HTML</button>
                    </div>
                    <!-- end card-body -->
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                                ...
                                data-bs-title="This is a primary tooltip with a custom style.">Primary tooltip</button>
                            <button type="button" class="btn btn-danger" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-custom-class="tooltip-danger"
                                data-bs-title="This is a danger tooltip with a custom warning message.">Danger
                                tooltip</button>
                            <button type="button" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-custom-class="tooltip-info"
                                data-bs-title="This is an info tooltip that provides extra details.">Info tooltip</button>
                            <button type="button" class="btn btn-success" data-bs-toggle="tooltip"
                                ...
                                data-bs-title="This is a success tooltip to indicate completion.">Success tooltip</button>
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="tooltip"
                                ...
                                data-bs-title="This is a warning tooltip to alert you.">Warning tooltip</button>
                            <button type="button" class="btn btn-dark" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-custom-class="tooltip-dark"
                                data-bs-title="This is a dark tooltip with important information.">Dark tooltip</button>
                            <button type="button" class="btn btn-purple" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-custom-class="tooltip-purple"
                                data-bs-title="This is a purple tooltip with a vibrant style.">Purple tooltip</button>
                        </div>
                    </div>
                    <!-- end card-body -->
                </div>
