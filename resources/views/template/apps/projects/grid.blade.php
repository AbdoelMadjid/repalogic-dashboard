...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Projects | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                ...
                                <div class="row gap-3">
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex gap-1">
                                            <a href="{{ asset('apps-projects-grid.html') }}" class="btn btn-primary btn-icon">
                                                <i class="ti ti-category fs-lg"></i>
                                            </a>
                                            <a href="{{ asset('apps-projects-list.html') }}" class="btn btn-soft-primary btn-icon">
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">AI Analytics Dashboard</a>
                                            </h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Marketing Automation Platform</a>
                                            </h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Website Redesign</a>
                                            </h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Sales Insight Tool</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Cyber Security System</a>
                                        </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">AI Performance Dashboard</a>
                                        </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Cloud Sync Platform</a>
                                        </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-header bg-light-subtle border-light p-3">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Data Mining Toolkit</a>
                                        </h5>
