                        ...
                        <div aria-labelledby="topnav-main" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-dashboards" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.main.dashboards.ecommerce') }}"><span
                                            data-lang="dashboard-ecommerce">Ecommerce</span></a>
                                    <a class="dropdown-item" href="{{ route('template.main.dashboards.analytics') }}"><span
                        ...
                        <div aria-labelledby="topnav-apps" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-ecommerce"
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.marketplace') }}"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-products" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.apps.ecommerce.products.products') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.categories') }}"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-orders" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.apps.ecommerce.orders.orders') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.customers') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.checkout') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.refunds') }}"><span
                                            data-lang="apps-ecommerce-refunds">Refunds</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.reviews') }}"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-reports" class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('template.apps.ecommerce.reports.sales') }}"><span
                                                    data-lang="apps-ecommerce-sales">Sales</span></a>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.attributes') }}"><span
                                            data-lang="apps-ecommerce-attributes">Attributes</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.ecommerce.settings') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-users" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.users.role-details') }}"><span
                                            data-lang="apps-users-role-details">Role Details</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.users.permissions') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-projects" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.projects.details') }}"><span
                                            data-lang="apps-projects-details">View Project</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.projects.kanban') }}"><span
                                            data-lang="apps-projects-kanban">Kanban Board</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.projects.team-board') }}"><span
                                            data-lang="apps-projects-team-board">Team Board</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.projects.activity') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-invoice" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.apps.invoice.details') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-more-apps" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.clients') }}"><span
                                            data-lang="apps-clients">Clients</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.outlook') }}"><span
                                            data-lang="apps-outlook">Outlook View</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.vote-list') }}"><span
                                            data-lang="apps-vote-list">Vote List</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.issue-tracker') }}"><span
                                            data-lang="apps-issue-tracker">Issue Tracker</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.api-keys') }}"><span
                                            data-lang="apps-api-keys">API Keys</span></a>
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.manage') }}"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-blog" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.apps.moreapps.blog.list') }}"><span
                                                    data-lang="apps-blog-list">Blog List</span></a>
                                            <a class="dropdown-item" href="{{ route('template.apps.moreapps.blog.grid') }}"><span
                                                    data-lang="apps-blog-grid">Blog Grid</span></a>
                                            <a class="dropdown-item" href="{{ route('template.apps.moreapps.blog.article') }}"><span
                                                    data-lang="apps-blog-article">Article</span></a>
                                            <a class="dropdown-item" href="{{ route('template.apps.moreapps.blog.add') }}"><span
                                                    data-lang="apps-blog-add">Add Article</span></a>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="{{ route('template.apps.moreapps.pin-board') }}"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-forum" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.apps.moreapps.forum.view') }}"><span
                                                    data-lang="apps-forum-view">Forum View</span></a>
                                            <a class="dropdown-item" href="{{ route('template.apps.moreapps.forum.post') }}"><span
                        ...
                        <div aria-labelledby="topnav-custom-pages" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-pages"
                                    class="dropdown-menu dropdown-menu-columns">
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.profile') }}"><span
                                            data-lang="pages-profile">Profile</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.account-settings') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.pricing') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.timeline') }}"><span
                                            data-lang="pages-timeline">Timeline</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.gallery') }}"><span
                                            data-lang="pages-gallery">Gallery</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.sitemap') }}"><span
                                            data-lang="pages-sitemap">Sitemap</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.search-results') }}"><span
                                            data-lang="pages-search-results">Search Results</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.coming-soon') }}"><span
                                            data-lang="pages-coming-soon">Coming Soon</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.privacy-policy') }}"><span
                                            data-lang="pages-privacy-policy">Privacy Policy</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.pages.terms-conditions') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-plugins"
                                    class="dropdown-menu dropdown-menu-columns">
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.sortable') }}"><span
                                            data-lang="plugins-sortable">Sortable List</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.text-diff') }}"><span
                                            data-lang="plugins-text-diff">Text Diff</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.pdf-viewer') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.sweet-alerts') }}"><span
                                            data-lang="plugins-sweet-alerts">Sweet Alerts</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.idle-timer') }}"><span
                                            data-lang="plugins-idle-timer">Idle Timer</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.pass-meter') }}"><span
                                            data-lang="plugins-pass-meter">Password Meter</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.live-favicon') }}"><span
                                            data-lang="plugins-live-favicon">Live Favicon</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.clipboard') }}"><span
                                            data-lang="plugins-clipboard">Clipboard</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.tree-view') }}"><span
                                            data-lang="plugins-tree-view">Tree View</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.loading-buttons') }}"><span
                                            data-lang="plugins-loading-buttons">Loading Buttons</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.masonry') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.animation') }}"><span
                                            data-lang="plugins-animation">Animation</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.plugins.video-player') }}"><span
                                ...
                                <div aria-labelledby="topnav-submenu-authentication" class="dropdown-menu">
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-auth-basic" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.sign-in') }}" target="_blank"><span
                                                    data-lang="auth-sign-in">Sign In</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.sign-up') }}" target="_blank"><span
                                                    data-lang="auth-sign-up">Sign Up</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.reset-pass') }}" target="_blank"><span
                                                    data-lang="auth-reset-pass">Reset Password</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.new-pass') }}" target="_blank"><span
                                                    data-lang="auth-new-pass">New Password</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.two-factor') }}" target="_blank"><span
                                                    data-lang="auth-two-factor">Two Factor</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.lock-screen') }}" target="_blank"><span
                                                    data-lang="auth-lock-screen">Lock Screen</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.success-mail') }}" target="_blank"><span
                                                    data-lang="auth-success-mail">Success Mail</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.login-pin') }}" target="_blank"><span
                                                    data-lang="auth-login-pin">Login with PIN</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.basic.delete-account') }}" target="_blank"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-auth-card" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.card.sign-in') }}" target="_blank"><span
                                                    data-lang="auth-card-sign-in">Sign In</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.card.sign-up') }}" target="_blank"><span
                                                    data-lang="auth-card-sign-up">Sign Up</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.card.reset-pass') }}" target="_blank"><span
                                                    data-lang="auth-card-reset-pass">Reset Password</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.card.new-pass') }}" target="_blank"><span
                                                    data-lang="auth-card-new-pass">New Password</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.card.two-factor') }}" target="_blank"><span
                                                    data-lang="auth-card-two-factor">Two Factor</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.card.lock-screen') }}" target="_blank"><span
                                                    data-lang="auth-card-lock-screen">Lock Screen</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.card.success-mail') }}" target="_blank"><span
                                                    data-lang="auth-card-success-mail">Success Mail</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.card.login-pin') }}" target="_blank"><span
                                                    data-lang="auth-card-login-pin">Login with PIN</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.card.delete-account') }}" target="_blank"><span
                                                    data-lang="auth-card-delete-account">Delete Account</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true"
                                        ...
                                        <div aria-labelledby="topnav-submenu-auth-split" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.split.sign-in') }}" target="_blank"><span
                                                    data-lang="auth-split-sign-in">Sign In</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.split.sign-up') }}" target="_blank"><span
                                                    data-lang="auth-split-sign-up">Sign Up</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.split.reset-pass') }}" target="_blank"><span
                                                    data-lang="auth-split-reset-pass">Reset Password</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.split.new-pass') }}" target="_blank"><span
                                                    data-lang="auth-split-new-pass">New Password</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.split.two-factor') }}" target="_blank"><span
                                                    data-lang="auth-split-two-factor">Two Factor</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.split.lock-screen') }}" target="_blank"><span
                                                    data-lang="auth-split-lock-screen">Lock Screen</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.split.success-mail') }}" target="_blank"><span
                                                    data-lang="auth-split-success-mail">Success Mail</span></a>
                                            <a class="dropdown-item" href="{{ route('template.custom.auth.split.login-pin') }}" target="_blank"><span
                                                    data-lang="auth-split-login-pin">Login with PIN</span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('template.custom.auth.split.delete-account') }}" target="_blank"><span
                                                    data-lang="auth-split-delete-account">Delete Account</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-error-pages" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.custom.error.400') }}" target="_blank"><span
                                            data-lang="error-400">400 Bad Request</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.error.401') }}" target="_blank"><span
                                            data-lang="error-401">401 Unauthorized</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.error.403') }}" target="_blank"><span
                                            data-lang="error-403">403 Forbidden</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.error.404') }}" target="_blank"><span
                                            data-lang="error-404">404 Not Found</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.error.408') }}" target="_blank"><span
                                            data-lang="error-408">408 Request Timeout</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.error.500') }}" target="_blank"><span
                                            data-lang="error-500">500 Internal Server</span></a>
                                    <a class="dropdown-item" href="{{ route('template.custom.error.maintenance') }}" target="_blank"><span
                        ...
                        <div aria-labelledby="topnav-layouts" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-layout-options" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.layouts.options.scrollable') }}"
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.layouts.options.horizontal') }}"
                                        target="_blank"><span data-lang="layouts-horizontal">Horizontal</span></a>
                                    <a class="dropdown-item" href="{{ route('template.layouts.options.preloader') }}"
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-sidebars" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.gradient') }}"
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.compact') }}"
                                        target="_blank"><span data-lang="layouts-sidebar-compact">Compact
                                            Menu</span></a>
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.on-hover') }}"
                                        target="_blank"><span data-lang="layouts-sidebar-on-hover">On Hover
                                            Menu</span></a>
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.on-hover-active') }}"
                                        target="_blank"><span data-lang="layouts-sidebar-on-hover-active">On Hover
                                            Active</span></a>
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.offcanvas') }}"
                                        target="_blank"><span data-lang="layouts-sidebar-offcanvas">Offcanvas
                                            Menu</span></a>
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.no-icons') }}"
                                        target="_blank"><span data-lang="layouts-sidebar-no-icons">No Icons with
                                            Lines</span></a>
                                    <a class="dropdown-item" href="{{ route('template.layouts.sidebars.with-lines') }}"
                        ...
                        <div aria-labelledby="topnav-components" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-base-ui"
                                    class="dropdown-menu dropdown-menu-columns">
                                    <a class="dropdown-item" href="{{ route('template.components.ui.accordions') }}"><span
                                            data-lang="ui-accordions">Accordions</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.alerts') }}"><span
                                            data-lang="ui-alerts">Alerts</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.images') }}"><span
                                            data-lang="ui-images">Images</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.badges') }}"><span
                                            data-lang="ui-badges">Badges</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.breadcrumb') }}"><span
                                            data-lang="ui-breadcrumb">Breadcrumb</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.buttons') }}"><span
                                            data-lang="ui-buttons">Buttons</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.cards') }}"><span
                                            data-lang="ui-cards">Cards</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.carousel') }}"><span
                                            data-lang="ui-carousel">Carousel</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.collapse') }}"><span
                                            data-lang="ui-collapse">Collapse</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.colors') }}"><span
                                            data-lang="ui-colors">Colors</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.dropdowns') }}"><span
                                            data-lang="ui-dropdowns">Dropdowns</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.videos') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.components.ui.links') }}"><span
                                            data-lang="ui-links">Links</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.list-group') }}"><span
                                            data-lang="ui-list-group">List Group</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.modals') }}"><span
                                            data-lang="ui-modals">Modals</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.notifications') }}"><span
                                            data-lang="ui-notifications">Notifications</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.offcanvas') }}"><span
                                            data-lang="ui-offcanvas">Offcanvas</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.placeholders') }}"><span
                                            data-lang="ui-placeholders">Placeholders</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.pagination') }}"><span
                                            data-lang="ui-pagination">Pagination</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.popovers') }}"><span
                                            data-lang="ui-popovers">Popovers</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.progress') }}"><span
                                            data-lang="ui-progress">Progress</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.scrollspy') }}"><span
                                            data-lang="ui-scrollspy">Scrollspy</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.spinners') }}"><span
                                    ...
                                    <a class="dropdown-item" href="{{ route('template.components.ui.tooltips') }}"><span
                                            data-lang="ui-tooltips">Tooltips</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.typography') }}"><span
                                            data-lang="ui-typography">Typography</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.ui.utilities') }}"><span
                                ...
                                <div aria-labelledby="topnav-submenu-charts" class="dropdown-menu">
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-apex-charts"
                                            class="dropdown-menu dropdown-menu-columns">
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.area') }}"><span
                                                    data-lang="charts-apex-area">Area</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.bar') }}"><span
                                                    data-lang="charts-apex-bar">Bar</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.bubble') }}"><span
                                            ...
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.column') }}"><span
                                                    data-lang="charts-apex-column">Column</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.heatmap') }}"><span
                                                    data-lang="charts-apex-heatmap">Heatmap</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.line') }}"><span
                                                    data-lang="charts-apex-line">Line</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.mixed') }}"><span
                                                    data-lang="charts-apex-mixed">Mixed</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.timeline') }}"><span
                                                    data-lang="charts-apex-timeline">Timeline</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.boxplot') }}"><span
                                                    data-lang="charts-apex-boxplot">Boxplot</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.treemap') }}"><span
                                                    data-lang="charts-apex-treemap">Treemap</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.pie') }}"><span
                                                    data-lang="charts-apex-pie">Pie</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.radar') }}"><span
                                            ...
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.scatter') }}"><span
                                            ...
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.range') }}"><span
                                                    data-lang="charts-apex-range">Range</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.funnel') }}"><span
                                                    data-lang="charts-apex-funnel">Funnel</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.apex.slope') }}"><span
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div aria-labelledby="topnav-submenu-echarts"
                                            class="dropdown-menu dropdown-menu-columns">
                                            <a class="dropdown-item" href="{{ route('template.components.charts.echart.line') }}"><span
                                                    data-lang="charts-echart-line">Line</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.echart.bar') }}"><span
                                                    data-lang="charts-echart-bar">Bar</span></a>
                                            <a class="dropdown-item" href="{{ route('template.components.charts.echart.pie') }}"><span
                                            ...
                                            <a class="dropdown-item" href="{{ route('template.components.charts.echart.area') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-forms" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.components.forms.elements') }}"><span
                                            data-lang="form-elements">Basic Elements</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.pickers') }}"><span
                                            data-lang="form-pickers">Pickers</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.select') }}"><span
                                            data-lang="form-select">Select</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.validation') }}"><span
                                            data-lang="form-validation">Validation</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.wizard') }}"><span
                                            data-lang="form-wizard">Wizard</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.fileuploads') }}"><span
                                            data-lang="form-fileuploads">File Uploads</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.text-editors') }}"><span
                                            data-lang="form-text-editors">Text Editors</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.range-slider') }}"><span
                                            data-lang="form-range-slider">Range Slider</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.layout') }}"><span
                                            data-lang="form-layout">Layouts</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.forms.other-plugin') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-tables" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.components.tables.static') }}"><span
                                            data-lang="tables-static">Static Tables</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.tables.custom') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-icons" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.components.icons.tabler') }}"><span
                                            data-lang="icons-tabler">Tabler</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.icons.lucide') }}"><span
                                            data-lang="icons-lucide">Lucide</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.icons.flags') }}"><span
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-maps" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('template.components.maps.google') }}"><span
                                            data-lang="maps-google">Google Maps</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.maps.vector') }}"><span
                                            data-lang="maps-vector">Vector Maps</span></a>
                                    <a class="dropdown-item" href="{{ route('template.components.maps.leaflet') }}"><span
