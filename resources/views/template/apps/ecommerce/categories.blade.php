...
<head>
    <meta charset="utf-8" />
    <title>Categories | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    ...
                                    <a href="#!" class="btn btn-primary ms-1"> <i
                                            class="ti ti-plus fs-sm me-2"></i> Add Category </a>
                                </div>
                            </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="#!"
                                                                class="link-reset">Table Lamps</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="#!"
                                                                class="link-reset">Kitchen Appliances</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="#!"
                                                                class="link-reset">Smart Watches</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="#!"
                                                                class="link-reset">Gaming Consoles</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="#!"
                                                                class="link-reset">Bluetooth Speakers</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
