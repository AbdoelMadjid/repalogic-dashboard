...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Invoices | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ asset('apps-invoice-create.html') }}" class="btn btn-secondary rounded-circle btn-icon"> <i class="ti ti-plus fs-lg"></i></a>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        ...
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120010</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        ...
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120009</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        ...
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120008</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        ...
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120007</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-success fs-lg"></i>
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120006</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-warning fs-lg"></i>
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120005</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-info fs-lg"></i>
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120004</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-success fs-lg"></i>
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120003</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-warning fs-lg"></i>
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120002</a>
                                                    </h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-danger fs-lg"></i>
                                                        <a href="{{ asset('apps-invoice-details.html') }}" class="link-reset fw-semibold">#INS-0120001</a>
                                                    </h5>
                                                </td>
