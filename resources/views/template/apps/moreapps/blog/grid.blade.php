    ...
    <div class="row" data-masonry='{"percentPosition": true }'>
            ...
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    ...
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Mastering Figma: 7 Pro Tips for
                            Better UI Design</a>
                    </h6>
                    <p class="mb-3 text-muted">Unlock advanced techniques in Figma that can speed up your workflow and help
                        you create pixel-perfect designs every time.</p>
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between">
                    <div class="d-flex justify-content-start align-items-center gap-2">
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="avatar-6"
                    ...
                    <a class="link-primary fw-semibold d-flex align-items-center gap-1"
                        href="{{ asset('apps-blog-article.html') }}">Read more <i class="ti ti-arrow-right"></i></a>
                </div>
            </article>
        </div>
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <!-- Card image -->
                <img class="card-img-top rounded-top-3" src="{{ asset('assets/images/blog/blog-1.jpg') }}"
                    alt="Building APIs" />
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Building REST APIs with
                            Node.js</a>
                    </h6>
                    <p class="mb-3 text-muted">Learn how to design and build scalable REST APIs with Node.js and Express in
                        this step-by-step tutorial.</p>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <!-- Card image -->
                <img class="card-img-top rounded-top-3" src="{{ asset('assets/images/blog/blog-2.jpg') }}"
                    alt="SEO Strategies" />
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">SEO Strategies for 2025: How to
                            Rank Higher</a>
                    </h6>
                    <p class="mb-3 text-muted">Boost your website's search engine ranking with these proven SEO techniques
                        for 2025.</p>
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between">
                    <div class="d-flex justify-content-start align-items-center gap-2">
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="avatar-2"
                                class="img-fluid rounded-circle" />
                        </div>
                        <div>
                            <h5 class="text-nowrap fs-sm mb-0 lh-base">
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Web Design Trends to Watch in
                            2025</a>
                    </h6>
                    <p class="mb-3 text-muted">Explore the top web design trends that will shape the user experience in
                        2025.</p>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">5 Key Tips for New
                            Entrepreneurs</a>
                    </h6>
                    <p class="mb-3 text-muted">Start your entrepreneurial journey with these 5 essential tips that will
                        guide you through the first year of business.</p>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">The Future of Artificial
                            Intelligence</a>
                    </h6>
                    <p class="mb-3 text-muted">Discover how AI is transforming industries and what the future holds for
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card bg-primary bg-gradient rounded-3">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="text-white">Top Data Science Trends in
                            2025</a>
                    </h6>
                    <p class="mb-3 text-white-50">Get ahead in the data science field with the latest trends, technologies,
                        and tools that are reshaping the industry.</p>
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                    ...
                    <a class="text-white fw-semibold d-flex align-items-center gap-1"
                        href="{{ asset('apps-blog-article.html') }}">Read more <i class="ti ti-arrow-right"></i></a>
                </div>
            </article>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <article class="card rounded-3">
                ...
                <div class="card-body">
                    <!-- Title -->
                    <h6 class="card-title fs-lg lh-base mb-2">
                        <a href="{{ asset('apps-blog-article.html') }}" class="link-reset">Top Data Science Trends in
                            2025</a>
                    </h6>
                    <p class="mb-3 text-muted">Get ahead in the data science field with the latest trends, technologies,
                        and tools that are reshaping the industry.</p>
