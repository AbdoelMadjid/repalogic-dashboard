                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <a href="{{ asset('auth-card-reset-pass.html') }}" class="text-decoration-underline link-offset-3 text-muted">Forgot Password?</a>
                                            </div>
                                        ...
                                        <p class="text-muted text-center mt-4 mb-0">
                                            New here?
                                            <a href="{{ asset('auth-card-sign-up.html') }}" class="text-decoration-underline link-offset-3 fw-semibold">Create an account</a>
                                        </p>
