        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Examples and usage guidelines for form control styles, layout options, and
                            ...
                            <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;input type=&quot;text&quot;
                                                id=&quot;simpleinput&quot; class=&quot;form-control&quot;&gt;</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;input type=&quot;text&quot;
                                                id=&quot;validInput&quot; class=&quot;form-control is-valid&quot;&gt;</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;input type=&quot;text&quot;
                                                id=&quot;inValidationInput&quot; class=&quot;form-control
                                                is-valid&quot;&gt;</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;input type=&quot;text&quot;
                                                id=&quot;example-rounded&quot; class=&quot;form-control rounded-pill&quot;
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;textarea class=&quot;form-control&quot;
                                                id=&quot;example-textarea&quot;
                                                rows=&quot;5&quot;&gt;&lt;/textarea&gt;</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;input type=&quot;text&quot;
                                                id=&quot;example-readonly&quot; class=&quot;form-control&quot; readonly
                                                value=&quot;Readonly value&quot;&gt;</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                            <code class="language-markup">&lt;input type=&quot;text&quot; readonly
                                                class=&quot;form-control-plaintext&quot; id=&quot;example-static&quot;
                                                value=&quot;email&#64;example.com&quot;&gt;</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-lg-4 g-2">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <small class="form-text text-muted">A block of help text that breaks onto a new
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="email" id="example-email"
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="password" id="example-password"
                                            class="form-control" value="password"&gt;</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="month" id="example-month"
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="time" id="example-time"
                                            class="form-control"&gt;</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="week" id="example-week"
                                            class="form-control"&gt;</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="number" id="example-number"
                                            class="form-control"&gt;</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="color" id="example-color"
                                            class="form-control" value="#3b97de"&gt;</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-lg-4 g-2 mb-3">
                                ...
                                <div class="col-lg-5">
                                    <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                        <code class="language-markup">&lt;input type="range" id="example-range"
                                            class="form-range" min="0" max="100"&gt;</code>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                    <code class="language-markup">&lt;input class=&quot;form-control&quot;
                                        type=&quot;file&quot; id=&quot;inputGroupFile04&quot;&gt;</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                    <code class="language-markup">&lt;input class=&quot;form-control&quot;
                                        type=&quot;file&quot; id=&quot;formFileMultiple01&quot; multiple&gt;</code>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                    <code class="language-markup">&lt;input type=&quot;text&quot; class=&quot;form-control
                                        form-control-sm&quot; placeholder=&quot;.input-sm&quot;&gt;</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                    <code class="language-markup">&lt;input type=&quot;text&quot;
                                        class=&quot;form-control&quot; placeholder=&quot;Normal&quot;&gt;</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                <div class="bg-light-subtle border border-light border-dashed rounded p-2">
                                    <code class="language-markup">&lt;input type=&quot;text&quot; class=&quot;form-control
                                        form-control-lg&quot; placeholder=&quot;.input-lg&quot;&gt;</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-lg-4 g-2">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-check mb-2">
                                    ...
                                    <label class="form-check-label" for="checkIndeterminate">Disabled indeterminate
                                        checkbox</label>
                                </div>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="checkCheckedDisabled">Disabled checked
                                        checkbox</label>
                                </div>
                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    <div>
                                        ...
                                        <div class="form-check form-check-success mb-2">
                                            <input type="checkbox" class="form-check-input" id="checkSuccess"
                                                checked />
                                    ...
                                    <div>
                                        <div class="form-check form-check-warning mb-2">
                                            <input type="checkbox" class="form-check-input" id="checkWarning"
                                                checked />
                                            <label class="form-check-label" for="checkWarning">Warning</label>
                                        </div>
                                        <div class="form-check form-check-danger mb-2">
                                            <input type="checkbox" class="form-check-input" id="checkDanger"
                                                checked />
                                            <label class="form-check-label" for="checkDanger">Danger</label>
                                        </div>
                                        <div class="form-check form-check-purple mb-2">
                                            <input type="checkbox" class="form-check-input" id="checkPurple"
                                                checked />
                                ...
                                <div class="d-flex flex-wrap gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-danger form-switch mb-2">
                                            <input type="checkbox" class="form-check-input" id="switchDanger"
                                                checked />
                                            <label class="form-check-label" for="switchDanger">Danger</label>
                                        </div>
                                        <div class="form-check form-check-purple form-switch mb-2">
                                            <input type="checkbox" class="form-check-input" id="switchPurple"
                                                checked />
