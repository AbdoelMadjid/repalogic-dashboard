                    ...
                    <table class="table table-hover table-select mb-0">
                        <tbody>
                            <tr class="position-relative">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="user avatar"
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Design Review & Feedback</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">I’ve reviewed the
                                        updated UI mockups. Great work overall—just a few...</span>
                                </td>
                            ...
                            <tr class="position-relative">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-2.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Request for Meeting</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Are you available for a
                                        quick sync-up this week regarding the roadmap?</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Q2 Marketing Strategy</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Here's the proposed
                                        outline for our Q2 campaign and goals...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-6.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Final Invoice Attached</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Attached is the invoice
                                        for the April sprint deliverables. Let me know...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Team Offsite Agenda</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Here’s a rough outline
                                        for the team offsite activities next month...</span>
                                </td>
                                <td style="width: 1%">
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="avatar-xs">
                                            <span
                                                class="avatar-title bg-secondary-subtle text-secondary fw-bold rounded-circle">C</span>
                                        </div>
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Welcome to the Project!</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Excited to have you on
                                        board. Let’s have a quick intro call tomorrow...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1 opacity-25">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative">
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Meeting Follow-up Notes</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Thanks for the insights
                                        today. Please find the summary and action points...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-7.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Project Files Delivered</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">The final batch of
                                        designs and documentation has been uploaded to the drive...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-8.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Re: Budget Estimate</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">The budget looks good
                                        overall, but we might need to adjust the Q3 allocations...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Collaboration Opportunity</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">I’d love to chat about a
                                        possible partnership on our upcoming launch event...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1 opacity-25">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-10.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Reschedule Request</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Can we move our call to
                                        Friday afternoon instead? Something urgent came up...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1 opacity-25">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-3.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Monthly Report Submission</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Please find the attached
                                        monthly performance report for your review...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative">
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Design Assets Update</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">I’ve uploaded the latest
                                        illustrations and icons to the shared folder...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1 opacity-25">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-9.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Updated Meeting Schedule</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Please review the
                                        adjusted times for next week's client meetings...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Client Feedback Notes</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Attached is the client
                                        feedback from last week’s demo session...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1">
                                        <i class="ti ti-paperclip"></i>
                            ...
                            <tr class="position-relative mark-as-read">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/users/user-1.jpg') }}" alt="user avatar"
                                            class="avatar-xs rounded-circle" />
                                ...
                                <td>
                                    <a href="{{ asset('apps-email-details.html') }}"
                                        class="link-reset fs-base fw-medium stretched-link">Weekly Sync Meeting</a>
                                    <span class="d-xl-inline-block d-none">—</span>
                                    <span class="fs-base text-muted d-xl-inline-block d-none mb-0">Let’s discuss blockers
                                        and updates on the current sprints in our sync...</span>
                                </td>
                                <td style="width: 1%">
                                    <div class="d-flex align-items-center gap-1 opacity-25">
                                        <i class="ti ti-paperclip"></i>
