...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Product Views | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="ecommerce">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a href="{{ asset('apps-ecommerce-marketplace.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="products">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-products.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-products">Products</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-products-grid">Products Grid</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-product-details">Product Details</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-product-add.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ asset('apps-ecommerce-categories.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="orders">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-orders.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-orders">Orders</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-order-details.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-order-details">Order Details</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-order-add.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sellers">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-sellers.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-sellers">Sellers</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-seller-details.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="inventory">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-warehouse.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-warehouse">Warehouse</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-product-stocks.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-product-stocks">Product Stocks</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-purchased-orders.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="reports">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-product-views.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-ecommerce-product-views">Product Views</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-ecommerce-sales.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ asset('apps-ecommerce-attributes.html') }}" class="side-nav-link">
                                    <span class="menu-text" data-lang="apps-ecommerce-attributes">Attributes</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('apps-ecommerce-settings.html') }}" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="users">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ asset('apps-users-role-details.html') }}" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="projects">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ asset('apps-projects-team-board.html') }}" class="side-nav-link">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="blog">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-blog-list.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-blog-list">Blog List</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-blog-grid.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-blog-grid">Blog Grid</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-blog-article.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-blog-article">Article</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-blog-add.html') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="forum">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-forum-view.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="apps-forum-view">Forum View</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('apps-forum-post.html') }}" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="pages">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ asset('pages-terms-conditions.html') }}" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="plugins">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ asset('plugins-loading-buttons.html') }}" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="layout-options">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-scrollable.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-scrollable">Scrollable</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-compact.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-compact">Compact</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-boxed.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-boxed">Boxed</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-horizontal.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-horizontal">Horizontal</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-preloader.html') }}" class="side-nav-link" target="_blank">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebars">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-light.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-light">Light Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-gradient.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-gradient">Gradient Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-gray.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-gray">Gray Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-image.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-image">Image Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-compact.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-compact">Compact Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-on-hover.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-on-hover">On Hover Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-on-hover-active.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-on-hover-active">On Hover Active</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-offcanvas.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-offcanvas">Offcanvas Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-no-icons.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-no-icons">No Icons with Lines</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-sidebar-with-lines.html') }}" class="side-nav-link" target="_blank">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="topbar">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-topbar-dark.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-topbar-dark">Dark Topbar</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-topbar-gray.html') }}" class="side-nav-link" target="_blank">
                                    <span class="menu-text" data-lang="layouts-topbar-gray">Gray Topbar</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ asset('layouts-topbar-gradient.html') }}" class="side-nav-link" target="_blank">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="echarts">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-line.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-line">Line</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-bar.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-bar">Bar</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-pie.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-pie">Pie</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-scatter.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-scatter">Scatter</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-geo-map.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-geo-map">GEO Map</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-gauge.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-gauge">Gauge</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-candlestick.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-candlestick">Candlestick</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-area.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-area">Area</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-radar.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-radar">Radar</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-heatmap.html') }}" class="side-nav-link">
                                                <span class="menu-text" data-lang="charts-echart-heatmap">Heatmap</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a href="{{ asset('charts-echart-other.html') }}" class="side-nav-link">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart Fitness Watch</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(54)</a></span>
                                                </td>
                                                <td>45.2k</td>
                                                <td>820</td>
                                                <td>7.3%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Portable Bluetooth Speaker</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(31)</a></span>
                                                </td>
                                                <td>28.9k</td>
                                                <td>410</td>
                                                <td>5.8%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Gaming Mouse</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>GM-77215</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(67)</a></span>
                                                </td>
                                                <td>22.4k</td>
                                                <td>340</td>
                                                <td>6.4%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Noise Cancelling Headphones</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>NC-88321</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(128)</a></span>
                                                </td>
                                                <td>60.1k</td>
                                                <td>1500</td>
                                                <td>9.8%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">4K Action Camera</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>AC-90763</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(94)</a></span>
                                                </td>
                                                <td>18.9k</td>
                                                <td>610</td>
                                                <td>6.0%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Wireless Charger Pad</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>WC-23815</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(41)</a></span>
                                                </td>
                                                <td>12.3k</td>
                                                <td>220</td>
                                                <td>4.1%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Mechanical Keyboard</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>MK-48519</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(77)</a></span>
                                                </td>
                                                <td>30.5k</td>
                                                <td>540</td>
                                                <td>7.2%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Drone with Camera</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>DR-61208</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i> </span>
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(189)</a></span>
                                                </td>
                                                <td>75.9k</td>
                                                <td>1900</td>
                                                <td>10.2%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart Home Hub</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>SH-30051</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(58)</a></span>
                                                </td>
                                                <td>21.7k</td>
                                                <td>470</td>
                                                <td>5.5%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Mini Projector</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>MP-12081</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ asset('apps-ecommerce-reviews.html') }}" data-sort="rating" class="link-reset fw-semibold">(35)</a></span>
                                                </td>
                                                <td>15.9k</td>
                                                <td>310</td>
                                                <td>4.7%</td>
