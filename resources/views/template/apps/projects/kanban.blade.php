                                ...
                                <li class="kanban-item">
                                    <div class="card shadow border-light mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <img src="{{ asset('assets/images/kanban/img-1.png') }}" alt=""
                                ...
                                <li class="kanban-item">
                                    <div class="card shadow border-light mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <img src="{{ asset('assets/images/kanban/img-2.png') }}" alt=""
                                                    class="rounded img-fluid" />
                                            </div>
                                ...
                                <li class="kanban-item">
                                    <div class="card shadow border-light mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <img src="{{ asset('assets/images/kanban/img-3.png') }}" alt=""
                                                    class="rounded img-fluid" />
                                            </div>
                                ...
                                <li class="kanban-item">
                                    <div class="card shadow border-light mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <img src="{{ asset('assets/images/kanban/img-4.png') }}" alt=""
                                                    class="rounded img-fluid" />
                                            </div>
