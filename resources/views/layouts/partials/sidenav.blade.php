        ...
        <div id="sidenav-menu">
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a aria-controls="dashboards" aria-expanded="false" class="side-nav-link" data-bs-toggle="collapse"
                        href="#dashboards">
                    ...
                    <div class="collapse" id="dashboards">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/dashboard/ecommerce') }}">
                                    <span class="menu-text" data-lang="dashboard-ecommerce">Ecommerce</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/dashboard/analytics') }}">
                ...
                <li class="side-nav-item">
                    <a aria-controls="ecommerce" aria-expanded="false" class="side-nav-link"
                        data-bs-toggle="collapse" href="#ecommerce">
                    ...
                    <div class="collapse" id="ecommerce">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/ecommerce/marketplace') }}">
                                    <span class="menu-text" data-lang="apps-ecommerce-marketplace">Marketplace</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a aria-controls="products" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#products">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/products-grid') }}">
                                                <span class="menu-text"
                                                    data-lang="apps-ecommerce-products-grid">Products Grid</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/product-details') }}">
                                                <span class="menu-text"
                                                    data-lang="apps-ecommerce-product-details">Product Details</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                            ...
                            <li class="side-nav-item">
                                <a aria-controls="orders" aria-expanded="false" class="side-nav-link"
                                ...
                                <div class="collapse" id="orders">
                                    <ul class="sub-menu">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/order-details') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/ecommerce/checkout') }}">
                                    <span class="menu-text" data-lang="apps-ecommerce-checkout">Checkout</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a aria-controls="sellers" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#sellers">
                                ...
                                <div class="collapse" id="sellers">
                                    <ul class="sub-menu">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/seller-details') }}">
                                                <span class="menu-text"
                                                    data-lang="apps-ecommerce-seller-details">Sellers Details</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="side-nav-item">
                                <a aria-controls="inventory" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#inventory">
                                ...
                                <div class="collapse" id="inventory">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/ecommerce/warehouse') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/product-stocks') }}">
                                                <span class="menu-text"
                                                    data-lang="apps-ecommerce-product-stocks">Product Stocks</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/purchased-orders') }}">
                                                <span class="menu-text"
                                                    data-lang="apps-ecommerce-purchased-orders">Purchased Orders</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="side-nav-item">
                                <a aria-controls="reports" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#reports">
                                ...
                                <div class="collapse" id="reports">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/apps/ecommerce/product-views') }}">
                                                <span class="menu-text"
                                                    data-lang="apps-ecommerce-product-views">Product Views</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/ecommerce/sales') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/ecommerce/settings') }}">
                ...
                <li class="side-nav-item">
                    <a aria-controls="projects" aria-expanded="false" class="side-nav-link"
                        data-bs-toggle="collapse" href="#projects">
                ...
                <li class="side-nav-item">
                    <a aria-controls="invoice" aria-expanded="false" class="side-nav-link" data-bs-toggle="collapse"
                        href="#invoice">
                ...
                <li class="side-nav-item">
                    <a class="side-nav-link" href="{{ url('/apps/companies') }}">
                        <span class="menu-icon"><i class="ti ti-building"></i></span>
                        <span class="menu-text" data-lang="apps-companies">Companies</span>
                    </a>
                </li>
                <li class="side-nav-item">
                    <a aria-controls="more-apps" aria-expanded="false" class="side-nav-link"
                        data-bs-toggle="collapse" href="#more-apps">
                    ...
                    <div class="collapse" id="more-apps">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/clients') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/vote-list') }}">
                                    <span class="menu-text" data-lang="apps-vote-list">Vote List</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/issue-tracker') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/manage') }}">
                                    <span class="menu-text" data-lang="apps-manage">Manage Apps</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a aria-controls="blog" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#blog">
                                ...
                                <div class="collapse" id="blog">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/blog/list') }}">
                                                <span class="menu-text" data-lang="apps-blog-list">Blog List</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/blog/grid') }}">
                                                <span class="menu-text" data-lang="apps-blog-grid">Blog Grid</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/blog/article') }}">
                                                <span class="menu-text" data-lang="apps-blog-article">Article</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/blog/add') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/apps/pin-board') }}">
                                    <span class="menu-text" data-lang="apps-pin-board">Pin Board</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a aria-controls="forum" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#forum">
                                ...
                                <div class="collapse" id="forum">
                                    <ul class="sub-menu">
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/forum/view') }}">
                                                <span class="menu-text" data-lang="apps-forum-view">Forum View</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ url('/apps/forum/post') }}">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="pages">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/pages/profile') }}">
                                    <span class="menu-text" data-lang="pages-profile">Profile</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/pages/account-settings') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/pages/gallery') }}">
                                    <span class="menu-text" data-lang="pages-gallery">Gallery</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/pages/sitemap') }}">
                ...
                <li class="side-nav-item">
                    <a aria-controls="plugins" aria-expanded="false" class="side-nav-link" data-bs-toggle="collapse"
                        href="#plugins">
                    ...
                    <div class="collapse" id="plugins">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/plugins/text-diff') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/plugins/idle-timer') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/plugins/live-favicon') }}">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/plugins/loading-buttons') }}">
                                    <span class="menu-text" data-lang="plugins-loading-buttons">Loading Buttons</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/plugins/masonry') }}">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="authentication">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a aria-controls="auth-card" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#auth-card">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="layout-options">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/layouts/horizontal') }}"
                                    target="_blank">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebars">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/layouts/sidebar/light') }}"
                                    target="_blank">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/layouts/sidebar/gray') }}"
                                    target="_blank">
                                    <span class="menu-text" data-lang="layouts-sidebar-gray">Gray Menu</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/layouts/sidebar/image') }}"
                                    target="_blank">
                ...
                <li class="side-nav-item">
                    <a aria-controls="topbar" aria-expanded="false" class="side-nav-link"
                        data-bs-toggle="collapse" href="#topbar">
                    ...
                    <div class="collapse" id="topbar">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/layouts/topbar/dark') }}"
                                    target="_blank">
                                    <span class="menu-text" data-lang="layouts-topbar-dark">Dark Topbar</span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/layouts/topbar/gray') }}"
                                    target="_blank">
                ...
                <li class="side-nav-item">
                    <a aria-controls="base-ui" aria-expanded="false" class="side-nav-link"
                        data-bs-toggle="collapse" href="#base-ui">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="charts">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a aria-controls="apex-charts" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#apex-charts">
                            ...
                            <li class="side-nav-item">
                                <a aria-controls="echarts" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#echarts">
                ...
                <li class="side-nav-item">
                    <a aria-controls="forms" aria-expanded="false" class="side-nav-link"
                        data-bs-toggle="collapse" href="#forms">
                ...
                <li class="side-nav-item">
                    <a aria-controls="tables" aria-expanded="false" class="side-nav-link"
                    ...
                    <div class="collapse" id="tables">
                        <ul class="sub-menu">
                            ...
                            <li class="side-nav-item">
                                <a aria-controls="datatables" aria-expanded="false" class="side-nav-link"
                                    data-bs-toggle="collapse" href="#datatables">
                                ...
                                <div class="collapse" id="datatables">
                                    <ul class="sub-menu">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/export-data') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/select') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/javascript') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/rendering') }}">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/scroll') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/fixed-columns') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/fixed-header') }}">
                                                <span class="menu-text"
                                                    data-lang="tables-datatables-fixed-header">Fixed Header</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/columns') }}">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/child-rows') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/column-searching') }}">
                                                <span class="menu-text"
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/range-search') }}">
                                                <span class="menu-text"
                                                    data-lang="tables-datatables-range-search">Range Search</span>
                                            </a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/rows-add') }}">
                                        ...
                                        <li class="side-nav-item">
                                            <a class="side-nav-link"
                                                href="{{ url('/tables/datatables/checkbox-select') }}">
                                                <span class="menu-text"
                ...
                <li class="side-nav-item">
                    <a aria-controls="icons" aria-expanded="false" class="side-nav-link"
                ...
                <li class="side-nav-item">
                    <a aria-controls="maps" aria-expanded="false" class="side-nav-link"
                    ...
                    <div class="collapse" id="maps">
                        <ul class="sub-menu">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="{{ url('/maps/google') }}">
                ...
                <li class="side-nav-item">
                    <a class="side-nav-link special-menu" href="#">
