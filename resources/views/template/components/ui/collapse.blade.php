        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Toggle the visibility of content across your project with a few classes
                            and our JavaScript plugins.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="collapse show" id="collapseExample">
                            <div class="card card-body mb-0">Anim pariatur cliche reprehenderit, enim eiusmod high life
                                accusamus terry richardson ad squid. Nihil anim keffiyeh helvetica, craft beer labore wes
                    ...
                    <div class="card-body">
                        ...
                        <div style="height: 100px">
                            <div class="collapse collapse-horizontal" id="collapseWidthExample">
                                <div class="card card-body mb-0" style="width: 300px">This is some placeholder content for a
