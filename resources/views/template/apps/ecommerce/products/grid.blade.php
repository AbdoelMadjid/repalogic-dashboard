...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Products Grid | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <form class="bg-light-subtle rounded border p-3">
                                <div class="d-flex flex-wrap justify align-items-center gap-3">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="btn btn-soft-primary btn-icon active">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ asset('apps-ecommerce-products.html') }}" class="btn btn-soft-primary btn-icon">
