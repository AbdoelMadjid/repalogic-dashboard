        ...
        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
            ...
            <div class="card-body p-0" style="height: calc(100% - 120px)" data-simplebar data-simplebar-md>
                <div class="app-search input-group border-bottom border-dashed ps-2 pe-4">
                    ...
                    <button class="btn btn-link fs-sm px-2 text-decoration-underline text-reset fw-semibold" type="button"
                ...
                <div class="collapse" id="email-cc">
                    <div class="app-search input-group border-bottom border-dashed ps-2 pe-4">
                        ...
                        <button class="btn btn-link px-2 text-muted fw-semibold" type="button" data-bs-toggle="collapse"
                            data-bs-target="#email-cc" aria-expanded="false" aria-controls="email-cc">
                ...
                <div class="collapse" id="email-bcc">
                    <div class="app-search input-group border-bottom border-dashed ps-2 pe-4">
                        ...
                        <button class="btn btn-link px-2 text-muted fw-semibold" type="button" data-bs-toggle="collapse"
                            data-bs-target="#email-bcc" aria-expanded="false" aria-controls="email-bcc">
                            <i class="ti ti-x fs-xl"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-light-subtle p-2 border-light border-bottom">
                    <div class="d-flex gap-1 align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-icon btn-light ms-auto" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Settings">
