...
<head>
    <meta charset="utf-8" />
    <title>Projects Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                ...
                                <div class="row g-0">
                                                ...
                                                <div class="col">
                                                    <div class="bg-light bg-opacity-50 p-2">
                                                        <h5 class="m-0"><span class="text-muted">Total
                                                                Revenue:</span>$ <span data-target="40">0</span>M</h5>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="bg-light bg-opacity-50 p-2">
                                                        <h5 class="m-0"><span class="text-muted">Total
                                                                Orders:</span> <span data-target="50.9">0</span>k</h5>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-6 order-xl-2 order-xxl-2">
                                        <div class="p-3">
                                            ...
                                            <p class="text-muted fs-xs">You have 21 projects with not completed task.
                                            </p>
                                            <div class="row mt-4">
                                                <div class="col-lg-12">
                                                    <div dir="ltr">
                                ...
                                <div class="timeline timeline-icon-bordered">
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3">
                                            ...
                                            <p class="mb-1 text-muted">Launched the real-time chat feature across all
                                                user accounts.</p>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('assets/images/users/user-6.jpg') }}"
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3">
                                            ...
                                            <p class="mb-1 text-muted">Improved DB query performance, reducing load
                                                time by 35%.</p>
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3">
                                            ...
                                            <p class="mb-1 text-muted">Michael Lee has joined the development team as
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-1">
                                ...
                                <div class="text-center mt-3">
                                    <a href="{{ asset('chat.html') }}"
                                        class="link-reset text-decoration-underline fw-semibold link-offset-3"> Go to
