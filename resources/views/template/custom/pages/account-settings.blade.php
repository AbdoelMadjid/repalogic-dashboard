        ...
        <div class="col-12">
            <article class="card card-out-of-container border-top-0">
                <div class="position-relative card-side-img overflow-hidden"
                    ...
                    <div
                        class="p-4 card-img-overlay rounded-start-0 flex-column gap-2 auth-overlay d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <span class="form-text fs-xs fst-italic text-muted">
                                                    <a href="#" class="link-reset">Click here to change your
                                                        password</a>
                                                </span>
                                            </div>
                                        </div>
