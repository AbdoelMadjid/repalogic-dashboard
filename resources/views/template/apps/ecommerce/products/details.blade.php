...
<head>
    <meta charset="utf-8" />
    <title>Product Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                                ...
                                                <div id="carouselExampleFade" class="carousel slide carousel-fade"
                                                    ...
                                                    <div class="carousel-inner bg-light bg-opacity-25 border border-light border-dashed rounded-3"
                                                        ...
                                                        <div class="carousel-item text-center active">
                                                            <img src="{{ asset('assets/images/products/single-1.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <div class="carousel-item text-center">
                                                            <img src="{{ asset('assets/images/products/single-2.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <div class="carousel-item text-center">
                                                            <img src="{{ asset('assets/images/products/single-3.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <div class="carousel-item text-center">
                                                            <img src="{{ asset('assets/images/products/single-4.png') }}"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                    </div>
                                                    <div
                                    ...
                                    <div class="col-xl-8">
                                        <div class="p-4">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <span
                                                        class="badge bg-success-subtle text-success px-2 py-1 fs-base rounded-pill">In
                                                        Stock</span>
                                                </div>
                                                <div
                                                    ...
                                                    <span class="ms-1 fs-base">
                                                        <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                            class="link-reset fw-medium">(859 Reviews)</a>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="mt-3 mb-5">
                                            ...
                                            <p>
                                                Relax in style with the Azure Comfort Single Sofa. Crafted with premium
                                                materials and a rich blue fabric, this single-seater is designed for
                                                both luxury and durability. Its sleek, modern profile fits perfectly in
                                                living rooms,
                                                reading nooks, or stylish lounges.
                                            </p>
                                            <p>Experience superior comfort with its deep cushioning and supportive
                                                backrest. The finely tailored upholstery and sturdy wood frame ensure
                                                long-lasting beauty and relaxation for years to come.</p>
                                                    ...
                                                    <div class="row align-items-center g-0">
                                                        <div class="col-xl-7">
                                                            <div class="d-flex align-items-center gap-4 p-4">
                                                                <img src="{{ asset('assets/images/ratings.svg') }}"
                                                                    alt="Product" height="80" />
                                                                <div>
                                                                    <h3
                                                                    ...
                                                                    <p class="mb-2">Based on 245 verified reviews
                                                                    </p>
                                                                    <p class="pe-2 h6 text-muted mb-2 lh-base">
                                                                        Feedback collected from real customers who
                                                                        purchased our templates</p>
                                                                    <span
                                                                        class="badge badge-label text-bg-success">+12
                                                                        new this week</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-5">
                                                            <div class="p-3">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                                    <div class="flex-shrink-0" style="width: 50px">5
                                                                        Star</div>
                                                                ...
                                                                <!-- 4 Star -->
                                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                                    <div class="flex-shrink-0" style="width: 50px">4
                                                                        Star</div>
                                                                    <div class="progress w-100 bg-label-primary"
                                                                        style="height: 8px">
                                                                        <div class="progress-bar bg-primary"
                                                                ...
                                                                <!-- 3 Star -->
                                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                                    <div class="flex-shrink-0" style="width: 50px">3
                                                                        Star</div>
                                                                    <div class="progress w-100 bg-label-primary"
                                                                        style="height: 8px">
                                                                        <div class="progress-bar bg-primary"
                                                                ...
                                                                <!-- 2 Star -->
                                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                                    <div class="flex-shrink-0" style="width: 50px">2
                                                                        Star</div>
                                                                    <div class="progress w-100 bg-label-primary"
                                                                        style="height: 8px">
                                                                        <div class="progress-bar bg-primary"
                                                                ...
                                                                <!-- 1 Star -->
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="flex-shrink-0" style="width: 50px">1
                                                                        Star</div>
                                                                    <div class="progress w-100 bg-label-primary"
                                                                        style="height: 8px">
                                                                        <div class="progress-bar bg-primary"
                                                    ...
                                                    <table
                                                        ...
                                                        <thead class="bg-light align-middle bg-opacity-25">
                                                            <tr class="text-uppercase fs-xxs">
                                                                ...
                                                                <th class="text-center" style="width: 1%">Actions
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <h5
                                                                                class="text-nowrap fs-sm mb-0 lh-base">
                                                                                Sophia Lee</h5>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <h5 class="mt-2">Great product, would buy again!
                                                                    </h5>
                                                                    <p class="text-muted fst-italic mb-0">"These
                                                                        earbuds are amazing, the sound quality is
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p class="text-muted fst-italic mb-0">"It does the
                                                                        job, but I feel like it's a little expensive for
                                                                        what it offers."</p>
                                                                </td>
                                                                <td>
                                                                    23 Apr, 2025
                                                                ...
                                                                <td>
                                                                    <span
                                                                        class="badge badge-soft-warning fs-xxs">Pending</span>
                                                                </td>
                                                                <td>
                                                                    <div class="d-flex justify-content-center gap-1">
                                                                        <a href="#"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p class="text-muted fst-italic mb-0">"The TV has
                                                                        incredible picture quality. Totally worth the
                                                                        investment!"</p>
                                                                </td>
                                                                <td>
                                                                    24 Apr, 2025
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <h5 class="mt-2">Perfect phone, highly
                                                                        recommended!</h5>
                                                                    <p class="text-muted fst-italic mb-0">"The camera
                                                                        is amazing and the performance is smooth.
                                                                        Definitely the best smartphone I have used!"</p>
                                                                </td>
                                                                <td>
                                                                    25 Apr, 2025
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p class="text-muted fst-italic mb-0">"The
                                                                        performance is amazing, but it's a bit too heavy
                                                                        to carry around all day."</p>
                                                                </td>
                                                                <td>
                                                                    26 Apr, 2025
