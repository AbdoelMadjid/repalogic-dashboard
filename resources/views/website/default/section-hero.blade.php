        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
                    ...
                    <a class="btn btn-light py-2 fw-semibold" href="https://wrapbootstrap.com/user/WebAppLayers/message"
                        target="_blank"> <i class="ti ti-confetti fs-xl me-2"></i>Contact Us </a>
                </div>
            </div>
        </div>
