                ...
                <div class="container-xxl">
                                ...
                                <div class="card-body pb-0 d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <ul class="list-unstyled mb-0 text-body">
                                            <li><a href="#" class="text-reset d-block py-1">Sports suits</a>
                                            </li>
                                            <li><a href="#" class="text-reset d-block py-1">Trousers</a></li>
                                            <li><a href="#" class="text-reset d-block py-1">Jackets and
                                                    coats</a></li>
                                            <li><a href="#" class="text-reset d-block py-1">Shirts</a></li>
                                        </ul>

                                        <a href="{{ asset('apps-ecommerce-products-grid.html') }}"
                                            class="fw-semibold link-reset d-inline-block my-3"> View All <i
                                                class="ti ti-arrow-right bi align-middle fs-lg"></i> </a>
                                    </div>

                                    <img src="{{ asset('assets/images/products/man.png') }}" alt="For men"
                                        class="img-fluid mt-auto" style="max-height: 220px" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body pb-0 d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <ul class="list-unstyled mb-0 text-body">
                                            ...
                                            <li><a href="#" class="text-reset d-block py-1">Pants and
                                                    jeans</a></li>
                                            <li><a href="#" class="text-reset d-block py-1">Shirts and
                                                    blouses</a></li>
                                            <li><a href="#" class="text-reset d-block py-1">Sweatshirts</a>
                                            </li>
                                        </ul>
                                    ...
                                    <img src="{{ asset('assets/images/products/women.png') }}" alt="For women"
                                        class="img-fluid mt-auto" style="max-height: 220px" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-danger bg-opacity-10 bg-gradient">
                                <div class="card-body pb-0 d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <ul class="list-unstyled mb-0 text-body">
                                            <li><a href="#" class="text-reset d-block py-1">Caps and hats</a>
                                            </li>
                                            <li><a href="#" class="text-reset d-block py-1">Sunglasses</a>
                                            </li>
                                    ...
                                    <img src="{{ asset('assets/images/products/hanbag.png') }}" alt="Accessories"
                                        class="img-fluid mt-auto" style="max-height: 220px" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pt-4">
                        <div class="col-12 text-center">
                            <span class="text-muted rounded-3 d-inline-block">👕 Discover styles tailored for
                                everyone</span>
                            ...
                            <div class="d-flex pt-1 justify-content-center align-items-center gap-1">
                                <a href="#!"
                                    class="badge badge-default rounded-pill px-3 py-2 fs-6 text-primary">Best
                                    Sellers</a>
                                <a href="#!"
                                    class="badge badge-default rounded-pill px-3 py-2 fs-6 text-muted">New Arrived</a>
                                <a href="#!"
                                    class="badge badge-default rounded-pill px-3 py-2 fs-6 text-muted">Sale Items</a>
                                <a href="#!"
                                    class="badge badge-default rounded-pill px-3 py-2 fs-6 text-muted">Top Rated</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-xxl-4 row-cols-lg-3 row-cols-sm-2 row-col-1 mt-3">
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/1.png') }}" alt="modern-sofa"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(45)</a>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <!-- Card footer -->
                                <div
                                    class="card-footer bg-transparent d-flex justify-content-between border-dashed border-top">
                        ...
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/2.png') }}" alt="funky-shoes"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(32)</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/3.png') }}" alt="earbuds"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(58)</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/4.png') }}" alt="wooden-chair"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(46)</a>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/5.png') }}"
                                            alt="black-wall-watch" class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                                        <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(62)</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/6.png') }}" alt="brown-chair"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(48)</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/7.png') }}" alt="imac"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                        ...
                        <div class="col">
                            <article class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/8.png') }}" alt="coolest-chair"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="ms-1">
                                            <a href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                class="link-reset fw-semibold">(52)</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <article class="card card-h-100 d-none d-lg-block d-xxl-none">
                                ...
                                <div class="card-body">
                                    <div class="p-3">
                                        <img src="{{ asset('assets/images/products/9.png') }}" alt="ipad"
                                            class="img-fluid" />
                                    </div>
                                    <!-- Title -->
                                    <h6 class="card-title fs-sm lh-base mb-2">
                    ...
                    <div class="row">
                        <div class="col-12 text-end">
                            <a href="{{ asset('apps-ecommerce-products-grid.html') }}"
                                class="btn btn-success mt-3"> View More Products <i
                                    class="ti ti-arrow-right bi align-middle fs-lg"></i> </a>
                        </div>
                    </div>
                    ...
                    <div class="row pt-4">
                        <div class="col-12 text-center">
                            ...
                            <span class="text-muted rounded-3 d-inline-block"> 🏷️ Discover trusted names loved by
                                millions </span>
                        </div>
                    </div>
                    <!-- end row -->
