    ...
    <div class="row">
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row p-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <p class="text-muted mb-3">Amazon.com, Inc. is an American multinational technology company focusing on
                        e-commerce, cloud computing...</p>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card d-flex flex-row align-items-center p-3">
                <img src="{{ asset('assets/images/logos/starbucks.svg') }}" alt="Starbucks Logo"
