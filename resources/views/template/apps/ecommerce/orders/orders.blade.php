...
<head>
    <meta charset="utf-8" />
    <title>Orders | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="app-search">
                                        <select data-table-filter="payment-status"
                                    ...
                                    <div class="app-search">
                                        <select data-table-filter="order-status"
                                            class="form-select form-control my-1 my-md-0">
                                ...
                                <div class="d-flex gap-1">
                                    <a href="{{ asset('apps-ecommerce-order-add.html') }}"
                                        class="btn btn-danger ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Order
                                    </a>
                                </div>
                            </div>
                                ...
                                <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-sm mb-0 fw-medium"><a
                                                        href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Mason Carter</h5>
                                                        <p class="text-muted fs-xs mb-0">mason.carter@shopmail.com</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>$129.45</td>
                                            <td class="text-success fw-semibold"><i
                                                    class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                            <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                            <td><img src="{{ asset('assets/images/cards/visa.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 7832</td>
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-9.jpg') }}"
                                                            alt="avatar-9" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Ava Martin</h5>
                                                        <p class="text-muted fs-xs mb-0">ava.martin@marketplace.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Noah Wilson</h5>
                                                        <p class="text-muted fs-xs mb-0">noah.wilson@ecomsite.com</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>$59.90</td>
                                            <td class="text-danger fw-semibold"><i
                                                    class="ti ti-circle-filled fs-sm"></i> Failed</td>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-10.jpg') }}"
                                                            alt="avatar-10" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Isabella Moore
                                                        </h5>
                                                        <p class="text-muted fs-xs mb-0">isabella.moore@onlineshop.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><img src="{{ asset('assets/images/cards/stripe.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 9901</td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                                        class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-5.jpg') }}"
                                                            alt="avatar-11" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Lucas Bennett
                                                        </h5>
                                                        <p class="text-muted fs-xs mb-0">lucas.bennett@shopzone.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-success fw-semibold"><i
                                                    class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                            <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                            <td><img src="{{ asset('assets/images/cards/american-express.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 4678</td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                                        class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-3.jpg') }}"
                                                            alt="avatar-3" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Emma Johnson</h5>
                                                        <p class="text-muted fs-xs mb-0">emma.johnson@storemail.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-success fw-semibold"><i
                                                    class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                            <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                            <td><img src="{{ asset('assets/images/cards/discover-card.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 1234</td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                                        class="btn btn-light btn-icon btn-sm rounded-circle"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Liam Thompson
                                                        </h5>
                                            ...
                                            <td><span class="badge badge-soft-warning fs-xxs">Processing</span></td>
                                            <td>
                                                <img src="{{ asset('assets/images/cards/unionpay.svg') }}"
                                                    alt="" class="me-2" height="28" />
                                                xxxx 9876
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-5.jpg') }}"
                                                            alt="avatar-5" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Sophia Davis</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-6.jpg') }}"
                                                            alt="avatar-6" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Oliver Brown</h5>
                                            ...
                                            <td class="text-success fw-semibold"><i
                                                    class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                            <td><span class="badge badge-soft-info fs-xxs">Shipped</span></td>
                                            <td><img src="{{ asset('assets/images/cards/google-wallet.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxx@google
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 data-sort="customer"
                                                            class="text-nowrap fs-base mb-0 lh-base">Charlotte Lee
                                                        </h5>
                                                        <p class="text-muted fs-xs mb-0">charlotte.lee@marketzone.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                            <td>
                                                <img src="{{ asset('assets/images/cards/bhim.svg') }}"
                                                    alt="" class="me-2" height="28" />
                                                xxxx@upi
                                            </td>
                                            <td>
