                        ...
                        <div class="col-xxl-4">
                            <div class="p-3 bg-light-subtle border-bottom border-dashed">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <small class="text-muted fs-xs mb-0"> All 120 orders have been successfully
                                            delivered </small>
                                    </div>
                            ...
                            <div class="text-center my-3">
                                <a href="{{ asset('chat.html') }}"
                                    ...
                                    Reports <i class="ti ti-send-2"></i> </a>
                            </div>
                        </div>
                        <!-- end col-->
                    </div>
            ...
            <div data-table data-table-rows-per-page="5" class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a href="#!" class="btn btn-sm btn-soft-secondary"> <i class="ti ti-plus me-1"></i> Add
                            Product </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Smart
                                                        Watch</a></h5>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/products/2.png') }}" alt=""
                                                class="avatar-sm rounded-circle me-2" />
                                            <div>
                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Bluetooth
                                                        Speaker</a></h5>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/products/4.png') }}" alt=""
                                                class="avatar-sm rounded-circle me-2" />
                                            <div>
                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Gaming
                                                        Mouse</a></h5>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/products/5.png') }}" alt=""
                                                class="avatar-sm rounded-circle me-2" />
                                            <div>
                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">4K Action
                                                        Camera</a></h5>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/images/products/6.png') }}" alt=""
                                                class="avatar-sm rounded-circle me-2" />
                                            <div>
                                                <h5 class="fs-base my-1"><a href="#!" class="text-body">Fitness
                                                        Tracker Band</a></h5>
                                                <span class="text-muted fs-xs">Wearables</span>
                                            </div>
                                        </div>
        ...
        <div class="col-xxl-6">
            <div data-table data-table-rows-per-page="5" class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a href="javascript:void(0);" class="btn btn-sm btn-soft-secondary"> <i
                                class="ti ti-plus me-1"></i> Add Order </a>
                        <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i
                                class="ti ti-file-export me-1"></i> Export CSV </a>
                    </div>
                </div>
                        ...
                        <div class="col-xl-6">
                                ...
                                <table class="table table-custom table-nowrap table-hover table-centered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-soft-success fs-xxs"><i
                                                        class="ti ti-point-filled"></i> Paid</span>
                                            </td>
                                            <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 1123</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-soft-danger fs-xxs"><i
                                                        class="ti ti-point-filled"></i> Failed</span>
                                            </td>
                                            <td><img src="{{ asset('assets/images/cards/visa.svg') }}" alt=""
                                                    class="me-2" height="28" /> xxxx 3490</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/cards/american-express.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 8765</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-soft-warning fs-xxs"><i
                                                        class="ti ti-point-filled"></i> Pending</span>
                                            </td>
                                            <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}"
                                                    alt="" class="me-2" height="28" /> xxxx 5566</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/cards/visa.svg') }}" alt=""
                                                    class="me-2" height="28" /> xxxx 9012</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="text-center mt-3">
                                <a href="#!" class="link-reset text-decoration-underline fw-semibold link-offset-3">
                                    View All Transactions <i class="ti ti-send-2"></i> </a>
                            </div>
                        </div>
                        <!-- end col-->
                        <div class="col-xl-6">
