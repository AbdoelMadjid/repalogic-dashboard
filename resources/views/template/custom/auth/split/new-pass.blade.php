                ...
                <div class="card auth-box-form border-0 mb-0">
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <div class="mt-auto text-center">
                            ...
                            <p class="text-muted auth-sub-text mx-auto mb-4">We've emailed you a 6-digit verification code.
                                Please enter it below to confirm your Email Address.</p>

                            <form>
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input type="email"
                                            class="form-control py-2 px-3 bg-light bg-opacity-40 border-light"
                                            id="userEmail" placeholder="you@example.com" disabled="">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-2 two-factor">
                                        <input type="text"
                                            class="form-control py-2 bg-light bg-opacity-40 border-light text-center"
                                            required="">
                                        <input type="text"
                                            class="form-control py-2 bg-light bg-opacity-40 border-light text-center"
                                            required="">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input type="password"
                                            class="form-control py-2 px-3 bg-light bg-opacity-40 border-light"
                                            id="userPassword" placeholder="Confirm New password" required="">
                                    </div>
                                </div>
