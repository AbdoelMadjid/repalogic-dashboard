                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div>
                                                                        <h5 class="mb-1">
                                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Wireless Earbuds</a>
                                                                        </h5>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div>
                                                                        <h5 class="mb-1">
                                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart Watch</a>
                                                                        </h5>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div>
                                                                        <h5 class="mb-1">
                                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Gaming Mouse</a>
                                                                        </h5>
