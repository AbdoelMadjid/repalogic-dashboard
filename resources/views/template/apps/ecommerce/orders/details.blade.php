                                                ...
                                                <div class="d-flex">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/1.png') }}"
                                                            alt="Wireless Earbuds" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                ...
                                                <div class="d-flex">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/2.png') }}"
                                                            alt="Smart Watch" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                ...
                                                <div class="d-flex">
                                                    <div class="avatar-md me-3">
                                                        <img src="{{ asset('assets/images/products/3.png') }}"
                                                            alt="Gaming Mouse" class="img-fluid rounded" />
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4">
                                <div class="me-2">
                                    <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="avatar"
                                        class="rounded-circle avatar-lg" />
                                </div>
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <a href="#!" class="link-reset">Sophia Carter</a>
                                        <img src="{{ asset('assets/images/flags/gb.svg') }}" alt="UK"
                                ...
                                <div class="ms-auto">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#"><i class="ti ti-edit me-2"></i>
                                                    Edit</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"><i class="ti ti-ban me-2"></i>
                                                    Block</a>
                                            </li>
                                            <li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm me-2">
                                    <img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt="Mastercard"
