                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Continue Shopping -->
                                        <div class="mt-4">
                                            <a href="{{ asset('apps-ecommerce-products-grid.html') }}" class="fw-medium d-inline-flex align-items-center gap-1"> <i class="ti ti-arrow-left"></i> Continue Shopping </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ asset('apps-ecommerce-checkout.html') }}" class="btn btn-lg btn-danger w-100 mb-3"> Proceed to Checkout </a>
