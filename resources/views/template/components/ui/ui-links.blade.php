...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Links | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">
                                            ...
                                            <a href="{{ asset('ui-utilities.html') }}">
                                                <code>.text-*</code>
                                                classes
                                            </a>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">
                                            <a href="{{ asset('ui-utilities.html') }}">Colored link helpers</a>
