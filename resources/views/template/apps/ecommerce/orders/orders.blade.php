            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    ...
                    <div class="d-flex gap-1">
                        <a href="{{ asset('apps-ecommerce-order-add.html') }}" class="btn btn-danger ms-1"> <i
                                class="ti ti-plus fs-sm me-2"></i> Add Order
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/cards/visa.svg') }}" alt="" class="me-2"
                                        height="28" /> xxxx 7832</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt=""
                                        class="me-2" height="28" />
                                    xxxx 5487
                                </td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('assets/images/cards/paypal.svg') }}" alt=""
                                        class="me-2" height="28" />
                                    xxx@email.com
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/cards/stripe.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 9901</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="btn btn-light btn-icon btn-sm rounded-circle"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" alt="avatar-11"
                                                class="img-fluid rounded-circle" />
                                        </div>
                                        <div>
                                ...
                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                <td><img src="{{ asset('assets/images/cards/american-express.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 4678</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="btn btn-light btn-icon btn-sm rounded-circle"><i
                            ...
                            <tr>
                                ...
                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                <td><img src="{{ asset('assets/images/cards/discover-card.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 1234</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="btn btn-light btn-icon btn-sm rounded-circle"><i
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-soft-warning fs-xxs">Processing</span></td>
                                <td>
                                    <img src="{{ asset('assets/images/cards/unionpay.svg') }}" alt=""
                                        class="me-2" height="28" />
                                    xxxx 9876
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-soft-danger fs-xxs">Cancelled</span></td>
                                <td>
                                    <img src="{{ asset('assets/images/cards/payoneer.svg') }}" alt=""
                                        class="me-2" height="28" />
                                    xxx@email.com
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                <td><span class="badge badge-soft-info fs-xxs">Shipped</span></td>
                                <td><img src="{{ asset('assets/images/cards/google-wallet.svg') }}" alt=""
                                        class="me-2" height="28" /> xxx@google
                                </td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                <td>
                                    <img src="{{ asset('assets/images/cards/bhim.svg') }}" alt="" class="me-2"
                                        height="28" />
                                    xxxx@upi
                                </td>
                                <td>
