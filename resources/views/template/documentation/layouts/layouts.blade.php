...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 mb-4">
            <div class="card border-0 bg-primary bg-gradient text-white shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-4 p-lg-5">
                    <span class="badge bg-white text-primary fw-semibold px-3 py-1.5 rounded-pill mb-3">Layout
                        Architecture</span>
                    <h2 class="fw-bold text-white mb-2" data-lang="layouts-option">Layout Options & Customization</h2>
                    <p class="text-white-50 fs-16 mb-0">Learn how to customize page layouts via HTML attributes on the root `
                        <html>` tag or Blade section wrappers.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 mb-4">
            <div class="card border shadow-sm">
                <div class="card-header bg-transparent py-3">
                    <h5 class="card-title mb-0 fw-bold"><i class="ti ti-code me-2 text-primary"></i>HTML Layout
                        Configuration Attributes</h5>
                </div>
                        ...
                        <table class="table table-hover table-centered mb-0 align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('template.layouts.options.horizontal') }}" target="_blank"
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('template.layouts.options.boxed') }}" target="_blank"
                                            class="btn btn-sm btn-soft-primary"><i class="ti ti-external-link me-1"></i>
                                            Boxed Preview</a></td>
                                </tr>
                                <tr>
                                    <td><code>data-sidenav-size</code></td>
                                    <td><code>default</code>, <code>compact</code>, <code>condensed</code>,
                                        <code>offcanvas</code></td>
                                    <td><code>default</code></td>
                                    <td>Controls sidebar width and expansion behavior</td>
                                    <td><a href="{{ route('template.layouts.options.compact') }}" target="_blank"
                                            class="btn btn-sm btn-soft-primary"><i class="ti ti-external-link me-1"></i>
                                            Compact Preview</a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="{{ route('template.layouts.topbar.dark') }}" target="_blank"
                                            class="btn btn-sm btn-soft-primary"><i class="ti ti-external-link me-1"></i>
                                            Dark Topbar</a></td>
                                </tr>
                            </tbody>
        ...
        <div class="col-12 mb-4">
            <div class="card border shadow-sm">
                <div class="card-header bg-transparent py-3">
                    <h5 class="card-title mb-0 fw-bold"><i class="ti ti-brand-php me-2 text-primary"></i>Passing Custom
                        Attributes in Blade Views</h5>
                </div>
                <div class="card-body">
                    <p class="text-muted fs-14 mb-3">In any Blade view in `resources/views/template/`, pass customized
                        attributes via <code>{{ '@' }}section('html_attribute')</code>:</p>
                    <div class="bg-dark text-white p-3 rounded-3 font-monospace fs-13">
                        <div class="text-success">{{ '@' }}extends('layouts.vertical')</div>
                        <br>
                        <div class="text-warning">{{ '@' }}section('html_attribute') data-layout-width="boxed"
                            data-topbar-color="dark" {{ '@' }}endsection</div>
                        <br>
