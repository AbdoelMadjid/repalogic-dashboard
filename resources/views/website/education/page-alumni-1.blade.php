...
<!-- Promo Block -->
          ...
          <div class="row align-items-lg-center">
            <div class="col-lg-6 g-mb-70 g-mb-150--sm g-mb-50--lg">
              <div class="g-pr-15--lg">
                ...
                <a class="btn u-shadow-v33 g-color-white g-bg-primary g-bg-main--hover g-rounded-30 g-px-25 g-py-13 mr-2" href="#">Make a Nomination</a>
                <a class="js-go-to btn u-shadow-v32 g-color-primary g-color-white--hover g-bg-white g-bg-main--hover g-rounded-30 g-px-25 g-py-13 ml-2" href="#" data-target="#content">Explore More</a>
            ...
            <div class="col-lg-6 g-mb-50">
              <div class="g-max-width-550 g-pos-rel g-pl-15--lg mx-auto">
                ...
                <div class="u-shadow-v36 g-max-width-300--sm g-pos-rel g-z-index-2 g-mb-20 g-mb-0--sm">
                  <img class="img-fluid g-brd-around g-brd-4 g-brd-white rounded" src="{{ asset('asset_education/img-temp') }}/600x350/img1.jpg" alt="Image Description">
                </div>

                <div class="u-shadow-v36 g-max-width-300--sm g-pos-abs--sm g-top-minus-70 g-left-130 g-z-index-1 g-mb-20 g-mb-0--sm">
                  <img class="img-fluid g-brd-around g-brd-4 g-brd-white rounded" src="{{ asset('asset_education/img-temp') }}/600x350/img2.jpg" alt="Image Description">
                </div>

                <div class="u-shadow-v36 g-max-width-300--sm g-pos-abs--sm g-top-65 g-right-0">
                  <img class="img-fluid g-brd-around g-brd-4 g-brd-white rounded" src="{{ asset('asset_education/img-temp') }}/600x350/img3.jpg" alt="Image Description">
                </div>
              ...
              <div class="g-pl-15--md">
                <div class="mb-5">
                  <div class="mb-4">
                    ...
                    <p>You may be surprised to discover what alumni benefits are on offer as a Unify graduate, including an alumni magazine, career resources, library membership, and more.</p>
                  </div>
                  <p>As a University of Unify graduate, you have access to a wide range of resources, mentoring opportunities, events and support to help you continue your passion for learning.</p>
                </div>
                <a class="btn u-shadow-v39 g-brd-main g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-11" href="#">Read More</a>
              </div>
            </div>
          </div>

          <div class="col-md-6 h-100 g-min-height-300 g-bg-size-cover g-bg-pos-center g-pos-abs--md g-top-0 g-left-0" data-bg-img-src="{{ asset('asset_education/img-temp') }}/900x700/img1.jpg"></div>
        </div>
      </div>
      <!-- End Benefits & Awards -->
      ...
      <section class="clearfix">
        <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_2--after" data-options="{direction: 'fromtop', animation_duration: 25, direction: 'reverse'}">
          <!-- Parallax Background Video -->
          <div class="dzsparallaxer--target" style="width: 100%; height: 200%;" data-forcewidth_ratio="1.77">
            <div class="js-bg-video g-pos-abs w-100 h-100" data-hs-bgv-type="youtube" data-hs-bgv-id="FxiskmF16gU" data-hs-bgv-loop="1"></div>
          </div>
          ...
          <div class="text-center g-pos-rel g-z-index-1 g-px-50 g-py-170">
            <a class="js-fancybox d-block" href="javascript:;"
               data-src="//www.youtube.com/watch?v=FxiskmF16gU?autoplay=1"
               data-speed="350"
               data-caption="Play Alumni at Unify University">
              <span class="u-icon-v3 u-icon-size--lg g-color-main g-color-white--hover g-bg-white g-bg-primary--hover g-font-size-20 g-rounded-50x g-cursor-pointer">
            ...
            <div class="col-md-8 g-pt-50 g-pt-100--md g-pb-70">
              <div class="row">
                ...
                <div class="col-sm-6 g-mb-30">
                  <article>
                    <img class="img-fluid mb-4" src="{{ asset('asset_education/img-temp') }}/600x350/img4.jpg" alt="Image Description">
                ...
                <div class="col-sm-6 g-mb-30">
                  <article>
                    <img class="img-fluid mb-4" src="{{ asset('asset_education/img-temp') }}/600x350/img5.jpg" alt="Image Description">
                ...
                <div class="col-sm-6 g-mb-30">
                  <article>
                    <img class="img-fluid mb-4" src="{{ asset('asset_education/img-temp') }}/600x350/img6.jpg" alt="Image Description">
                ...
                <div class="col-sm-6 g-mb-30">
                  <article>
                    <img class="img-fluid mb-4" src="{{ asset('asset_education/img-temp') }}/600x350/img21.jpg" alt="Image Description">
      ...
      <div class="g-pos-rel g-pb-100 g-pb-0--md">
        <div class="container">
              ...
              <div class="g-pl-15--md">
                <div class="mb-5">
                  <div class="mb-4">
                    ...
                    <p>As the University marks its 2017 Alumni Awards, we reflect on the essential qualities shared by all our award winners.</p>
                  </div>
                  <p>From starting a school in Uganda, to making maths a YouTube sensation. From improving the health of people the world over, to conducting some of the world’s greatest orchestras.</p>
                </div>
                <a class="btn u-shadow-v39 g-brd-main g-brd-primary--hover g-color-main g-color-white--hover g-bg-primary--hover g-font-size-default g-rounded-30 g-px-35 g-py-11" href="#">Read More</a>
              </div>
            </div>
          ...
          <div class="col-md-5 h-100 g-min-height-300 g-bg-size-cover g-bg-pos-center g-pos-abs--md g-top-0 g-right-0" data-bg-img-src="{{ asset('asset_education/img-temp') }}/900x700/img2.jpg"></div>
        </div>
      </div>
