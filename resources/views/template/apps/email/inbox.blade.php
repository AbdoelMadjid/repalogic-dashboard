...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Inbox (77) | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                    ...
                    <div class="outlook-box email-app">
                        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-sm" tabindex="-1" id="emailSidebaroffcanvas">
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    <a href="{{ asset('apps-email-compose.html') }}" class="btn btn-danger fw-medium w-100">Compose</a>

                                    <div class="list-group list-group-flush list-custom mt-3">
                                        <a href="{{ asset('apps-email-inbox.html') }}" class="list-group-item list-group-item-action active">
                                    ...
                                    <table class="table table-hover table-select mb-0">
                                        <tbody>
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Design Review & Feedback</a>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Request for Meeting</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Q2 Marketing Strategy</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Final Invoice Attached</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Team Offsite Agenda</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Welcome to the Project!</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Meeting Follow-up Notes</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Project Files Delivered</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Re: Budget Estimate</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Collaboration Opportunity</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Reschedule Request</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Monthly Report Submission</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Design Assets Update</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Updated Meeting Schedule</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Client Feedback Notes</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ asset('apps-email-details.html') }}" class="link-reset fs-base fw-medium stretched-link">Weekly Sync Meeting</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
