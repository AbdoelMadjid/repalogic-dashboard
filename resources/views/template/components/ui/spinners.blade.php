        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Indicate the loading state of a component or page with Bootstrap spinners,
                            built entirely with HTML, CSS, and no JavaScript.</p>

                        <a class="btn btn-link p-0 fw-semibold"
                            href="https://getbootstrap.com/docs/5.3/components/spinners/" target="_blank">
                        ...
                        <div class="flex-grow-1">
                            <h4 class="card-title">
                                ...
                                <a href="https://tobiasahlin.com/spinkit/" target="_blank"
                                    class="badge badge-soft-warning">CSS Based Plugin</a>
                            </h4>
                        </div>
                        <div class="card-action">
                            <a href="#!" class="card-action-item" data-action="card-toggle">
