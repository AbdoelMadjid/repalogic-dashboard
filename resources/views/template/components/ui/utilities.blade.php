        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            <code>background-color</code>
                            utilities are generated with Sass using CSS variables. This allows for real-time color changes
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Text color utilities are generated with Sass using CSS variables. This allows
                            for real-time color changes without compilation and dynamic alpha transparency changes.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded"
                                alt="rounded" />
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-top"
                                alt="rounded-top" />
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-end"
                                alt="rounded-end" />
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-bottom"
                                alt="rounded-bottom" />
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-start"
                                alt="rounded-start" />
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-circle"
                                alt="rounded-circle" />
                            <img src="{{ asset('assets/images/stock/small-3.jpg') }}" class="w-auto rounded-pill"
                                alt="rounded-pill" width="80" />
                        </div>
                    </div>
                    <!-- end card body-->
                </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-0"
                                alt="rounded-0" />
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-1"
                                alt="rounded-1" />
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-2"
                                alt="rounded-2" />
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-3"
                                alt="rounded-3" />
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-4"
                                alt="rounded-4" />
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-5"
                                alt="rounded-5" />
                        </div>
                    </div>
                    <!--end card body-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Adjust the
                            <code>overflow</code>
                            property on the fly with four default values and classes. These classes are not responsive by
                            default.
                        </p>
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="overflow-visible p-3 bg-light" style="max-width: 260px; max-height: 100px">
                                ...
                                on an element with set width and height add more text dimensions premium admin dashboard
                                template.
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            with our responsive
                            <code>object-fit</code>
                            utility classes. This property tells the content to fill the parent container in a variety of
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                            <div>
                                <img src="{{ asset('assets/images/stock/small-1.jpg') }}"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            <a href="https://getbootstrap.com/docs/5.3/utilities/position/" target="_blank">position
                                utilities</a>
                            .
                        </p>
