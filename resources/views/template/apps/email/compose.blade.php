...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>New Email (Compose) | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                    ...
                    <div class="outlook-box email-app">
                        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-sm" tabindex="-1" id="emailSidebaroffcanvas">
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    <a href="{{ asset('apps-email-inbox.html') }}" class="btn btn-danger fw-medium w-100">Back to Inbox</a>
