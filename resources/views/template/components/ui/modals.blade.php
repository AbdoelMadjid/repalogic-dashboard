        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Use Bootstrap’s JavaScript modal plugin to add dialogs to your site for
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Specify the position for the modal. You can display modal at top, bottom, or center of page by
                            specifying classes
                            <code>modal-top</code>
                            ,
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#staticBackdrop">Static Backdrop</button>
                        </div>
                        <!-- btn list -->
