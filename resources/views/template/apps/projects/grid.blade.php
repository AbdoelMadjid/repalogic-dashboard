                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">AI Analytics
                                    Dashboard</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Marketing
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Website
                                    Redesign</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            <h5 class="mb-1 d-flex align-items-center">
                                <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Sales Insight
                                    Tool</a>
                            </h5>
                    ...
                    <div class="avatar-group avatar-group-xs mb-3">
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                    </div>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Cyber Security
                                System</a>
                        </h5>
                ...
                <div class="card-body">
                    ...
                    <div class="avatar-group avatar-group-xs mb-3">
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs"
                        ...
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                    </div>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">AI Performance
                                Dashboard</a>
                        </h5>
                ...
                <div class="card-body">
                    ...
                    <div class="avatar-group avatar-group-xs mb-3">
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs"
                        ...
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                    </div>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Cloud Sync
                                Platform</a>
                        </h5>
                ...
                <div class="card-body">
                    ...
                    <div class="avatar-group avatar-group-xs mb-3">
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-xs"
                                alt="" />
                        </div>
                        <div class="avatar">
                            <img src="{{ asset('assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs"
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-header bg-light-subtle border-light p-3">
                    ...
                    <div>
                        <h5 class="mb-1 d-flex align-items-center">
                            <a href="{{ asset('apps-projects-details.html') }}" class="link-reset">Data Mining
                                Toolkit</a>
                        </h5>
