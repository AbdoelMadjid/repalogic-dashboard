...
<head>
    <meta charset="utf-8" />
    <title>Order Details | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                ...
                                <div class="card">
                                    <div class="card-header align-items-start p-4">
                                        <div>
                                            ...
                                            <p class="text-muted mb-3"><i class="ti ti-calendar"></i> 24 Apr, 2025
                                                <small class="text-muted">10:10 AM</small></p>
                                            <span class="badge badge-soft-success fs-xxs badge-label"><i
                                                    class="ti ti-circle-filled fs-sm align-middle"></i> Paid</span>
                                            <span class="badge badge-soft-info fs-xxs badge-label"><i
                                                    class="ti ti-truck fs-sm align-middle"></i> Shipped</span>
                                        </div>
                                        <div class="ms-auto">
                                            <a href="javascript: void(0);" class="btn btn-light"><i
                                                    class="ti ti-pencil me-1"></i> Modify</a>
                                    ...
                                    <div class="card-body px-4">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                class="table table-bordered table-custom table-nowrap align-middle mb-1">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-muted mb-0 fs-xxs">by: My Furniture
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-muted mb-0 fs-xxs">by: Tech World
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-muted mb-0 fs-xxs">by: Pro Gamerz
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <!-- Subtotal -->
                                                    <tr class="border-top">
                                                        <td colspan="3" class="text-end fw-semibold">Subtotal
                                                        </td>
                                                    ...
                                                    <!-- Tax -->
                                                    <tr>
                                                        <td colspan="3" class="text-end fw-semibold">Tax (10%)
                                                        </td>
                                                    ...
                                                    <!-- Discount -->
                                                    <tr>
                                                        <td colspan="3" class="text-end fw-semibold">Discount
                                                            (5%)</td>
                                                    ...
                                                    <!-- Shipping -->
                                                    <tr>
                                                        <td colspan="3" class="text-end fw-semibold">Shipping fee
                                                        </td>
                                        ...
                                        <div class="timeline">
                                            ...
                                            <div class="timeline-item d-flex align-items-stretch">
                                                ...
                                                <div class="timeline-content ps-3 pb-5">
                                                    ...
                                                    <p class="mb-1 text-muted">The package is out for delivery and
                                                        will reach you shortly.</p>
                                            ...
                                            <div class="timeline-item d-flex align-items-stretch">
                                                ...
                                                <div class="timeline-content ps-3 pb-5">
                                                    ...
                                                    <p class="mb-1 text-muted">Courier picked up the package for final
                                                        delivery.</p>
                                                    <p class="mb-1 text-muted fs-xxs">Tracking No: <a href="#!"
                                                            class="link-primary fw-semibold text-decoration-underline">TRK123456789</a>
                                                    </p>
                                            ...
                                            <div class="timeline-item d-flex align-items-stretch">
                                                ...
                                                <div class="timeline-content ps-3 pb-5">
                                                    ...
                                                    <p class="mb-1 text-muted">Shipment arrived at the nearest
                                                        delivery center.</p>
                                                    <p class="mb-1 text-muted fs-xxs">Tracking No: <a href="#!"
                                                            class="link-primary fw-semibold text-decoration-underline">TRK123456789</a>
                                                    </p>
                                            ...
                                            <div class="timeline-item d-flex align-items-stretch">
                                                ...
                                                <div class="timeline-content ps-3 pb-5">
                                                    ...
                                                    <p class="mb-1 text-muted">Package left the main transit facility
                                                        and is en route to the local hub.</p>
                                                    <p class="mb-1 text-muted fs-xxs">Tracking No: <a href="#!"
                                                            class="link-primary fw-semibold text-decoration-underline">TRK123456789</a>
                                                    </p>
                                            ...
                                            <div class="timeline-item d-flex align-items-stretch">
                                                ...
                                                <div class="timeline-content ps-3 pb-5">
                                                    ...
                                                    <p class="mb-1 text-muted">Package arrived at the central
                                                        distribution hub for processing.</p>
                                                    <p class="mb-1 text-muted fs-xxs">Tracking No: <a href="#!"
                                                            class="link-primary fw-semibold text-decoration-underline">TRK123456789</a>
                                                    </p>
                                            ...
                                            <!-- Event 6 -->
                                            <div class="timeline-item d-flex align-items-stretch">
                                                <div class="timeline-time pe-3 text-muted">Last Saturday, 2:00 PM
                                                </div>
                                                <div class="timeline-dot bg-success"></div>
                                                <div class="timeline-content ps-3 pb-5">
                                                    <h5 class="mb-1">Dispatched from Warehouse</h5>
                                                    <p class="mb-1 text-muted">Package was picked up and dispatched by
                                                        carrier from warehouse.</p>
                                                    <p class="mb-1 text-muted fs-xxs">Tracking No: <a href="#!"
                                                            class="link-primary fw-semibold text-decoration-underline">TRK123456789</a>
                                                    </p>
                                            ...
                                            <div class="timeline-item d-flex align-items-stretch">
                                                ...
                                                <div class="timeline-content ps-3">
                                                    ...
                                                    <p class="mb-1 text-muted">The order was successfully placed and
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="me-2">
                                                <img src="{{ asset('assets/images/users/user-5.jpg') }}"
                                                    alt="avatar" class="rounded-circle avatar-lg" />
                                            </div>
                                            <div>
                                                <h5 class="mb-1 d-flex align-items-center">
                                                    <a href="#!" class="link-reset">Sophia Carter</a>
                                                    <img src="{{ asset('assets/images/flags/gb.svg') }}"
                                                        alt="UK" class="ms-2 rounded-circle"
                                                        height="16" />
                                                </h5>
                                            ...
                                            <div class="ms-auto">
                                                <div class="dropdown">
                                                    <a href="#"
                                                        class="btn btn-icon btn-ghost-light text-muted"
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a class="dropdown-item" href="#"><i
                                                                    class="ti ti-share me-2"></i> Share</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="#"><i
                                        ...
                                        <ul class="list-unstyled text-muted mb-0">
                                            ...
                                            <li class="mb-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <h5 class="fs-base mb-0 fw-medium"><a href="#"
                                                            class="link-reset">+44 7911 123456</a></h5>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start my-3">
                                            ...
                                            <div class="ms-auto">
                                                <span class="badge bg-success-subtle text-success">Primary
                                                    Address</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-warning mb-0">
                                            ...
                                            <p class="fst-italic mb-0">Please leave the package at the front door if
                                                no one is home. Call upon arrival.</p>
                                        </div>
                                    </div>
                                    <!-- end card-body -->
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start mb-0">
                                            ...
                                            <div class="ms-auto">
                                                <span class="badge bg-primary-subtle text-primary">Billing
                                                    Address</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm me-2">
                                                <img src="{{ asset('assets/images/cards/mastercard.svg') }}"
                                                    alt="Mastercard" class="img-fluid rounded" />
                                            </div>
                                            <div>
