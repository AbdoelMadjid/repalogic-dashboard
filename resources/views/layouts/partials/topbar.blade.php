<header class="app-topbar">
    <div class="container-fluid topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            @php
                $showSearchBox = empty($appFeatures) || !empty($appFeatures->topbar_search_box);
            @endphp
            <div id="search-box" data-feature="topbar_search_box" class="app-search d-none d-xl-flex" style="{{ $showSearchBox ? '' : 'display: none !important;' }}">
