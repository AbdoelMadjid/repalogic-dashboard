                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="border rounded position-relative d-flex text-center align-items-center justify-content-between px-2"
                                        ...
                                        <img id="preview" src="{{ asset('assets/images/logo-black.png') }}"
                                            alt="Company Logo" height="28" />
                                ...
                                <div class="table-responsive mt-4">
                                    ...
                                    <button type="button" class="btn btn-primary mt-2"><i class="ti ti-plus me-1"></i>
                                        Add Item</button>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="justify-content-center d-flex flex-column gap-2">
                                ...
                                <a href="javascript: void(0);" class="btn btn-danger btn-lg"><i
                                        class="ti ti-send-2 me-1"></i> Send</a>
                            </div>
                        </div>
                        <!-- end card-body-->
                    </div>
