...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Analytics Dashboard | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-end mt-3">
                                                <a href="{{ asset('chat.html') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Links <i class="ti ti-link"></i> </a>
                                            </div>
                                        </div>
                                        <!-- end card-body-->
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center mt-2">
                                                <a href="{{ asset('chat.html') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Countries <i class="ti ti-world"></i> </a>
                                            </div>
                                        </div>
                                        <!-- end card-body -->
                                    </div>
                    ...
                    <div class="offcanvas-body p-0 h-100" data-simplebar>
                        <div class="d-block">
                            <div class="p-3 border-bottom">
                                ...
                                <div class="text-center mt-2">
                                    <a href="{{ asset('chat.html') }}" class="link-reset text-decoration-underline fw-semibold link-offset-3"> Go to Chat <i class="ti ti-message"></i> </a>
                                </div>
                            </div>
                            <!-- end Quick Message-->
