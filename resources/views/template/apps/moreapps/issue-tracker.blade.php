                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="mb-0 text-muted">Search bar does not return any results for valid
                                                keywords</p>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="mb-0 text-muted">Email verification link expires instantly after
                                                signup</p>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="mb-0 text-muted">Reports are showing times in UTC instead of local
                                                timezone</p>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
