        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Documentation and examples for Bootstrap typography, including global
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted m-b-15">Use text utilities as needed to change the alignment of your
                            blockquote.</p>
