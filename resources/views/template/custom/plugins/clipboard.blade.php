                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-primary mt-2"
                                                data-clipboard-target="#emailToCopy">
                                                <i class="ti ti-copy me-1"></i>
                                                Copy Email
                                            </button>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="text-muted mb-0">This cuts the value from a single-line input field.
                                            </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-primary mt-2"
                                                data-clipboard-target="#copyUsername">
                                                <i class="ti ti-copy me-1"></i>
                                                Copy Username
                                            </button>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <code id="htmlTemplate">&lt;button class="btn btn-primary"&gt;Click
                                                Me&lt;/button&gt;</code> <br />
