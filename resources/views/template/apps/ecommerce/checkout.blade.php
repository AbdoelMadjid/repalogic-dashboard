...
<head>
    <meta charset="utf-8" />
    <title>Checkout | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                            ...
                            <div class="dropdown-menu dropdown-menu-xxl p-0">
                                <div class="h-100" style="max-height: 380px" data-simplebar="">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-4">
                                            <div class="p-3">
                                                <h5 class="mb-2 fw-semibold fs-sm dropdown-header">Project Management
                                                </h5>
                                                <ul class="list-unstyled megamenu-list">
                                                    <li>
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="h-100 position-relative rounded-end rounded-0 overflow-hidden"
                                                style="background: url('{{ asset('assets/images/stock/small-8.jpg') }}'); background-size: cover">
                                                <div
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="ecommerce">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-marketplace.html') }}"
                                            class="side-nav-link">
                                            <span class="menu-text"
                                                data-lang="apps-ecommerce-marketplace">Marketplace</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="products">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-products.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-products-grid.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-product-add.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-categories.html') }}"
                                            class="side-nav-link">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="orders">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-orders.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-order-add.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-customers.html') }}" class="side-nav-link">
                                            <span class="menu-text"
                                                data-lang="apps-ecommerce-customers">Customers</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-cart.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-ecommerce-cart">Cart</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-checkout.html') }}" class="side-nav-link">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="sellers">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-sellers.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-seller-details.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-refunds.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-ecommerce-refunds">Refunds</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-reviews.html') }}" class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="inventory">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-warehouse.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-product-stocks.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-purchased-orders.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="reports">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-product-views.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-ecommerce-sales.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-attributes.html') }}"
                                            class="side-nav-link">
                                            <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-ecommerce-settings.html') }}"
                                            class="side-nav-link">
                                            <span class="menu-text"
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#email" aria-expanded="false"
                                aria-controls="email" class="side-nav-link">
                            ...
                            <div class="collapse" id="email">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-email-inbox.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-email-inbox">Inbox</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-email-details.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-email-details">Details</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-email-compose.html') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="users">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-users-contacts.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-users-contacts">Contacts</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-users-roles.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-users-roles">Roles</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-users-role-details.html') }}"
                                            class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-users-permissions.html') }}" class="side-nav-link">
                                            <span class="menu-text"
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#projects" aria-expanded="false"
                                aria-controls="projects" class="side-nav-link">
                            ...
                            <div class="collapse" id="projects">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-projects-grid.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-projects-grid">My
                                                Projects</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-projects-list.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-projects-list">Projects
                                                List</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-projects-details.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-projects-details">View
                                                Project</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-projects-kanban.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-projects-kanban">Kanban
                                                Board</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-projects-team-board.html') }}"
                                            class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-projects-activity.html') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="invoice">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-invoice-list.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-invoice-list">Invoices</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-invoice-details.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-invoice-details">Single
                                                Invoice</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-invoice-create.html') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ asset('apps-companies.html') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="more-apps">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-clients.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-clients">Clients</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-outlook.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-outlook">Outlook View</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-vote-list.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-vote-list">Vote List</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-issue-tracker.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-issue-tracker">Issue
                                                Tracker</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-api-keys.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="apps-api-keys">API Keys</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-manage.html') }}" class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="blog">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-blog-list.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-blog-grid.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-blog-article.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-blog-add.html') }}"
                                                        class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('apps-pin-board.html') }}" class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="forum">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-forum-view.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('apps-forum-post.html') }}"
                                                        class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#pages" aria-expanded="false"
                                aria-controls="pages" class="side-nav-link">
                            ...
                            <div class="collapse" id="pages">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-profile.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-profile">Profile</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-account-settings.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-account-settings">Account
                                                Settings</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-faq.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-faq">FAQ</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-pricing.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-pricing">Pricing</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-empty.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-empty">Empty Page</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-timeline.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-timeline">Timeline</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-gallery.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-gallery">Gallery</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-sitemap.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-sitemap">Sitemap</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-search-results.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-search-results">Search
                                                Results</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-coming-soon.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-coming-soon">Coming Soon</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-privacy-policy.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="pages-privacy-policy">Privacy
                                                Policy</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('pages-terms-conditions.html') }}"
                                            class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#plugins" aria-expanded="false"
                                aria-controls="plugins" class="side-nav-link">
                            ...
                            <div class="collapse" id="plugins">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-sortable.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-sortable">Sortable
                                                List</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-text-diff.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-text-diff">Text Diff</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-pdf-viewer.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-pdf-viewer">PDF Viewer</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-i18.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-i18">i18 Support</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-sweet-alerts.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-sweet-alerts">Sweet
                                                Alerts</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-idle-timer.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-idle-timer">Idle Timer</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-pass-meter.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-pass-meter">Password
                                                Meter</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-live-favicon.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-live-favicon">Live
                                                Favicon</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-clipboard.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-clipboard">Clipboard</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-tree-view.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-tree-view">Tree View</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-loading-buttons.html') }}"
                                            class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-loading-buttons">Loading
                                                Buttons</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-masonry.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-masonry">Masonry</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-tour.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-tour">Tour</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-animation.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="plugins-animation">Animation</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('plugins-video-player.html') }}" class="side-nav-link">
                                ...
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="auth-basic">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-sign-up.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-reset-pass.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-new-pass.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-two-factor.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-lock-screen.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-success-mail.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-success-mail">Success Mail</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-login-pin.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-delete-account.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-delete-account">Delete Account</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="auth-card">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-sign-in.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-sign-up.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-reset-pass.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-card-reset-pass">Reset Password</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-new-pass.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-two-factor.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-lock-screen.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-card-lock-screen">Lock Screen</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-success-mail.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-login-pin.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-card-login-pin">Login with PIN</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-card-delete-account.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="auth-split">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-sign-in.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-sign-up.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-reset-pass.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-split-reset-pass">Reset Password</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-new-pass.html') }}"
                                                        class="side-nav-link">
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-two-factor.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-split-two-factor">Two Factor</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-lock-screen.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-split-lock-screen">Lock Screen</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-success-mail.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-login-pin.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="auth-split-login-pin">Login with PIN</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('auth-split-delete-account.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="layout-options">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-scrollable.html') }}" class="side-nav-link"
                                            target="_blank">
                                            <span class="menu-text" data-lang="layouts-scrollable">Scrollable</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-compact.html') }}" class="side-nav-link"
                                            target="_blank">
                                            <span class="menu-text" data-lang="layouts-compact">Compact</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-boxed.html') }}" class="side-nav-link"
                                            target="_blank">
                                            <span class="menu-text" data-lang="layouts-boxed">Boxed</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-horizontal.html') }}" class="side-nav-link"
                                            target="_blank">
                                            <span class="menu-text" data-lang="layouts-horizontal">Horizontal</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-preloader.html') }}" class="side-nav-link"
                                            target="_blank">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebars" aria-expanded="false"
                                aria-controls="sidebars" class="side-nav-link">
                            ...
                            <div class="collapse" id="sidebars">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-light.html') }}" class="side-nav-link"
                                            target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-gradient.html') }}"
                                            class="side-nav-link" target="_blank">
                                            <span class="menu-text" data-lang="layouts-sidebar-gradient">Gradient
                                                Menu</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-gray.html') }}" class="side-nav-link"
                                            target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-image.html') }}" class="side-nav-link"
                                            target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-compact.html') }}"
                                            class="side-nav-link" target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-on-hover.html') }}"
                                            class="side-nav-link" target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-on-hover-active.html') }}"
                                            class="side-nav-link" target="_blank">
                                            <span class="menu-text" data-lang="layouts-sidebar-on-hover-active">On
                                                Hover Active</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-offcanvas.html') }}"
                                            class="side-nav-link" target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-no-icons.html') }}"
                                            class="side-nav-link" target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-sidebar-with-lines.html') }}"
                                            class="side-nav-link" target="_blank">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#topbar" aria-expanded="false"
                                aria-controls="topbar" class="side-nav-link">
                            ...
                            <div class="collapse" id="topbar">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-topbar-dark.html') }}" class="side-nav-link"
                                            target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-topbar-gray.html') }}" class="side-nav-link"
                                            target="_blank">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="{{ asset('layouts-topbar-gradient.html') }}"
                                            class="side-nav-link" target="_blank">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#base-ui" aria-expanded="false"
                                aria-controls="base-ui" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#charts" aria-expanded="false"
                                aria-controls="charts" class="side-nav-link">
                                ...
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="apex-charts">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-area.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-bar.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-bubble.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-candlestick.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-column.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-heatmap.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-line.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-mixed.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-timeline.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-boxplot.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-treemap.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-pie.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-radar.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-radialbar.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-scatter.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-polar-area.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="charts-apex-polar-area">Polar Area</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-sparklines.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-range.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-funnel.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-apex-slope.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="echarts">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-line.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-bar.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-pie.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-scatter.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-geo-map.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                            data-lang="charts-echart-geo-map">GEO Map</span>
                                                    </a>
                                                </li>
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-gauge.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-candlestick.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-area.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-radar.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-heatmap.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('charts-echart-other.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#forms" aria-expanded="false"
                                aria-controls="forms" class="side-nav-link">
                            ...
                            <div class="collapse" id="forms">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-elements.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-elements">Basic Elements</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-pickers.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-pickers">Pickers</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-select.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-select">Select</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-validation.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-validation">Validation</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-wizard.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-wizard">Wizard</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-fileuploads.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-fileuploads">File Uploads</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-text-editors.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-text-editors">Text
                                                Editors</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-range-slider.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-range-slider">Range
                                                Slider</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-layout.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="form-layout">Layouts</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('form-other-plugin.html') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#tables" aria-expanded="false"
                                aria-controls="tables" class="side-nav-link">
                            ...
                            <div class="collapse" id="tables">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('tables-static.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="tables-static">Static Tables</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('tables-custom.html') }}" class="side-nav-link">
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="datatables">
                                            <ul class="sub-menu">
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-basic.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-export-data.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-select.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-ajax.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-javascript.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-rendering.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-scroll.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-fixed-columns.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-fixed-header.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-columns.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-child-rows.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-column-searching.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-range-search.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-rows-add.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                                                ...
                                                <li class="side-nav-item">
                                                    <a href="{{ asset('tables-datatables-checkbox-select.html') }}"
                                                        class="side-nav-link">
                                                        <span class="menu-text"
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#icons" aria-expanded="false"
                                aria-controls="icons" class="side-nav-link">
                            ...
                            <div class="collapse" id="icons">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('icons-tabler.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="icons-tabler">Tabler</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('icons-lucide.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="icons-lucide">Lucide</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('icons-flags.html') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#maps" aria-expanded="false"
                                aria-controls="maps" class="side-nav-link">
                            ...
                            <div class="collapse" id="maps">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="{{ asset('maps-google.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="maps-google">Google Maps</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('maps-vector.html') }}" class="side-nav-link">
                                            <span class="menu-text" data-lang="maps-vector">Vector Maps</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="{{ asset('maps-leaflet.html') }}" class="side-nav-link">
                                                    ...
                                                    <div class="collapse" id="menu-item-4">
                                                        <ul class="sub-menu">
                                                            <li class="side-nav-item">
                                                                <a href="#" class="side-nav-link">
                                                                    <span class="menu-text"
                                                                        data-lang="menu-item-5">Item 3.1</span>
                                                                </a>
                                                            </li>
                                                            <li class="side-nav-item">
                                                                <a href="#" class="side-nav-link">
                                                                    <span class="menu-text"
                                                                        data-lang="menu-item-6">Item 3.2</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="ins-wizard" data-wizard>
                                        <!-- Navigation Tabs -->
                                        <ul class="nav nav-tabs nav-justified wizard-tabs" data-wizard-nav
                                            role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link py-2 active" data-bs-toggle="tab"
                                                    href="#stuInfo">
                                                    <span class="d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-user-circle fs-24"></i>
                                                        <span class="ms-2 text-truncate">
                                                            <span
                                                                class="mb-0 lh-base d-block fw-semibold text-body fs-md">Billing
                                                                Info</span>
                                                        </span>
                                                    </span>
                                                </a>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link py-2" data-bs-toggle="tab" href="#addrInfo">
                                                    <span class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <span class="ms-2 text-truncate">
                                                            <span
                                                                class="mb-0 lh-base d-block fw-semibold text-body fs-md">Shipping
                                                                Info</span>
                                                        </span>
                                                    </span>
                                                </a>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link py-2" data-bs-toggle="tab" href="#courseInfo">
                                                    <span class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <span class="ms-2 text-truncate">
                                                            <span
                                                                class="mb-0 lh-base d-block fw-semibold text-body fs-md">Payment
                                                                Info</span>
                                                        </span>
                                                    </span>
                                                </a>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link py-2" data-bs-toggle="tab" href="#parentInfo">
                                                    <span class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <span class="ms-2 text-truncate">
                                                            <span
                                                                class="mb-0 lh-base d-block fw-semibold text-body fs-md">Finish</span>
                                                        </span>
                                                    </span>
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content pt-3" data-wizard-content>
                                            ...
                                            <div class="tab-pane fade show active" id="stuInfo">
                                                ...
                                                <p class="text-muted fs-sm mb-4">Fill the form below in order to send
                                                    you the order's invoice.</p>
                                                <form>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="mb-3 mt-3">
                                                                <label for="example-textarea"
                                                                    class="form-label">Order Notes:</label>
                                                ...
                                                <div class="d-flex justify-content-end mt-3">
                                                    <button type="button" class="btn btn-primary"
                                                        data-wizard-next>Proceed to Shipping <i
                                                            class="ti ti-truck ms-1 fs-lg"></i></button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="addrInfo">
                                                ...
                                                <p class="text-muted fs-sm mb-4">Provide your address details to
                                                    receive the order invoice.</p>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="form-check card-radio card-radio-bordered">
                                                                <input class="form-check-input" type="radio"
                                                                    name="deli-address" id="add-home" checked />
                                                                <label class="form-check-label p-3 w-100"
                                                                    for="add-home">
                                                                    <span
                                                                        class="fw-bold text-muted mb-1 d-block text-uppercase">Home</span>
                                                                    <span class="fw-semibold d-block">Evelyn
                                                                        Carter</span>
                                                                    2418 Maple Street, Apt 12B<br />
                                                                    Brooklyn, NY 11215<br />
                                                                    <abbr title="Phone">P:</abbr> (917) 432-7784
                                                                    <br />
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="mb-3">
                                                            <div class="form-check card-radio card-radio-bordered">
                                                                <input class="form-check-input" type="radio"
                                                                    name="deli-address" id="add-office" />
                                                                <label class="form-check-label p-3 w-100"
                                                                    for="add-office">
                                                                    <span
                                                                        class="fw-bold text-muted mb-1 d-block text-uppercase">Office</span>
                                                                    <span class="fw-semibold d-block">Marcus
                                                                        Reynolds</span>
                                                                    500 Howard Street, Floor 8<br />
                                                                    San Francisco, CA 94105<br />
                                                                    <abbr title="Phone">P:</abbr> (415) 392-6400
                                                                    <br />
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <form>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-first-name"
                                                                    class="form-label">First Name</label>
                                                                <input class="form-control" type="text"
                                                                    placeholder="Enter your first name"
                                                                    id="shipping-add-first-name" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-last-name"
                                                                    class="form-label">Last Name</label>
                                                                <input class="form-control" type="text"
                                                                    placeholder="Enter your last name"
                                                                    id="shipping-add-last-name" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-email-address"
                                                                    class="form-label">Email <span
                                                                        class="text-danger">*</span></label>
                                                                <input class="form-control" type="email"
                                                                    placeholder="Enter your email"
                                                                    id="shipping-add-email-address" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-phone"
                                                                    class="form-label">Phone <span
                                                                        class="text-danger">*</span></label>
                                                                <input class="form-control" type="text"
                                                                    placeholder="(xx) xxx xxxx xxx"
                                                                    id="shipping-add-phone" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-address"
                                                                    class="form-label">Address <span
                                                                        class="text-danger">*</span></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-town-city"
                                                                    class="form-label">Town / City</label>
                                                                <input class="form-control" type="text"
                                                                    placeholder="Enter your city name"
                                                                    id="shipping-add-town-city" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-state"
                                                                    class="form-label">State</label>
                                                                <input class="form-control" type="text"
                                                                    placeholder="Enter your state"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="shipping-add-zip-postal"
                                                                    class="form-label">Zip / Postal Code</label>
                                                                <input class="form-control" type="text"
                                                                    placeholder="Enter your zip code"
                                                                    id="shipping-add-zip-postal" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end row -->
                                                ...
                                                <p class="text-muted fs-sm mb-3">Choose your preferred shipping method
                                                    to receive your order on time.</p>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="border p-3 rounded mb-3 mb-md-0">
                                                            ...
                                                            <p class="mb-0 ps-3 pt-1 text-muted">Estimated 5-7 days
                                                                shipping (Duties and tax may be due upon delivery)</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="border p-3 rounded">
                                                            ...
                                                            <p class="mb-0 ps-3 pt-1 text-muted">Estimated 1-2 days
                                                                shipping (Duties and tax may be due upon delivery)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between mt-3">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-wizard-prev>← Billing Info</button>
                                                    <button type="button" class="btn btn-primary"
                                                        data-wizard-next>Payment Info →</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="courseInfo">
                                                ...
                                                <p class="text-muted fs-sm mb-3">Select your preferred payment method
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <p class="mb-0 ps-3 pt-1 text-muted">You will be
                                                                redirected to PayPal website to complete your purchase
                                                                securely.</p>
                                                        </div>
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('assets/images/cards/paypal.svg') }}"
                                                                height="32" alt="paypal-img" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <p class="mb-0 ps-3 pt-1 text-muted">Safe money transfer
                                                                using your bank account. We support Mastercard, Visa,
                                                                Discover and Stripe.</p>
                                                        </div>
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('assets/images/cards/mastercard.svg') }}"
                                                                height="32" alt="master-card-img" />
                                                            <img src="{{ asset('assets/images/cards/discover-card.svg') }}"
                                                                height="32" alt="discover-card-img" />
                                                            <img src="{{ asset('assets/images/cards/visa.svg') }}"
                                                                height="32" alt="visa-card-img" />
                                                            <img src="{{ asset('assets/images/cards/stripe.svg') }}"
                                                                height="32" alt="stripe-card-img" />
                                                        </div>
                                                    </div>
                                                    <!-- end row -->
                                                    <div class="row mt-4">
                                                        <div class="col-md-12">
                                                            <div class="alert alert-warning fs-xs py-2">Enjoy an extra
                                                                <span class="fw-bold">10% discount</span> when you pay
                                                                with your <span class="fw-bold">Credit Card</span>.
                                                            </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <p class="mb-0 ps-3 pt-1 text-muted">You will be
                                                                redirected to Payoneer website to complete your purchase
                                                                securely.</p>
                                                        </div>
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('assets/images/cards/payoneer.svg') }}"
                                                                height="32" alt="payoneer" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            ...
                                                            <p class="mb-0 ps-3 pt-1 text-muted">Pay with cash when
                                                                your order is delivered.</p>
                                                        </div>
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('assets/images/cards/cod.png') }}"
                                                                height="24" alt="COD-img" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between mt-3">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-wizard-prev>← Shipping Info</button>
                                                    <button type="button" class="btn btn-primary"
                                                        data-wizard-next>Proceed →</button>
                                                </div>
                                            </div>
                                                ...
                                                <div class="p-4">
                                                    <div class="d-flex align-items-center gap-3 mb-3">
                                                        <div class="avatar-md flex-shrink-0">
                                                            <span
                                                                class="avatar-title text-bg-success rounded-circle fs-22">
                                                        ...
                                                        <a href="#"
                                                            class="link-reset text-decoration-underline link-offset-2 fw-semibold ms-auto">Track
                                                            Order</a>
                                                    </div>
                                                    ...
                                                    <div class="mt-4">
                                                        <h6 class="text-uppercase text-muted fw-bold">Delivery Address
                                                        </h6>
                                                    ...
                                                    <div class="mt-4">
                                                        <h6 class="text-uppercase text-muted fw-bold">Payment Info
                                                        </h6>
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="#!" class="btn btn-success"><i
                                                                class="ti ti-download me-1"></i> Download Invoice</a>
                                                        <a href="{{ asset('apps-ecommerce-products-grid.html') }}"
                                                            class="btn btn-link fw-semibold text-muted"><i
                                                                class="ti ti-arrow-left me-1"></i> Continue
                                                            Shopping</a>
                                                    </div>

                                                    <div class="p-4 alert alert-info mt-4 mb-0">
                                                        <h4 class="text-center pb-2 mb-1 text-dark">🎁 Great News!
                                                            You’ve unlocked 25% off your next order!</h4>
                                                        <p class="text-center fst-italic mb-4">Apply the code below at
                                                            checkout or find it anytime in your account.</p>
                                                        <div class="d-flex gap-2 mx-auto">
                                                            <input type="text" class="form-control border-0"
                                                                value="SAVE25NOW" readonly />
                                                            <button type="button"
                                                                class="btn btn-dark text-nowrap">Copy Code</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        <img src="{{ asset('assets/images/products/2.png') }}"
                                            class="me-1 rounded" width="42" alt="MacBook Air" />
                                        <div>
                                            <p class="mb-1 fw-semibold">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                    class="link-reset">Apple MacBook Air M3 13”</a>
                                            </p>
                                    ...
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        <img src="{{ asset('assets/images/products/5.png') }}"
                                            class="me-1 rounded" width="42" alt="Sony Headphones" />
                                        <div>
                                            <p class="mb-1 fw-semibold">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                    class="link-reset">Sony WH-1000XM5 Wireless Headphones</a>
                                            </p>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="{{ asset('assets/images/products/7.png') }}"
                                            class="me-1 rounded" width="42" alt="Apple Watch" />
                                        <div>
                                            <p class="mb-1 fw-semibold">
                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                    class="link-reset">Apple Watch Series 9 GPS</a>
                                            </p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <p class="text-muted mb-0">🎉 Congratulations! You’ve earned <span
                                            class="fw-bold text-success">239 bonus points</span>!</p>
                                </div>
                            </div>
                        </div>
                    </div>
