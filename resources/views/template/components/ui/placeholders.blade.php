        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Use loading placeholders for your components or pages to indicate
                            something may still be loading.</p>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card border shadow-none mb-md-0">
                                    <!-- card-img-top -->
                                    <img src="{{ asset('assets/images/stock/small-1.jpg') }}" class="card-img-top"
                                        alt="..." />
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            The size of
                            <code>.placeholder</code>
                            s are based on the typographic style of the parent element. Customize them with sizing
                            modifiers:
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            <code>width</code>
                            . They can replace the text inside an element or as be added as a modifier class to an existing
                            component.
                        </p>
