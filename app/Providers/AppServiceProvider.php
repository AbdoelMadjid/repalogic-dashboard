...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer(['layouts.partials.title-meta', 'layouts.partials.sidenav', 'layouts.partials.footer', 'welcome', 'website.*', 'website.*.partials.*', 'website.default.partials.*', 'auth.*'], function ($view) {
        ...
        View::composer(['welcome', 'website.*', 'website.*.partials.*', 'website.default.partials.*'], function ($view) {
