                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart LED TV 55"</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Wireless Noise Cancel Headphones</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Ergonomic Office Chair</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smartphone 12 Pro</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Bluetooth Speaker Mini</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Portable Air Cooler</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Gaming Laptop GTX 4070</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Wireless Mouse Pro</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">4K Action Camera</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Smart Fitness Watch</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Cordless Vacuum Cleaner</a>
                                                            </h5>
