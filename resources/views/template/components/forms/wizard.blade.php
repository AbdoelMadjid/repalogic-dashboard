                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y"
                                                    placeholder="Select you DOB" class="form-control" name="dob"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="ins-wizard" data-wizard>
                                ...
                                <div class="tab-content pt-3" data-wizard-content>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" data-provider="flatpickr"
                                                        data-date-format="d M, Y" placeholder="Select your birth date"
                                                        class="form-control" name="dob" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-end mt-3">
                                            <button type="button" class="btn btn-primary" data-wizard-next>Next: Address
                                                Info →</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="stepAddress">
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <button type="button" class="btn btn-secondary" data-wizard-prev>← Back:
                                                Student Info</button>
                                            <button type="button" class="btn btn-primary" data-wizard-next>Next: Course
                                                Info →</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="stepCourse">
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <button type="button" class="btn btn-secondary" data-wizard-prev>← Back:
                                                Address Info</button>
                                            <button type="button" class="btn btn-primary" data-wizard-next>Next: Parent
                                                Info →</button>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="tel" class="form-control"
                                                                name="parent_phone" placeholder="e.g., +1 555 123 4567"
                                                                required />
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
