                ...
                <div class="card-body pt-0">
                    <article class="card card-out-of-container border-top-0">
                        <div class="position-relative card-side-img overflow-hidden rounded-top"
                            style="height: 180px; background-image: url('{{ asset('assets/images/seller-profile.jpg') }}')">
                            <div
                            ...
                            <div
                                ...
                                <div class="d-flex justify-content-start align-items-center gap-3">
                                    <div class="avatar avatar-xxl">
                                        <img src="{{ asset('assets/images/sellers/4.png') }}" alt="avatar-2"
                    ...
                    <div class="">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <p class="mb-0 fs-sm">Support: <a href="mailto:support@example.com"
                                    class="text-primary fw-semibold">support@example.com</a></p>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <p class="mb-0 fs-sm">Website: <a href="https://www.example.com"
                                    class="text-primary fw-semibold">www.example.com</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div data-table data-table-rows-per-page="8" class="card">
                        <div class="card-header border-light justify-content-between">
                            ...
                            <div class="d-flex gap-1">
                                ...
                                <a href="{{ asset('apps-ecommerce-product-add.html') }}" class="btn btn-danger ms-1"> <i
                                        class="ti ti-plus fs-sm me-2"></i> Add Product </a>
                            </div>
                        </div>
                                                ...
                                                <div>
                                                    <h5 class="mb-0">
                                                        <a data-sort="product"
                                                            ...
                                                            class="link-reset">Gaming Laptop Pro</a>
                                                    </h5>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h5 class="mb-0">
                                                        <a data-sort="product"
                                                            href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                            class="link-reset">Vintage Leather Wallet</a>
                                                    </h5>
                                                </div>
                                            </div>
                                        </td>
