            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    ...
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <a href="#!" class="btn btn-primary ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Category
                        </a>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="#!" class="link-reset">Kitchen
                                                    Appliances</a>
                                            </h5>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="#!" class="link-reset">Smart
                                                    Watches</a>
                                            </h5>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="#!" class="link-reset">Gaming
                                                    Consoles</a>
                                            </h5>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a data-sort="product" href="#!" class="link-reset">Bluetooth
                                                    Speakers</a>
                                            </h5>
                                        </div>
                                    </div>
