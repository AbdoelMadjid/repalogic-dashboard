                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="app-search">
                                        <select data-table-range-filter="performance"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Portable Bluetooth Speaker</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>$49.99</td>
                                            <td>
                                                <span class="text-warning"> <i class="ti ti-star-filled"></i><i
                                                        class="ti ti-star-filled"></i><i
                                                        class="ti ti-star-filled"></i><i
                                                        class="ti ti-star-filled"></i><i class="ti ti-star"></i>
                                                </span>
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(67)</a></span>
                                            </td>
                                            <td>22.4k</td>
                                            <td>340</td>
                                            <td>6.4%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Noise Cancelling Headphones</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(128)</a></span>
                                            </td>
                                            <td>60.1k</td>
                                            <td>1500</td>
                                            <td>9.8%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">4K Action Camera</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>AC-90763</td>
                                            ...
                                            <td>
                                                ...
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(94)</a></span>
                                            </td>
                                            <td>18.9k</td>
                                            <td>610</td>
                                            <td>6.0%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Wireless Charger Pad</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>WC-23815</td>
                                            ...
                                            <td>
                                                <span class="text-warning"> <i class="ti ti-star-filled"></i><i
                                                        class="ti ti-star-filled"></i><i
                                                        class="ti ti-star-filled"></i><i class="ti ti-star"></i><i
                                                        class="ti ti-star"></i> </span>
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(41)</a></span>
                                            </td>
                                            <td>12.3k</td>
                                            <td>220</td>
                                            <td>4.1%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Mechanical Keyboard</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>MK-48519</td>
                                            ...
                                            <td>
                                                ...
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(77)</a></span>
                                            </td>
                                            <td>30.5k</td>
                                            <td>540</td>
                                            <td>7.2%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Drone with Camera</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>DR-61208</td>
                                            ...
                                            <td>
                                                ...
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(189)</a></span>
                                            </td>
                                            <td>75.9k</td>
                                            <td>1900</td>
                                            <td>10.2%</td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Smart Home Hub</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>SH-30051</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0"><a data-sort="product"
                                                                href="{{ asset('apps-ecommerce-product-details.html') }}"
                                                                class="link-reset">Mini Projector</a></h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>MP-12081</td>
                                            ...
                                            <td>
                                                ...
                                                <span class="ms-1"><a
                                                        href="{{ asset('apps-ecommerce-reviews.html') }}"
                                                        data-sort="rating"
                                                        class="link-reset fw-semibold">(35)</a></span>
                                            </td>
                                            <td>15.9k</td>
                                            <td>310</td>
                                            <td>4.7%</td>
