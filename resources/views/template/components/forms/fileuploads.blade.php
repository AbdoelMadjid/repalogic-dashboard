        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">DropzoneJS is an open source library that provides drag’n’drop file
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">A JavaScript library that can upload anything you throw at it, optimizes
                            images for faster uploads, and offers a great, accessible, silky smooth user experience.</p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="avatar-xxl">
                                    <input type="file" class="filepond filepond-input-circle rounded" name="filepond"
                                        accept="image/png, image/jpeg, image/gif" />
                                </div>
                            </div>
                        </div>
