        ...
        <div class="row">
                                    ...
                                    <a class="nav-link py-2 active" data-bs-toggle="tab" href="#stuInfo">
                                        <span class="d-flex align-items-center justify-content-center">
                                            ...
                                            <span class="ms-2 text-truncate">
                                                <span class="mb-0 lh-base d-block fw-semibold text-body fs-md">Billing
                                                    Info</span>
                                            </span>
                                        </span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link py-2" data-bs-toggle="tab" href="#addrInfo">
                                        <span class="d-flex align-items-center justify-content-center">
                                            ...
                                            <span class="ms-2 text-truncate">
                                                <span class="mb-0 lh-base d-block fw-semibold text-body fs-md">Shipping
                                                    Info</span>
                                            </span>
                                        </span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link py-2" data-bs-toggle="tab" href="#courseInfo">
                                        <span class="d-flex align-items-center justify-content-center">
                                            ...
                                            <span class="ms-2 text-truncate">
                                                <span class="mb-0 lh-base d-block fw-semibold text-body fs-md">Payment
                                                    Info</span>
                                            </span>
                                        </span>
                                    </a>
                            ...
                            <div class="tab-content pt-3" data-wizard-content>
                                ...
                                <div class="tab-pane fade show active" id="stuInfo">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="billing-email-address" class="form-label">Email <span
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="billing-address" class="form-label">Address <span
                                                            class="text-danger">*</span></label>
                                    ...
                                    <div class="d-flex justify-content-end mt-3">
                                        <button type="button" class="btn btn-primary" data-wizard-next>Proceed to
                                            Shipping
                                            <i class="ti ti-truck ms-1 fs-lg"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="addrInfo">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                <div class="form-check card-radio card-radio-bordered">
                                                    <input class="form-check-input" type="radio" name="deli-address"
                                                        id="add-home" checked />
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="shipping-add-first-name" class="form-label">First
                                                        Name</label>
                                                    <input class="form-control" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="shipping-add-last-name" class="form-label">Last
                                                        Name</label>
                                                    <input class="form-control" type="text"
                                                        placeholder="Enter your last name" id="shipping-add-last-name" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="shipping-add-email-address" class="form-label">Email <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" type="email"
                                                        placeholder="Enter your email" id="shipping-add-email-address" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="shipping-add-phone" class="form-label">Phone <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" type="text"
                                                        placeholder="(xx) xxx xxxx xxx" id="shipping-add-phone" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="shipping-add-address" class="form-label">Address <span
                                                            class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="shipping-add-town-city" class="form-label">Town /
                                                        City</label>
                                                    <input class="form-control" type="text"
                                                        placeholder="Enter your city name" id="shipping-add-town-city" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        placeholder="Enter your state" id="shipping-add-state" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="shipping-add-zip-postal" class="form-label">Zip / Postal
                                                        Code</label>
                                                    <input class="form-control" type="text"
                                                        placeholder="Enter your zip code" id="shipping-add-zip-postal" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <button type="button" class="btn btn-secondary" data-wizard-prev>← Billing
                                            Info</button>
                                        <button type="button" class="btn btn-primary" data-wizard-next>Payment Info
                                            →</button>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="courseInfo">
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                <img src="{{ asset('assets/images/cards/paypal.svg') }}" height="32"
                                                    alt="paypal-img" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                ...
                                                <img src="{{ asset('assets/images/cards/visa.svg') }}" height="32"
                                                    alt="visa-card-img" />
                                                <img src="{{ asset('assets/images/cards/stripe.svg') }}" height="32"
                                                    alt="stripe-card-img" />
                                            </div>
                                        </div>
                                        <!-- end row -->
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="card-number" class="form-control"
                                                        data-toggle="input-mask" data-mask-format="0000 0000 0000 0000"
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                <img src="{{ asset('assets/images/cards/payoneer.svg') }}" height="32"
                                                    alt="payoneer" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border p-3 mb-3 rounded">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                <img src="{{ asset('assets/images/cards/cod.png') }}" height="24"
                                                    alt="COD-img" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <button type="button" class="btn btn-secondary" data-wizard-prev>← Shipping
                                            Info</button>
                                ...
                                <div class="tab-pane fade" id="parentInfo">
                                    <div class="p-4">
                                        ...
                                        <div class="mt-4">
                                            <a href="#!" class="btn btn-success"><i class="ti ti-download me-1"></i>
                                                Download Invoice</a>
                                        ...
                                        <div class="p-4 alert alert-info mt-4 mb-0">
                                            ...
                                            <div class="d-flex gap-2 mx-auto">
                                                <input type="text" class="form-control border-0" value="SAVE25NOW"
                                                    readonly />
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <img src="{{ asset('assets/images/products/2.png') }}" class="me-1 rounded" width="42"
                                alt="MacBook Air" />
                            <div>
                                <p class="mb-1 fw-semibold">
                                    <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple
                                        MacBook Air M3 13”</a>
                                </p>
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <img src="{{ asset('assets/images/products/5.png') }}" class="me-1 rounded" width="42"
                                alt="Sony Headphones" />
                            <div>
                                <p class="mb-1 fw-semibold">
                                    <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Sony
                                        WH-1000XM5 Wireless Headphones</a>
                                </p>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ asset('assets/images/products/7.png') }}" class="me-1 rounded" width="42"
                                alt="Apple Watch" />
                            <div>
                                <p class="mb-1 fw-semibold">
                                    <a href="{{ asset('apps-ecommerce-product-details.html') }}" class="link-reset">Apple
                                        Watch Series 9 GPS</a>
                                </p>
                ...
                <div class="card">
                    <div class="card-body">
                        <p class="text-muted mb-0">🎉 Congratulations! You’ve earned <span
                                class="fw-bold text-success">239
                                bonus points</span>!</p>
                    </div>
                </div>
            </div>
