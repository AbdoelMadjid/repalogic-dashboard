...
<head>
    <meta charset="utf-8" />
    <title>Warehouse | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
                        ...
                        <div data-table data-table-rows-per-page="10" class="card">
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <div class="app-search">
                                        <select data-table-filter="warehouse-status"
                                    ...
                                    <!-- Location Filter -->
                                    <div class="app-search">
                                        <select data-table-filter="warehouse-location"
                                            class="form-select form-control my-1 my-md-0">
                                ...
                                <div class="d-flex gap-1">
                                    <a href="#!" class="btn btn-danger ms-1"> <i
                                            class="ti ti-plus fs-sm me-2"></i> Add New </a>
                                </div>
                            </div>
                                ...
                                <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="tel:+14165559876" class="text-reset">+1 416 555 9876</a>
                                            </td>
                                            <td>95,000 sq.ft</td>
                                            <td>38,240 units</td>
                                            <td>12,680 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+14165551234" class="text-reset">+1 416 555 1234</a>
                                            </td>
                                            <td>68,000 sq.ft</td>
                                            <td>22,500 units</td>
                                            <td>9,340 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+13105557654" class="text-reset">+1 310 555 7654</a>
                                            </td>
                                            <td>120,000 sq.ft</td>
                                            <td>51,800 units</td>
                                            <td>14,250 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+49301234567" class="text-reset">+49 30 1234 567</a>
                                            </td>
                                            <td>88,000 sq.ft</td>
                                            <td>29,400 units</td>
                                            <td>10,200 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+97145567890" class="text-reset">+971 4 556 7890</a>
                                            </td>
                                            <td>77,000 sq.ft</td>
                                            <td>33,900 units</td>
                                            <td>7,850 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+551112345678" class="text-reset">+55 11 1234 5678</a>
                                            </td>
                                            <td>90,000 sq.ft</td>
                                            <td>41,200 units</td>
                                            <td>11,800 units</td>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-8.jpg') }}"
                                                            alt="avatar-8" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                            ...
                                            <td><a href="tel:+27115555678" class="text-reset">+27 11 555 5678</a>
                                            </td>
                                            <td>85,000 sq.ft</td>
                                            <td>36,900 units</td>
                                            <td>9,900 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+14165553456" class="text-reset">+1 416 555 3456</a>
                                            </td>
                                            <td>92,000 sq.ft</td>
                                            <td>40,850 units</td>
                                            <td>10,600 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+61298765432" class="text-reset">+61 2 9876 5432</a>
                                            </td>
                                            <td>105,000 sq.ft</td>
                                            <td>50,200 units</td>
                                            <td>12,450 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="tel:+46855667890" class="text-reset">+46 8 5566 7890</a>
                                            </td>
                                            <td>80,000 sq.ft</td>
                                            <td>34,500 units</td>
                                            <td>7,450 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-7.jpg') }}"
                                                            alt="avatar-12" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0 fw-semibold">Nursultan Aydin</h6>
                                                        <p class="text-muted fs-xs mb-0">nursultan.aydin@company.com
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><a href="tel:+77272345678" class="text-reset">+7 727 234 5678</a>
                                            </td>
                                            <td>70,000 sq.ft</td>
                                            <td>28,300 units</td>
                                            <td>8,200 units</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="{{ asset('assets/images/users/user-4.jpg') }}"
                                                            alt="avatar-13" class="img-fluid rounded-circle" />
                                                    </div>
                                                    <div>
                                            ...
                                            <td><a href="tel:+81678901234" class="text-reset">+81 6 7890 1234</a>
                                            </td>
                                            <td>99,000 sq.ft</td>
                                            <td>45,900 units</td>
                                            <td>11,600 units</td>
