                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ asset('apps-ecommerce-order-add.html') }}" class="btn btn-danger ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Order </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB20100</a></h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ asset('apps-ecommerce-order-details.html') }}" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB20101</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB20102</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB20103</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB20104</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB30100</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB30101</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB30102</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB30103</a></h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ asset('apps-ecommerce-order-details.html') }}" class="link-reset">#WB30104</a></h5>
                                                </td>
