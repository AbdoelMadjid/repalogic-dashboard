...
<head>
    <meta charset="utf-8" />
    <title>Create New Account | INSPINIA - Responsive Bootstrap 5 Admin Dashboard Template</title>
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="auth-brand text-center mb-4">
                        ...
                        <p class="text-muted w-lg-75 mx-auto">Let’s get you started. Create your account by entering
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="userName" placeholder="Damian D."
                                        required />
                                </div>
                            </div>
