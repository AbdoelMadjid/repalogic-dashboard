        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-2">Build vertically collapsing accordions in combination with our Collapse
                            JavaScript plugin.</p>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="withoutarrowheadingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="withoutarrowcollapseOne">Accordion Item #1</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="withoutarrowheadingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="withoutarrowcollapseTwo">Accordion Item #2</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="withoutarrowheadingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="withoutarrowcollapseThree">Accordion Item #3</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="BorderedheadingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="BorderedcollapseOne">Accordion Item #1</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="BorderedheadingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="BorderedcollapseTwo">Accordion Item #2</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="BorderedheadingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="BorderedcollapseThree">Accordion Item #3</button>
                                </h2>
