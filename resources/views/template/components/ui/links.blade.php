                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            and
                            <code>:focus</code>
                            state. Some of the link styles use a relatively light foreground color, and should only be used
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            opacity, underline opacity, and underline offset.
                        </p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            ...
                            <code>rgba()</code>
                            color value with utilities. Please be aware that changes to a color’s opacity can lead to links
                            with
                            <em>insufficient</em>
                            contrast.
                        </p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            <a href="#" class="text-decoration-underline link-underline-primary">Primary
                                underline</a>
                        </p>
                        <p>
                            <a href="#" class="text-decoration-underline link-underline-secondary">Secondary
                                underline</a>
                        </p>
                        <p>
                            <a href="#" class="text-decoration-underline link-underline-success">Success
                                underline</a>
                        </p>
                        <p>
                        ...
                        <p>
                            <a href="#" class="text-decoration-underline link-underline-warning">Warning
                                underline</a>
                        </p>
                        <p>
