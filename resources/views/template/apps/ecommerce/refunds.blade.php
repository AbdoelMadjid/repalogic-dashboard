            ...
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    ...
                    <div class="d-flex gap-1">
                        <a href="#!" class="btn btn-primary ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Create Refund
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="link-reset">#INV-10423</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('assets/images/products/1.png') }}" alt=""
                                            class="rounded" width="34" height="34" />
                                        <div>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <button
                                            class="btn btn-light btn-icon btn-sm rounded-circle dropdown-toggle drop-arrow-none"
                                            data-bs-toggle="dropdown"><i class="ti ti-dots-vertical fs-lg"></i></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="link-reset">#INV-10407</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 2294</td>
                                <td>$79.99</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="link-reset">#INV-10388</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <td><img src="{{ asset('assets/images/cards/american-express.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 1145</td>
                                <td>$249.00</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="link-reset">#INV-10352</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                ...
                                <td><img src="{{ asset('assets/images/cards/paypal.svg') }}" alt=""
                                        class="me-2" height="28" /> PayPal</td>
                                <td>$59.99</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a href="{{ asset('apps-ecommerce-order-details.html') }}"
                                            class="link-reset">#INV-10341</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/cards/american-express.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 6730</td>
                                <td>$199.00</td>
                                <td><span class="badge badge-label badge-soft-success">Approved</span></td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 8142</td>
                                <td>$89.50</td>
                                <td><span class="badge badge-label badge-soft-secondary">Refunded</span></td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/cards/mastercard.svg') }}" alt=""
                                        class="me-2" height="28" /> xxxx 3210</td>
                                <td>$64.99</td>
                                <td><span class="badge badge-label badge-soft-success">Approved</span></td>
