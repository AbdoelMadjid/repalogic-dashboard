                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="slug"
                                    placeholder="e.g. how-to-build-a-blog-with-bootstrap" />
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" data-provider="flatpickr" data-date-format="d M, Y"
                                        data-enable-time class="form-control flatpickr-input" id="publishDate" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div id="snow-editor" style="height: 300px">
                                    ...
                                    <p><br /></p>
                                    <p>The Blog Article module helps you create professional-looking posts quickly. Ideal
                                        for personal blogs, news platforms, or content-driven websites.</p>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tags"
                                    placeholder="e.g. bootstrap, web design, ui, frontend" />
                            ...
                            <div class="border-top pt-3 mt-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="metaKeywords"
                                        placeholder="e.g. blog, bootstrap, tutorial" />
                                </div>
                            </div>
